...
export declare const USER_FEDERATED_IDENTITY_CREDENTIAL = "user_federated_identity_credential";
export declare const USERNAME = "username";
export declare const USER_ID = "user_id";
export declare const FMI_PATH = "fmi_path";
export declare const ATTRIBUTE_TOKENS = "attribute_tokens";
