...
})(ControlAttestationStatus || (exports.ControlAttestationStatus = ControlAttestationStatus = {}));
/**
...
(function (ControlResultStatus) {
    ControlResultStatus["Error"] = "error";
    ControlResultStatus["Failed"] = "failed";
    ControlResultStatus["Passed"] = "passed";
    ControlResultStatus["Skipped"] = "skipped";
})(ControlResultStatus || (exports.ControlResultStatus = ControlResultStatus = {}));
// Converts JSON strings to/from your types
// and asserts the results of JSON.parse at runtime
class Convert {
    static toExecJSON(json) {
        return cast(JSON.parse(json), r("ExecJSON"));
    }
    static execJSONToJson(value) {
