...
class HDFControl10 {
    ...
    static compute_severity(raw) {
        var _a, _b;
        if (compat_wrappers_1.severities.includes((_a = raw.tags['severityoverride']) === null || _a === void 0 ? void 0 : _a.toLowerCase()))
            return raw.tags['severityoverride'];
        if (compat_wrappers_1.severities.includes((_b = raw.tags['severity']) === null || _b === void 0 ? void 0 : _b.toLowerCase()))
