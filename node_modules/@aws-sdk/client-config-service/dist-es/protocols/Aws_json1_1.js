...
const se_Evaluation = (input, context) => {
    return take(input, {
        ...
        ComplianceType: [],
        OrderingTimestamp: (_) => _.getTime() / 1000,
    });
};
...
const se_GetResourceConfigHistoryRequest = (input, context) => {
    return take(input, {
        chronologicalOrder: [],
        earlierTime: (_) => _.getTime() / 1000,
        laterTime: (_) => _.getTime() / 1000,
        limit: [],
        nextToken: [],
        resourceId: [],
        resourceType: [],
...
const de_BaseConfigurationItem = (output, context) => {
    return take(output, {
        ...
        configurationItemDeliveryTime: (_) => __expectNonNull(__parseEpochTimestamp(__expectNumber(_))),
