...
var serializeAws_json1_1PutConformancePackRequest = function (input, context) {
    return __assign(__assign(__assign(__assign(__assign(__assign({}, (input.ConformancePackInputParameters != null && {
    ...
    })), (input.ConformancePackName != null && { ConformancePackName: input.ConformancePackName })), (input.DeliveryS3Bucket != null && { DeliveryS3Bucket: input.DeliveryS3Bucket })), (input.DeliveryS3KeyPrefix != null && { DeliveryS3KeyPrefix: input.DeliveryS3KeyPrefix })), (input.TemplateBody != null && { TemplateBody: input.TemplateBody })), (input.TemplateS3Uri != null && { TemplateS3Uri: input.TemplateS3Uri }));
};
