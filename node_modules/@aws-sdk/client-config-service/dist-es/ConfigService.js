...
var ConfigService = (function (_super) {
    ...
    ConfigService.prototype.listConformancePackComplianceScores = function (args, optionsOrCb, cb) {
        var command = new ListConformancePackComplianceScoresCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
