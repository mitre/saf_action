...
import { de_DeleteOrganizationConfigRuleCommand, se_DeleteOrganizationConfigRuleCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class DeleteOrganizationConfigRuleCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteOrganizationConfigRuleCommand.getEndpointParameterInstructions()));
