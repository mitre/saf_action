...
import { DescribeConfigurationRecorderStatusRequestFilterSensitiveLog, DescribeConfigurationRecorderStatusResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeConfigurationRecorderStatusCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeConfigurationRecorderStatusCommand.getEndpointParameterInstructions()));
