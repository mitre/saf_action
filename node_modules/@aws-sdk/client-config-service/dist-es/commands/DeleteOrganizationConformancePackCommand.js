...
import { de_DeleteOrganizationConformancePackCommand, se_DeleteOrganizationConformancePackCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class DeleteOrganizationConformancePackCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteOrganizationConformancePackCommand.getEndpointParameterInstructions()));
