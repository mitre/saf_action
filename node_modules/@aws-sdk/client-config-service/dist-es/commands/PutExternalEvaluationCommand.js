...
import { PutExternalEvaluationRequestFilterSensitiveLog, PutExternalEvaluationResponseFilterSensitiveLog, } from "../models/models_1";
...
export class PutExternalEvaluationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, PutExternalEvaluationCommand.getEndpointParameterInstructions()));
