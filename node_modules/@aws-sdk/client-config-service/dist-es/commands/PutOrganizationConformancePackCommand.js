...
import { PutOrganizationConformancePackRequestFilterSensitiveLog, PutOrganizationConformancePackResponseFilterSensitiveLog, } from "../models/models_1";
...
export class PutOrganizationConformancePackCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, PutOrganizationConformancePackCommand.getEndpointParameterInstructions()));
