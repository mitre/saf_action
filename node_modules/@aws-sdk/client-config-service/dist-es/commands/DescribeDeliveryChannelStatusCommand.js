...
import { DescribeDeliveryChannelStatusRequestFilterSensitiveLog, DescribeDeliveryChannelStatusResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeDeliveryChannelStatusCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeDeliveryChannelStatusCommand.getEndpointParameterInstructions()));
