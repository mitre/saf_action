...
import { DescribeConformancePackStatusRequestFilterSensitiveLog, DescribeConformancePackStatusResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeConformancePackStatusCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeConformancePackStatusCommand.getEndpointParameterInstructions()));
