...
import { PutConfigurationRecorderRequestFilterSensitiveLog } from "../models/models_1";
...
export class PutConfigurationRecorderCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, PutConfigurationRecorderCommand.getEndpointParameterInstructions()));
