...
import { GetAggregateDiscoveredResourceCountsRequestFilterSensitiveLog, GetAggregateDiscoveredResourceCountsResponseFilterSensitiveLog, } from "../models/models_0";
...
export class GetAggregateDiscoveredResourceCountsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetAggregateDiscoveredResourceCountsCommand.getEndpointParameterInstructions()));
