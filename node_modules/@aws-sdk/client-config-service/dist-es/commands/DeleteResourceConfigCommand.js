...
import { DeleteResourceConfigRequestFilterSensitiveLog } from "../models/models_0";
...
export class DeleteResourceConfigCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteResourceConfigCommand.getEndpointParameterInstructions()));
