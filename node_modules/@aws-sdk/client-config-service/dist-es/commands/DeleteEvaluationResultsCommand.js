...
import { DeleteEvaluationResultsRequestFilterSensitiveLog, DeleteEvaluationResultsResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DeleteEvaluationResultsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteEvaluationResultsCommand.getEndpointParameterInstructions()));
