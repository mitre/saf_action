...
import { PutRemediationConfigurationsRequestFilterSensitiveLog, PutRemediationConfigurationsResponseFilterSensitiveLog, } from "../models/models_1";
...
export class PutRemediationConfigurationsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, PutRemediationConfigurationsCommand.getEndpointParameterInstructions()));
