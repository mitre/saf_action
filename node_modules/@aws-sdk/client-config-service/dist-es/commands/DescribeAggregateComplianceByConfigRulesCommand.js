...
import { DescribeAggregateComplianceByConfigRulesRequestFilterSensitiveLog, DescribeAggregateComplianceByConfigRulesResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeAggregateComplianceByConfigRulesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeAggregateComplianceByConfigRulesCommand.getEndpointParameterInstructions()));
