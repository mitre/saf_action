...
import { PutRemediationExceptionsRequestFilterSensitiveLog, PutRemediationExceptionsResponseFilterSensitiveLog, } from "../models/models_1";
...
export class PutRemediationExceptionsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, PutRemediationExceptionsCommand.getEndpointParameterInstructions()));
