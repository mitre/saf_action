...
import { GetResourceConfigHistoryRequestFilterSensitiveLog, GetResourceConfigHistoryResponseFilterSensitiveLog, } from "../models/models_0";
...
export class GetResourceConfigHistoryCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetResourceConfigHistoryCommand.getEndpointParameterInstructions()));
