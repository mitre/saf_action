...
import { PutStoredQueryRequestFilterSensitiveLog, PutStoredQueryResponseFilterSensitiveLog, } from "../models/models_1";
...
export class PutStoredQueryCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, PutStoredQueryCommand.getEndpointParameterInstructions()));
