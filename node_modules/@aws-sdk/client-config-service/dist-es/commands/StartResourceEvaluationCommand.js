...
import { StartResourceEvaluationRequestFilterSensitiveLog, StartResourceEvaluationResponseFilterSensitiveLog, } from "../models/models_1";
import { deserializeAws_json1_1StartResourceEvaluationCommand, serializeAws_json1_1StartResourceEvaluationCommand, } from "../protocols/Aws_json1_1";
export class StartResourceEvaluationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, StartResourceEvaluationCommand.getEndpointParameterInstructions()));
