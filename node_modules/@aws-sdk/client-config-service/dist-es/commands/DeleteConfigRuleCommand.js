...
import { DeleteConfigRuleRequestFilterSensitiveLog } from "../models/models_0";
...
export class DeleteConfigRuleCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteConfigRuleCommand.getEndpointParameterInstructions()));
