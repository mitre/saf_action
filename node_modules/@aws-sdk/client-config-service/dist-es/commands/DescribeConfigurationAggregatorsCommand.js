...
import { de_DescribeConfigurationAggregatorsCommand, se_DescribeConfigurationAggregatorsCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class DescribeConfigurationAggregatorsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeConfigurationAggregatorsCommand.getEndpointParameterInstructions()));
