...
import { DeliverConfigSnapshotRequestFilterSensitiveLog, DeliverConfigSnapshotResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DeliverConfigSnapshotCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeliverConfigSnapshotCommand.getEndpointParameterInstructions()));
