...
import { BatchGetResourceConfigRequestFilterSensitiveLog, BatchGetResourceConfigResponseFilterSensitiveLog, } from "../models/models_0";
...
export class BatchGetResourceConfigCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, BatchGetResourceConfigCommand.getEndpointParameterInstructions()));
