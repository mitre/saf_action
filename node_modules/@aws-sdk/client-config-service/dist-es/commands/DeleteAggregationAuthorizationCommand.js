...
import { de_DeleteAggregationAuthorizationCommand, se_DeleteAggregationAuthorizationCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class DeleteAggregationAuthorizationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteAggregationAuthorizationCommand.getEndpointParameterInstructions()));
