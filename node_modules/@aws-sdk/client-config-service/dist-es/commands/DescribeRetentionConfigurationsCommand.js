...
import { DescribeRetentionConfigurationsRequestFilterSensitiveLog, DescribeRetentionConfigurationsResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeRetentionConfigurationsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeRetentionConfigurationsCommand.getEndpointParameterInstructions()));
