...
import { PutConformancePackRequestFilterSensitiveLog, PutConformancePackResponseFilterSensitiveLog, } from "../models/models_1";
...
export class PutConformancePackCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, PutConformancePackCommand.getEndpointParameterInstructions()));
