...
import { deserializeAws_json1_1ListConformancePackComplianceScoresCommand, serializeAws_json1_1ListConformancePackComplianceScoresCommand, } from "../protocols/Aws_json1_1";
export class ListConformancePackComplianceScoresCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListConformancePackComplianceScoresCommand.getEndpointParameterInstructions()));
