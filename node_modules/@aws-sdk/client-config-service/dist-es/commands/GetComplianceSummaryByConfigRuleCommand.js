...
import { de_GetComplianceSummaryByConfigRuleCommand, se_GetComplianceSummaryByConfigRuleCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class GetComplianceSummaryByConfigRuleCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetComplianceSummaryByConfigRuleCommand.getEndpointParameterInstructions()));
