...
import { DescribeComplianceByResourceRequestFilterSensitiveLog, DescribeComplianceByResourceResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeComplianceByResourceCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeComplianceByResourceCommand.getEndpointParameterInstructions()));
