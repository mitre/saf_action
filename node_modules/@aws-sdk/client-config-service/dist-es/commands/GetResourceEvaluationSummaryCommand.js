...
import { GetResourceEvaluationSummaryRequestFilterSensitiveLog, GetResourceEvaluationSummaryResponseFilterSensitiveLog, } from "../models/models_0";
import { deserializeAws_json1_1GetResourceEvaluationSummaryCommand, serializeAws_json1_1GetResourceEvaluationSummaryCommand, } from "../protocols/Aws_json1_1";
export class GetResourceEvaluationSummaryCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetResourceEvaluationSummaryCommand.getEndpointParameterInstructions()));
