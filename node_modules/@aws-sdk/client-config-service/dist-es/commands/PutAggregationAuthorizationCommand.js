...
import { PutAggregationAuthorizationRequestFilterSensitiveLog, PutAggregationAuthorizationResponseFilterSensitiveLog, } from "../models/models_1";
...
export class PutAggregationAuthorizationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, PutAggregationAuthorizationCommand.getEndpointParameterInstructions()));
