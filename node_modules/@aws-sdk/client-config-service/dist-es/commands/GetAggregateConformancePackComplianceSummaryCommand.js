...
import { GetAggregateConformancePackComplianceSummaryRequestFilterSensitiveLog, GetAggregateConformancePackComplianceSummaryResponseFilterSensitiveLog, } from "../models/models_0";
...
export class GetAggregateConformancePackComplianceSummaryCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetAggregateConformancePackComplianceSummaryCommand.getEndpointParameterInstructions()));
