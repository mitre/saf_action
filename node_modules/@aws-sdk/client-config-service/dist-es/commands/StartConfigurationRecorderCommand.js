...
import { StartConfigurationRecorderRequestFilterSensitiveLog, } from "../models/models_1";
...
export class StartConfigurationRecorderCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, StartConfigurationRecorderCommand.getEndpointParameterInstructions()));
