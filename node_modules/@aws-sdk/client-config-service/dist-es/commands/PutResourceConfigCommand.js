...
import { PutResourceConfigRequestFilterSensitiveLog } from "../models/models_1";
...
export class PutResourceConfigCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, PutResourceConfigCommand.getEndpointParameterInstructions()));
