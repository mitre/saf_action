...
import { de_GetComplianceDetailsByResourceCommand, se_GetComplianceDetailsByResourceCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class GetComplianceDetailsByResourceCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetComplianceDetailsByResourceCommand.getEndpointParameterInstructions()));
