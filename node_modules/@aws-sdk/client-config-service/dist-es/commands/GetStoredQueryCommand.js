...
import { GetStoredQueryRequestFilterSensitiveLog, GetStoredQueryResponseFilterSensitiveLog, } from "../models/models_0";
...
export class GetStoredQueryCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetStoredQueryCommand.getEndpointParameterInstructions()));
