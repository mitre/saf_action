...
import { DeleteRemediationConfigurationRequestFilterSensitiveLog, DeleteRemediationConfigurationResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DeleteRemediationConfigurationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteRemediationConfigurationCommand.getEndpointParameterInstructions()));
