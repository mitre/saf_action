...
import { PutEvaluationsRequestFilterSensitiveLog, PutEvaluationsResponseFilterSensitiveLog, } from "../models/models_1";
...
export class PutEvaluationsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, PutEvaluationsCommand.getEndpointParameterInstructions()));
