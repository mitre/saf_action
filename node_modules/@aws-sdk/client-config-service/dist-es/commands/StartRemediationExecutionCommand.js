...
import { StartRemediationExecutionRequestFilterSensitiveLog, StartRemediationExecutionResponseFilterSensitiveLog, } from "../models/models_1";
...
export class StartRemediationExecutionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, StartRemediationExecutionCommand.getEndpointParameterInstructions()));
