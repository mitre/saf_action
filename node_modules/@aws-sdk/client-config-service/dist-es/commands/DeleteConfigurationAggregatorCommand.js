...
import { de_DeleteConfigurationAggregatorCommand, se_DeleteConfigurationAggregatorCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class DeleteConfigurationAggregatorCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteConfigurationAggregatorCommand.getEndpointParameterInstructions()));
