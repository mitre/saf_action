...
import { DescribePendingAggregationRequestsRequestFilterSensitiveLog, DescribePendingAggregationRequestsResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribePendingAggregationRequestsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribePendingAggregationRequestsCommand.getEndpointParameterInstructions()));
