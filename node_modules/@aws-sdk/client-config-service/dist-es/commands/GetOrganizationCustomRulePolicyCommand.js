...
import { GetOrganizationCustomRulePolicyRequestFilterSensitiveLog, GetOrganizationCustomRulePolicyResponseFilterSensitiveLog, } from "../models/models_0";
...
export class GetOrganizationCustomRulePolicyCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetOrganizationCustomRulePolicyCommand.getEndpointParameterInstructions()));
