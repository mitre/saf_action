...
import { DescribeRemediationExceptionsRequestFilterSensitiveLog, DescribeRemediationExceptionsResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeRemediationExceptionsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeRemediationExceptionsCommand.getEndpointParameterInstructions()));
