...
import { GetAggregateComplianceDetailsByConfigRuleRequestFilterSensitiveLog, GetAggregateComplianceDetailsByConfigRuleResponseFilterSensitiveLog, } from "../models/models_0";
...
export class GetAggregateComplianceDetailsByConfigRuleCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetAggregateComplianceDetailsByConfigRuleCommand.getEndpointParameterInstructions()));
