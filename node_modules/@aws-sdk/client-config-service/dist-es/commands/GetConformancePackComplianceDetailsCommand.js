...
import { GetConformancePackComplianceDetailsRequestFilterSensitiveLog, GetConformancePackComplianceDetailsResponseFilterSensitiveLog, } from "../models/models_0";
...
export class GetConformancePackComplianceDetailsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetConformancePackComplianceDetailsCommand.getEndpointParameterInstructions()));
