...
import { DeleteRemediationExceptionsRequestFilterSensitiveLog, DeleteRemediationExceptionsResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DeleteRemediationExceptionsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteRemediationExceptionsCommand.getEndpointParameterInstructions()));
