...
import { de_DescribeConformancePackComplianceCommand, se_DescribeConformancePackComplianceCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class DescribeConformancePackComplianceCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeConformancePackComplianceCommand.getEndpointParameterInstructions()));
