...
import { GetCustomRulePolicyRequestFilterSensitiveLog, GetCustomRulePolicyResponseFilterSensitiveLog, } from "../models/models_0";
...
export class GetCustomRulePolicyCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetCustomRulePolicyCommand.getEndpointParameterInstructions()));
