...
import { PutRetentionConfigurationRequestFilterSensitiveLog, PutRetentionConfigurationResponseFilterSensitiveLog, } from "../models/models_1";
...
export class PutRetentionConfigurationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, PutRetentionConfigurationCommand.getEndpointParameterInstructions()));
