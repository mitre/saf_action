...
import { DescribeConformancePacksRequestFilterSensitiveLog, DescribeConformancePacksResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeConformancePacksCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeConformancePacksCommand.getEndpointParameterInstructions()));
