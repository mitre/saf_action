...
import { GetConformancePackComplianceSummaryRequestFilterSensitiveLog, GetConformancePackComplianceSummaryResponseFilterSensitiveLog, } from "../models/models_0";
...
export class GetConformancePackComplianceSummaryCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetConformancePackComplianceSummaryCommand.getEndpointParameterInstructions()));
