...
import { StartConfigRulesEvaluationRequestFilterSensitiveLog, StartConfigRulesEvaluationResponseFilterSensitiveLog, } from "../models/models_1";
...
export class StartConfigRulesEvaluationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, StartConfigRulesEvaluationCommand.getEndpointParameterInstructions()));
