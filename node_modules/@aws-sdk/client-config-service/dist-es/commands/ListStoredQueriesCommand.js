...
import { ListStoredQueriesRequestFilterSensitiveLog, ListStoredQueriesResponseFilterSensitiveLog, } from "../models/models_0";
...
export class ListStoredQueriesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListStoredQueriesCommand.getEndpointParameterInstructions()));
