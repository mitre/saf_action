...
import { DescribeComplianceByConfigRuleRequestFilterSensitiveLog, DescribeComplianceByConfigRuleResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeComplianceByConfigRuleCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeComplianceByConfigRuleCommand.getEndpointParameterInstructions()));
