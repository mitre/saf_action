...
import { de_GetAggregateConfigRuleComplianceSummaryCommand, se_GetAggregateConfigRuleComplianceSummaryCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class GetAggregateConfigRuleComplianceSummaryCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetAggregateConfigRuleComplianceSummaryCommand.getEndpointParameterInstructions()));
