...
import { StopConfigurationRecorderRequestFilterSensitiveLog, } from "../models/models_1";
...
export class StopConfigurationRecorderCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, StopConfigurationRecorderCommand.getEndpointParameterInstructions()));
