...
import { DeleteDeliveryChannelRequestFilterSensitiveLog } from "../models/models_0";
...
export class DeleteDeliveryChannelCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteDeliveryChannelCommand.getEndpointParameterInstructions()));
