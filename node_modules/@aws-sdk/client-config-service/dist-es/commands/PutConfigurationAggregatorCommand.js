...
import { PutConfigurationAggregatorRequestFilterSensitiveLog, PutConfigurationAggregatorResponseFilterSensitiveLog, } from "../models/models_1";
...
export class PutConfigurationAggregatorCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, PutConfigurationAggregatorCommand.getEndpointParameterInstructions()));
