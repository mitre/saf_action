...
import { DescribeRemediationExecutionStatusRequestFilterSensitiveLog, DescribeRemediationExecutionStatusResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeRemediationExecutionStatusCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeRemediationExecutionStatusCommand.getEndpointParameterInstructions()));
