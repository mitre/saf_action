...
import { SelectResourceConfigRequestFilterSensitiveLog, SelectResourceConfigResponseFilterSensitiveLog, } from "../models/models_1";
...
export class SelectResourceConfigCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, SelectResourceConfigCommand.getEndpointParameterInstructions()));
