...
import { de_DeletePendingAggregationRequestCommand, se_DeletePendingAggregationRequestCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class DeletePendingAggregationRequestCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeletePendingAggregationRequestCommand.getEndpointParameterInstructions()));
