...
import { DescribeOrganizationConformancePacksRequestFilterSensitiveLog, DescribeOrganizationConformancePacksResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeOrganizationConformancePacksCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeOrganizationConformancePacksCommand.getEndpointParameterInstructions()));
