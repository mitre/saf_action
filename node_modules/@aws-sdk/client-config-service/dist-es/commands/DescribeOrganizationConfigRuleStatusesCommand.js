...
import { DescribeOrganizationConfigRuleStatusesRequestFilterSensitiveLog, DescribeOrganizationConfigRuleStatusesResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeOrganizationConfigRuleStatusesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeOrganizationConfigRuleStatusesCommand.getEndpointParameterInstructions()));
