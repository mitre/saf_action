...
import { DeleteConformancePackRequestFilterSensitiveLog } from "../models/models_0";
...
export class DeleteConformancePackCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteConformancePackCommand.getEndpointParameterInstructions()));
