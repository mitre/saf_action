...
import { GetComplianceDetailsByConfigRuleRequestFilterSensitiveLog, GetComplianceDetailsByConfigRuleResponseFilterSensitiveLog, } from "../models/models_0";
...
export class GetComplianceDetailsByConfigRuleCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetComplianceDetailsByConfigRuleCommand.getEndpointParameterInstructions()));
