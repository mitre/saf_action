...
import { de_DescribeOrganizationConfigRulesCommand, se_DescribeOrganizationConfigRulesCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class DescribeOrganizationConfigRulesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeOrganizationConfigRulesCommand.getEndpointParameterInstructions()));
