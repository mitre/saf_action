...
import { DescribeConfigurationRecordersRequestFilterSensitiveLog, DescribeConfigurationRecordersResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeConfigurationRecordersCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeConfigurationRecordersCommand.getEndpointParameterInstructions()));
