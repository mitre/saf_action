...
import { DescribeAggregationAuthorizationsRequestFilterSensitiveLog, DescribeAggregationAuthorizationsResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeAggregationAuthorizationsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeAggregationAuthorizationsCommand.getEndpointParameterInstructions()));
