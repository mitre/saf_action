...
import { DescribeDeliveryChannelsRequestFilterSensitiveLog, DescribeDeliveryChannelsResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeDeliveryChannelsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeDeliveryChannelsCommand.getEndpointParameterInstructions()));
