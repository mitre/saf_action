...
import { DescribeRemediationConfigurationsRequestFilterSensitiveLog, DescribeRemediationConfigurationsResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeRemediationConfigurationsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeRemediationConfigurationsCommand.getEndpointParameterInstructions()));
