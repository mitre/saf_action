...
import { DescribeOrganizationConformancePackStatusesRequestFilterSensitiveLog, DescribeOrganizationConformancePackStatusesResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeOrganizationConformancePackStatusesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeOrganizationConformancePackStatusesCommand.getEndpointParameterInstructions()));
