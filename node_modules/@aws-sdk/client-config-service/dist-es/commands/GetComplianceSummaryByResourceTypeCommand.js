...
import { GetComplianceSummaryByResourceTypeRequestFilterSensitiveLog, GetComplianceSummaryByResourceTypeResponseFilterSensitiveLog, } from "../models/models_0";
...
export class GetComplianceSummaryByResourceTypeCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetComplianceSummaryByResourceTypeCommand.getEndpointParameterInstructions()));
