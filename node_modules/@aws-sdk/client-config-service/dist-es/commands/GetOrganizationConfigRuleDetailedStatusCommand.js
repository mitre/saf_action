...
import { GetOrganizationConfigRuleDetailedStatusRequestFilterSensitiveLog, GetOrganizationConfigRuleDetailedStatusResponseFilterSensitiveLog, } from "../models/models_0";
...
export class GetOrganizationConfigRuleDetailedStatusCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetOrganizationConfigRuleDetailedStatusCommand.getEndpointParameterInstructions()));
