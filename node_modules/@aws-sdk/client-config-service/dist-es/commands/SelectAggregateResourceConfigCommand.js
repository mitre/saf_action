...
import { SelectAggregateResourceConfigRequestFilterSensitiveLog, SelectAggregateResourceConfigResponseFilterSensitiveLog, } from "../models/models_1";
...
export class SelectAggregateResourceConfigCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, SelectAggregateResourceConfigCommand.getEndpointParameterInstructions()));
