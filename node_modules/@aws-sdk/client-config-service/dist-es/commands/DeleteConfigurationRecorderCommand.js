...
import { DeleteConfigurationRecorderRequestFilterSensitiveLog, } from "../models/models_0";
...
export class DeleteConfigurationRecorderCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteConfigurationRecorderCommand.getEndpointParameterInstructions()));
