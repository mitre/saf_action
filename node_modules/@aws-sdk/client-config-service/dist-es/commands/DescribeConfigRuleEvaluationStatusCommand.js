...
import { de_DescribeConfigRuleEvaluationStatusCommand, se_DescribeConfigRuleEvaluationStatusCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class DescribeConfigRuleEvaluationStatusCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeConfigRuleEvaluationStatusCommand.getEndpointParameterInstructions()));
