...
import { GetAggregateResourceConfigRequestFilterSensitiveLog, GetAggregateResourceConfigResponseFilterSensitiveLog, } from "../models/models_0";
...
export class GetAggregateResourceConfigCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetAggregateResourceConfigCommand.getEndpointParameterInstructions()));
