...
import { de_DeleteRetentionConfigurationCommand, se_DeleteRetentionConfigurationCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class DeleteRetentionConfigurationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteRetentionConfigurationCommand.getEndpointParameterInstructions()));
