...
import { GetOrganizationConformancePackDetailedStatusRequestFilterSensitiveLog, GetOrganizationConformancePackDetailedStatusResponseFilterSensitiveLog, } from "../models/models_0";
...
export class GetOrganizationConformancePackDetailedStatusCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetOrganizationConformancePackDetailedStatusCommand.getEndpointParameterInstructions()));
