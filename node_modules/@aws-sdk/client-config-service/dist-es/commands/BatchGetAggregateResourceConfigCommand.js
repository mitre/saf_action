...
import { BatchGetAggregateResourceConfigRequestFilterSensitiveLog, BatchGetAggregateResourceConfigResponseFilterSensitiveLog, } from "../models/models_0";
...
export class BatchGetAggregateResourceConfigCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, BatchGetAggregateResourceConfigCommand.getEndpointParameterInstructions()));
