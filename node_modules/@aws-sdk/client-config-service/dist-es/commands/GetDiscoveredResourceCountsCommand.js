...
import { GetDiscoveredResourceCountsRequestFilterSensitiveLog, GetDiscoveredResourceCountsResponseFilterSensitiveLog, } from "../models/models_0";
...
export class GetDiscoveredResourceCountsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetDiscoveredResourceCountsCommand.getEndpointParameterInstructions()));
