...
import { DescribeConfigurationAggregatorSourcesStatusRequestFilterSensitiveLog, DescribeConfigurationAggregatorSourcesStatusResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeConfigurationAggregatorSourcesStatusCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeConfigurationAggregatorSourcesStatusCommand.getEndpointParameterInstructions()));
