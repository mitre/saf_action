...
import { ListAggregateDiscoveredResourcesRequestFilterSensitiveLog, ListAggregateDiscoveredResourcesResponseFilterSensitiveLog, } from "../models/models_0";
...
export class ListAggregateDiscoveredResourcesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ListAggregateDiscoveredResourcesCommand.getEndpointParameterInstructions()));
