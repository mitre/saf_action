...
import { DescribeAggregateComplianceByConformancePacksRequestFilterSensitiveLog, DescribeAggregateComplianceByConformancePacksResponseFilterSensitiveLog, } from "../models/models_0";
...
export class DescribeAggregateComplianceByConformancePacksCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeAggregateComplianceByConformancePacksCommand.getEndpointParameterInstructions()));
