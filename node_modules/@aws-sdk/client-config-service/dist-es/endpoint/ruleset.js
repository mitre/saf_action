...
const a = true, b = false, c = "String", d = "PartitionResult", e = "tree", f = "error", g = "endpoint", h = "getAttr", i = { "required": true, "default": false, "type": "Boolean" }, j = { [w]: "Endpoint" }, k = { [u]: "booleanEquals", [v]: [{ [w]: "UseFIPS" }, true] }, l = { [u]: "booleanEquals", [v]: [{ [w]: "UseDualStack" }, true] }, m = {}, n = { [u]: "booleanEquals", [v]: [true, { [u]: h, [v]: [{ [w]: d }, "supportsFIPS"] }] }, o = { [w]: d }, p = { [u]: "booleanEquals", [v]: [true, { [u]: h, [v]: [o, "supportsDualStack"] }] }, q = { "url": "https://config.{Region}.{PartitionResult#dnsSuffix}", "properties": {}, "headers": {} }, r = [j], s = [k], t = [l];
