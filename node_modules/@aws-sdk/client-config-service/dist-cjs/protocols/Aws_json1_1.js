...
const de_MaxActiveResourcesExceededExceptionRes = async (parsedOutput, context) => {
    const body = parsedOutput.body;
    const deserialized = (0, smithy_client_1._json)(body);
    const exception = new models_1_1.MaxActiveResourcesExceededException({
        $metadata: deserializeMetadata(parsedOutput),
        ...deserialized,
    });
    return (0, smithy_client_1.decorateServiceException)(exception, body);
...
const de_BaseConfigurationItem = (output, context) => {
    return (0, smithy_client_1.take)(output, {
        ...
        configurationItemDeliveryTime: (_) => (0, smithy_client_1.expectNonNull)((0, smithy_client_1.parseEpochTimestamp)((0, smithy_client_1.expectNumber)(_))),
        configurationItemStatus: smithy_client_1.expectString,
        configurationStateId: smithy_client_1.expectString,
        recordingFrequency: smithy_client_1.expectString,
