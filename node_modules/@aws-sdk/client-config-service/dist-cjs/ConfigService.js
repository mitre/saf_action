...
class ConfigService extends ConfigServiceClient_1.ConfigServiceClient {
    ...
    getCustomRulePolicy(args, optionsOrCb, cb) {
        const command = new GetCustomRulePolicyCommand_1.GetCustomRulePolicyCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    getOrganizationCustomRulePolicy(args, optionsOrCb, cb) {
        const command = new GetOrganizationCustomRulePolicyCommand_1.GetOrganizationCustomRulePolicyCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    getResourceEvaluationSummary(args, optionsOrCb, cb) {
        const command = new GetResourceEvaluationSummaryCommand_1.GetResourceEvaluationSummaryCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    listConformancePackComplianceScores(args, optionsOrCb, cb) {
        const command = new ListConformancePackComplianceScoresCommand_1.ListConformancePackComplianceScoresCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    listResourceEvaluations(args, optionsOrCb, cb) {
        const command = new ListResourceEvaluationsCommand_1.ListResourceEvaluationsCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    startResourceEvaluation(args, optionsOrCb, cb) {
        const command = new StartResourceEvaluationCommand_1.StartResourceEvaluationCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
