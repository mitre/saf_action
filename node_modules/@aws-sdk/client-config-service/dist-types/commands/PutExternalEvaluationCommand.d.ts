...
declare const PutExternalEvaluationCommand_base: {
    new (input: PutExternalEvaluationCommandInput): import("@smithy/smithy-client").CommandImpl<PutExternalEvaluationCommandInput, PutExternalEvaluationCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutExternalEvaluationCommandInput): import("@smithy/smithy-client").CommandImpl<PutExternalEvaluationCommandInput, PutExternalEvaluationCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
