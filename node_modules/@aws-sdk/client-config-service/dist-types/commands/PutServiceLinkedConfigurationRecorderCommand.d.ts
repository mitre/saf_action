...
import type { PutServiceLinkedConfigurationRecorderRequest, PutServiceLinkedConfigurationRecorderResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const PutServiceLinkedConfigurationRecorderCommand_base: {
    new (input: PutServiceLinkedConfigurationRecorderCommandInput): import("@smithy/core/client").CommandImpl<PutServiceLinkedConfigurationRecorderCommandInput, PutServiceLinkedConfigurationRecorderCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutServiceLinkedConfigurationRecorderCommandInput): import("@smithy/core/client").CommandImpl<PutServiceLinkedConfigurationRecorderCommandInput, PutServiceLinkedConfigurationRecorderCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
