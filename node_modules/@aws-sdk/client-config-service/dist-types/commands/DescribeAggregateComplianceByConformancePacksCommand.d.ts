...
declare const DescribeAggregateComplianceByConformancePacksCommand_base: {
    new (input: DescribeAggregateComplianceByConformancePacksCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAggregateComplianceByConformancePacksCommandInput, DescribeAggregateComplianceByConformancePacksCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeAggregateComplianceByConformancePacksCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAggregateComplianceByConformancePacksCommandInput, DescribeAggregateComplianceByConformancePacksCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
