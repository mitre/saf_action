...
declare const PutOrganizationConformancePackCommand_base: {
    new (input: PutOrganizationConformancePackCommandInput): import("@smithy/smithy-client").CommandImpl<PutOrganizationConformancePackCommandInput, PutOrganizationConformancePackCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutOrganizationConformancePackCommandInput): import("@smithy/smithy-client").CommandImpl<PutOrganizationConformancePackCommandInput, PutOrganizationConformancePackCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
