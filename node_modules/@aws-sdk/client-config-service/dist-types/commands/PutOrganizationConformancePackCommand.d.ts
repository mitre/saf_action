...
declare const PutOrganizationConformancePackCommand_base: {
    new (input: PutOrganizationConformancePackCommandInput): import("@smithy/core/client").CommandImpl<PutOrganizationConformancePackCommandInput, PutOrganizationConformancePackCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutOrganizationConformancePackCommandInput): import("@smithy/core/client").CommandImpl<PutOrganizationConformancePackCommandInput, PutOrganizationConformancePackCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
