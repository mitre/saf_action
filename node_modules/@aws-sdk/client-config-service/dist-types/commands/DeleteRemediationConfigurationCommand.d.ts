...
declare const DeleteRemediationConfigurationCommand_base: {
    new (input: DeleteRemediationConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRemediationConfigurationCommandInput, DeleteRemediationConfigurationCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteRemediationConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRemediationConfigurationCommandInput, DeleteRemediationConfigurationCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
