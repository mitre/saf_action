...
declare const PutResourceConfigCommand_base: {
    new (input: PutResourceConfigCommandInput): import("@smithy/smithy-client").CommandImpl<PutResourceConfigCommandInput, PutResourceConfigCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutResourceConfigCommandInput): import("@smithy/smithy-client").CommandImpl<PutResourceConfigCommandInput, PutResourceConfigCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
