...
declare const PutResourceConfigCommand_base: {
    new (input: PutResourceConfigCommandInput): import("@smithy/core/client").CommandImpl<PutResourceConfigCommandInput, PutResourceConfigCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutResourceConfigCommandInput): import("@smithy/core/client").CommandImpl<PutResourceConfigCommandInput, PutResourceConfigCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
