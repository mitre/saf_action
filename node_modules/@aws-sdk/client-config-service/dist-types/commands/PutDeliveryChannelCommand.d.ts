...
declare const PutDeliveryChannelCommand_base: {
    new (input: PutDeliveryChannelCommandInput): import("@smithy/core/client").CommandImpl<PutDeliveryChannelCommandInput, PutDeliveryChannelCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutDeliveryChannelCommandInput): import("@smithy/core/client").CommandImpl<PutDeliveryChannelCommandInput, PutDeliveryChannelCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
