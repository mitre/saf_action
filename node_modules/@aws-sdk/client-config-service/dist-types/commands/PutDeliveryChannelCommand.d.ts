...
declare const PutDeliveryChannelCommand_base: {
    new (input: PutDeliveryChannelCommandInput): import("@smithy/smithy-client").CommandImpl<PutDeliveryChannelCommandInput, PutDeliveryChannelCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutDeliveryChannelCommandInput): import("@smithy/smithy-client").CommandImpl<PutDeliveryChannelCommandInput, PutDeliveryChannelCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
