...
declare const DescribeDeliveryChannelsCommand_base: {
    new (input: DescribeDeliveryChannelsCommandInput): import("@smithy/core/client").CommandImpl<DescribeDeliveryChannelsCommandInput, DescribeDeliveryChannelsCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeDeliveryChannelsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeDeliveryChannelsCommandInput, DescribeDeliveryChannelsCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
