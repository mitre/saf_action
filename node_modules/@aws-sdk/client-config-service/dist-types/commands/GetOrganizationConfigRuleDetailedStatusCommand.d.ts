...
import type { GetOrganizationConfigRuleDetailedStatusRequest, GetOrganizationConfigRuleDetailedStatusResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetOrganizationConfigRuleDetailedStatusCommand_base: {
    new (input: GetOrganizationConfigRuleDetailedStatusCommandInput): import("@smithy/core/client").CommandImpl<GetOrganizationConfigRuleDetailedStatusCommandInput, GetOrganizationConfigRuleDetailedStatusCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetOrganizationConfigRuleDetailedStatusCommandInput): import("@smithy/core/client").CommandImpl<GetOrganizationConfigRuleDetailedStatusCommandInput, GetOrganizationConfigRuleDetailedStatusCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
