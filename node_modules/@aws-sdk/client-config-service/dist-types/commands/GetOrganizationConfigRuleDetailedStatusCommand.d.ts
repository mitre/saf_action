...
declare const GetOrganizationConfigRuleDetailedStatusCommand_base: {
    new (input: GetOrganizationConfigRuleDetailedStatusCommandInput): import("@smithy/smithy-client").CommandImpl<GetOrganizationConfigRuleDetailedStatusCommandInput, GetOrganizationConfigRuleDetailedStatusCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetOrganizationConfigRuleDetailedStatusCommandInput): import("@smithy/smithy-client").CommandImpl<GetOrganizationConfigRuleDetailedStatusCommandInput, GetOrganizationConfigRuleDetailedStatusCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
