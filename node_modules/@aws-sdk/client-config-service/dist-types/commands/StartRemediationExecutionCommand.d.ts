...
declare const StartRemediationExecutionCommand_base: {
    new (input: StartRemediationExecutionCommandInput): import("@smithy/core/client").CommandImpl<StartRemediationExecutionCommandInput, StartRemediationExecutionCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartRemediationExecutionCommandInput): import("@smithy/core/client").CommandImpl<StartRemediationExecutionCommandInput, StartRemediationExecutionCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
