...
declare const GetOrganizationConformancePackDetailedStatusCommand_base: {
    new (input: GetOrganizationConformancePackDetailedStatusCommandInput): import("@smithy/core/client").CommandImpl<GetOrganizationConformancePackDetailedStatusCommandInput, GetOrganizationConformancePackDetailedStatusCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetOrganizationConformancePackDetailedStatusCommandInput): import("@smithy/core/client").CommandImpl<GetOrganizationConformancePackDetailedStatusCommandInput, GetOrganizationConformancePackDetailedStatusCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
