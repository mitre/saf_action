...
declare const GetOrganizationConformancePackDetailedStatusCommand_base: {
    new (input: GetOrganizationConformancePackDetailedStatusCommandInput): import("@smithy/smithy-client").CommandImpl<GetOrganizationConformancePackDetailedStatusCommandInput, GetOrganizationConformancePackDetailedStatusCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetOrganizationConformancePackDetailedStatusCommandInput): import("@smithy/smithy-client").CommandImpl<GetOrganizationConformancePackDetailedStatusCommandInput, GetOrganizationConformancePackDetailedStatusCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
