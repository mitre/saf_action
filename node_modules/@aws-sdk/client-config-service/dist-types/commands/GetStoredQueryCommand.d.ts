...
declare const GetStoredQueryCommand_base: {
    new (input: GetStoredQueryCommandInput): import("@smithy/core/client").CommandImpl<GetStoredQueryCommandInput, GetStoredQueryCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetStoredQueryCommandInput): import("@smithy/core/client").CommandImpl<GetStoredQueryCommandInput, GetStoredQueryCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
