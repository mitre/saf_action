...
declare const GetStoredQueryCommand_base: {
    new (input: GetStoredQueryCommandInput): import("@smithy/smithy-client").CommandImpl<GetStoredQueryCommandInput, GetStoredQueryCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetStoredQueryCommandInput): import("@smithy/smithy-client").CommandImpl<GetStoredQueryCommandInput, GetStoredQueryCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
