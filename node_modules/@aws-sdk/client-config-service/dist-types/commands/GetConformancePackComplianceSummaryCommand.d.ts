...
declare const GetConformancePackComplianceSummaryCommand_base: {
    new (input: GetConformancePackComplianceSummaryCommandInput): import("@smithy/smithy-client").CommandImpl<GetConformancePackComplianceSummaryCommandInput, GetConformancePackComplianceSummaryCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetConformancePackComplianceSummaryCommandInput): import("@smithy/smithy-client").CommandImpl<GetConformancePackComplianceSummaryCommandInput, GetConformancePackComplianceSummaryCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
