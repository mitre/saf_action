...
import type { GetConformancePackComplianceSummaryRequest, GetConformancePackComplianceSummaryResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetConformancePackComplianceSummaryCommand_base: {
    new (input: GetConformancePackComplianceSummaryCommandInput): import("@smithy/core/client").CommandImpl<GetConformancePackComplianceSummaryCommandInput, GetConformancePackComplianceSummaryCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetConformancePackComplianceSummaryCommandInput): import("@smithy/core/client").CommandImpl<GetConformancePackComplianceSummaryCommandInput, GetConformancePackComplianceSummaryCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
