...
declare const SelectResourceConfigCommand_base: {
    new (input: SelectResourceConfigCommandInput): import("@smithy/smithy-client").CommandImpl<SelectResourceConfigCommandInput, SelectResourceConfigCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SelectResourceConfigCommandInput): import("@smithy/smithy-client").CommandImpl<SelectResourceConfigCommandInput, SelectResourceConfigCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
