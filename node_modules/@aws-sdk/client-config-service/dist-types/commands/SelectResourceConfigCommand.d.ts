...
import type { SelectResourceConfigRequest, SelectResourceConfigResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const SelectResourceConfigCommand_base: {
    new (input: SelectResourceConfigCommandInput): import("@smithy/core/client").CommandImpl<SelectResourceConfigCommandInput, SelectResourceConfigCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SelectResourceConfigCommandInput): import("@smithy/core/client").CommandImpl<SelectResourceConfigCommandInput, SelectResourceConfigCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
