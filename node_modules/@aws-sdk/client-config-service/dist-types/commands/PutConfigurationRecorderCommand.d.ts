...
declare const PutConfigurationRecorderCommand_base: {
    new (input: PutConfigurationRecorderCommandInput): import("@smithy/smithy-client").CommandImpl<PutConfigurationRecorderCommandInput, PutConfigurationRecorderCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutConfigurationRecorderCommandInput): import("@smithy/smithy-client").CommandImpl<PutConfigurationRecorderCommandInput, PutConfigurationRecorderCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
