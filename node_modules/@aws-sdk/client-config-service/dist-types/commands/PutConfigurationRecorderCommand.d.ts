...
declare const PutConfigurationRecorderCommand_base: {
    new (input: PutConfigurationRecorderCommandInput): import("@smithy/core/client").CommandImpl<PutConfigurationRecorderCommandInput, PutConfigurationRecorderCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutConfigurationRecorderCommandInput): import("@smithy/core/client").CommandImpl<PutConfigurationRecorderCommandInput, PutConfigurationRecorderCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
