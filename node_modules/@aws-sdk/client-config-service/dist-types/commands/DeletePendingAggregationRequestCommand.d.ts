...
declare const DeletePendingAggregationRequestCommand_base: {
    new (input: DeletePendingAggregationRequestCommandInput): import("@smithy/smithy-client").CommandImpl<DeletePendingAggregationRequestCommandInput, DeletePendingAggregationRequestCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeletePendingAggregationRequestCommandInput): import("@smithy/smithy-client").CommandImpl<DeletePendingAggregationRequestCommandInput, DeletePendingAggregationRequestCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
