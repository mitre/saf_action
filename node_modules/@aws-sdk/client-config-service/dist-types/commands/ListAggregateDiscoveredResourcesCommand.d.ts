...
import type { ListAggregateDiscoveredResourcesRequest, ListAggregateDiscoveredResourcesResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListAggregateDiscoveredResourcesCommand_base: {
    new (input: ListAggregateDiscoveredResourcesCommandInput): import("@smithy/core/client").CommandImpl<ListAggregateDiscoveredResourcesCommandInput, ListAggregateDiscoveredResourcesCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListAggregateDiscoveredResourcesCommandInput): import("@smithy/core/client").CommandImpl<ListAggregateDiscoveredResourcesCommandInput, ListAggregateDiscoveredResourcesCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
