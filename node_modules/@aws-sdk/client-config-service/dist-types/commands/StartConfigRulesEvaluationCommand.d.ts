...
declare const StartConfigRulesEvaluationCommand_base: {
    new (input: StartConfigRulesEvaluationCommandInput): import("@smithy/core/client").CommandImpl<StartConfigRulesEvaluationCommandInput, StartConfigRulesEvaluationCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [StartConfigRulesEvaluationCommandInput]): import("@smithy/core/client").CommandImpl<StartConfigRulesEvaluationCommandInput, StartConfigRulesEvaluationCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
