...
declare const StartConfigRulesEvaluationCommand_base: {
    new (input: StartConfigRulesEvaluationCommandInput): import("@smithy/smithy-client").CommandImpl<StartConfigRulesEvaluationCommandInput, StartConfigRulesEvaluationCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [StartConfigRulesEvaluationCommandInput]): import("@smithy/smithy-client").CommandImpl<StartConfigRulesEvaluationCommandInput, StartConfigRulesEvaluationCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
