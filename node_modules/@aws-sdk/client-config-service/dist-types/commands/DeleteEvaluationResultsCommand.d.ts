...
declare const DeleteEvaluationResultsCommand_base: {
    new (input: DeleteEvaluationResultsCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteEvaluationResultsCommandInput, DeleteEvaluationResultsCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteEvaluationResultsCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteEvaluationResultsCommandInput, DeleteEvaluationResultsCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
