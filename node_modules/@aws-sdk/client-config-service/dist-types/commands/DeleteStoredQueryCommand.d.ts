...
declare const DeleteStoredQueryCommand_base: {
    new (input: DeleteStoredQueryCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteStoredQueryCommandInput, DeleteStoredQueryCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteStoredQueryCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteStoredQueryCommandInput, DeleteStoredQueryCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
