...
declare const PutStoredQueryCommand_base: {
    new (input: PutStoredQueryCommandInput): import("@smithy/smithy-client").CommandImpl<PutStoredQueryCommandInput, PutStoredQueryCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutStoredQueryCommandInput): import("@smithy/smithy-client").CommandImpl<PutStoredQueryCommandInput, PutStoredQueryCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
