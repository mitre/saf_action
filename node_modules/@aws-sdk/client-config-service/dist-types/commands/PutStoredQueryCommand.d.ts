...
declare const PutStoredQueryCommand_base: {
    new (input: PutStoredQueryCommandInput): import("@smithy/core/client").CommandImpl<PutStoredQueryCommandInput, PutStoredQueryCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutStoredQueryCommandInput): import("@smithy/core/client").CommandImpl<PutStoredQueryCommandInput, PutStoredQueryCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
