...
declare const DeleteOrganizationConformancePackCommand_base: {
    new (input: DeleteOrganizationConformancePackCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteOrganizationConformancePackCommandInput, DeleteOrganizationConformancePackCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteOrganizationConformancePackCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteOrganizationConformancePackCommandInput, DeleteOrganizationConformancePackCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
