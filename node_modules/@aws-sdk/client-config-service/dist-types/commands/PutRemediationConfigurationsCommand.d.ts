...
declare const PutRemediationConfigurationsCommand_base: {
    new (input: PutRemediationConfigurationsCommandInput): import("@smithy/smithy-client").CommandImpl<PutRemediationConfigurationsCommandInput, PutRemediationConfigurationsCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutRemediationConfigurationsCommandInput): import("@smithy/smithy-client").CommandImpl<PutRemediationConfigurationsCommandInput, PutRemediationConfigurationsCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
