...
declare const PutRemediationConfigurationsCommand_base: {
    new (input: PutRemediationConfigurationsCommandInput): import("@smithy/core/client").CommandImpl<PutRemediationConfigurationsCommandInput, PutRemediationConfigurationsCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutRemediationConfigurationsCommandInput): import("@smithy/core/client").CommandImpl<PutRemediationConfigurationsCommandInput, PutRemediationConfigurationsCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
