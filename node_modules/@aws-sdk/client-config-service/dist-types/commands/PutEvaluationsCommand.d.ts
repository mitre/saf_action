...
declare const PutEvaluationsCommand_base: {
    new (input: PutEvaluationsCommandInput): import("@smithy/smithy-client").CommandImpl<PutEvaluationsCommandInput, PutEvaluationsCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutEvaluationsCommandInput): import("@smithy/smithy-client").CommandImpl<PutEvaluationsCommandInput, PutEvaluationsCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
