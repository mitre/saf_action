...
import type { PutEvaluationsRequest, PutEvaluationsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const PutEvaluationsCommand_base: {
    new (input: PutEvaluationsCommandInput): import("@smithy/core/client").CommandImpl<PutEvaluationsCommandInput, PutEvaluationsCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutEvaluationsCommandInput): import("@smithy/core/client").CommandImpl<PutEvaluationsCommandInput, PutEvaluationsCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
