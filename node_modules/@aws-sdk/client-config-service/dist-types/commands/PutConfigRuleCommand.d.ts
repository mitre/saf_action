...
declare const PutConfigRuleCommand_base: {
    new (input: PutConfigRuleCommandInput): import("@smithy/core/client").CommandImpl<PutConfigRuleCommandInput, PutConfigRuleCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutConfigRuleCommandInput): import("@smithy/core/client").CommandImpl<PutConfigRuleCommandInput, PutConfigRuleCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
