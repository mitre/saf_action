...
declare const PutConfigRuleCommand_base: {
    new (input: PutConfigRuleCommandInput): import("@smithy/smithy-client").CommandImpl<PutConfigRuleCommandInput, PutConfigRuleCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutConfigRuleCommandInput): import("@smithy/smithy-client").CommandImpl<PutConfigRuleCommandInput, PutConfigRuleCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
