...
declare const GetComplianceDetailsByConfigRuleCommand_base: {
    new (input: GetComplianceDetailsByConfigRuleCommandInput): import("@smithy/smithy-client").CommandImpl<GetComplianceDetailsByConfigRuleCommandInput, GetComplianceDetailsByConfigRuleCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetComplianceDetailsByConfigRuleCommandInput): import("@smithy/smithy-client").CommandImpl<GetComplianceDetailsByConfigRuleCommandInput, GetComplianceDetailsByConfigRuleCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
