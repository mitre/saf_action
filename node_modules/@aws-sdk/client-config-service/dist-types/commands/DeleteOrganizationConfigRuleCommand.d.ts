...
declare const DeleteOrganizationConfigRuleCommand_base: {
    new (input: DeleteOrganizationConfigRuleCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteOrganizationConfigRuleCommandInput, DeleteOrganizationConfigRuleCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteOrganizationConfigRuleCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteOrganizationConfigRuleCommandInput, DeleteOrganizationConfigRuleCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
