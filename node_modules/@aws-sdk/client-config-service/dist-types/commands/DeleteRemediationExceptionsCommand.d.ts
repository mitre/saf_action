...
declare const DeleteRemediationExceptionsCommand_base: {
    new (input: DeleteRemediationExceptionsCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRemediationExceptionsCommandInput, DeleteRemediationExceptionsCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteRemediationExceptionsCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRemediationExceptionsCommandInput, DeleteRemediationExceptionsCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
