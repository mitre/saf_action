...
declare const PutConfigurationAggregatorCommand_base: {
    new (input: PutConfigurationAggregatorCommandInput): import("@smithy/smithy-client").CommandImpl<PutConfigurationAggregatorCommandInput, PutConfigurationAggregatorCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutConfigurationAggregatorCommandInput): import("@smithy/smithy-client").CommandImpl<PutConfigurationAggregatorCommandInput, PutConfigurationAggregatorCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
