...
declare const PutConfigurationAggregatorCommand_base: {
    new (input: PutConfigurationAggregatorCommandInput): import("@smithy/core/client").CommandImpl<PutConfigurationAggregatorCommandInput, PutConfigurationAggregatorCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutConfigurationAggregatorCommandInput): import("@smithy/core/client").CommandImpl<PutConfigurationAggregatorCommandInput, PutConfigurationAggregatorCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
