...
declare const GetAggregateConfigRuleComplianceSummaryCommand_base: {
    new (input: GetAggregateConfigRuleComplianceSummaryCommandInput): import("@smithy/smithy-client").CommandImpl<GetAggregateConfigRuleComplianceSummaryCommandInput, GetAggregateConfigRuleComplianceSummaryCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetAggregateConfigRuleComplianceSummaryCommandInput): import("@smithy/smithy-client").CommandImpl<GetAggregateConfigRuleComplianceSummaryCommandInput, GetAggregateConfigRuleComplianceSummaryCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
