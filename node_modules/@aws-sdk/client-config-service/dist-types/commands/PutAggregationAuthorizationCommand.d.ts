...
declare const PutAggregationAuthorizationCommand_base: {
    new (input: PutAggregationAuthorizationCommandInput): import("@smithy/smithy-client").CommandImpl<PutAggregationAuthorizationCommandInput, PutAggregationAuthorizationCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutAggregationAuthorizationCommandInput): import("@smithy/smithy-client").CommandImpl<PutAggregationAuthorizationCommandInput, PutAggregationAuthorizationCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
