...
declare const PutAggregationAuthorizationCommand_base: {
    new (input: PutAggregationAuthorizationCommandInput): import("@smithy/core/client").CommandImpl<PutAggregationAuthorizationCommandInput, PutAggregationAuthorizationCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutAggregationAuthorizationCommandInput): import("@smithy/core/client").CommandImpl<PutAggregationAuthorizationCommandInput, PutAggregationAuthorizationCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
