...
declare const PutOrganizationConfigRuleCommand_base: {
    new (input: PutOrganizationConfigRuleCommandInput): import("@smithy/core/client").CommandImpl<PutOrganizationConfigRuleCommandInput, PutOrganizationConfigRuleCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutOrganizationConfigRuleCommandInput): import("@smithy/core/client").CommandImpl<PutOrganizationConfigRuleCommandInput, PutOrganizationConfigRuleCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
