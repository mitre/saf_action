...
declare const PutOrganizationConfigRuleCommand_base: {
    new (input: PutOrganizationConfigRuleCommandInput): import("@smithy/smithy-client").CommandImpl<PutOrganizationConfigRuleCommandInput, PutOrganizationConfigRuleCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutOrganizationConfigRuleCommandInput): import("@smithy/smithy-client").CommandImpl<PutOrganizationConfigRuleCommandInput, PutOrganizationConfigRuleCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
