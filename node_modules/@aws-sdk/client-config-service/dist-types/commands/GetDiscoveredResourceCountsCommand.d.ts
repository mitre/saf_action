...
import type { GetDiscoveredResourceCountsRequest, GetDiscoveredResourceCountsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetDiscoveredResourceCountsCommand_base: {
    new (input: GetDiscoveredResourceCountsCommandInput): import("@smithy/core/client").CommandImpl<GetDiscoveredResourceCountsCommandInput, GetDiscoveredResourceCountsCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetDiscoveredResourceCountsCommandInput]): import("@smithy/core/client").CommandImpl<GetDiscoveredResourceCountsCommandInput, GetDiscoveredResourceCountsCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
