...
declare const PutConformancePackCommand_base: {
    new (input: PutConformancePackCommandInput): import("@smithy/core/client").CommandImpl<PutConformancePackCommandInput, PutConformancePackCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutConformancePackCommandInput): import("@smithy/core/client").CommandImpl<PutConformancePackCommandInput, PutConformancePackCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
