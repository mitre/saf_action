...
declare const PutConformancePackCommand_base: {
    new (input: PutConformancePackCommandInput): import("@smithy/smithy-client").CommandImpl<PutConformancePackCommandInput, PutConformancePackCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutConformancePackCommandInput): import("@smithy/smithy-client").CommandImpl<PutConformancePackCommandInput, PutConformancePackCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
