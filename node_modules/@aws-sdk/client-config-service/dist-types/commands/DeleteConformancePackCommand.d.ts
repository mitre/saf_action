...
declare const DeleteConformancePackCommand_base: {
    new (input: DeleteConformancePackCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteConformancePackCommandInput, DeleteConformancePackCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteConformancePackCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteConformancePackCommandInput, DeleteConformancePackCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
