...
declare const DeleteConfigRuleCommand_base: {
    new (input: DeleteConfigRuleCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteConfigRuleCommandInput, DeleteConfigRuleCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteConfigRuleCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteConfigRuleCommandInput, DeleteConfigRuleCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
