...
declare const GetResourceEvaluationSummaryCommand_base: {
    new (input: GetResourceEvaluationSummaryCommandInput): import("@smithy/core/client").CommandImpl<GetResourceEvaluationSummaryCommandInput, GetResourceEvaluationSummaryCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetResourceEvaluationSummaryCommandInput): import("@smithy/core/client").CommandImpl<GetResourceEvaluationSummaryCommandInput, GetResourceEvaluationSummaryCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
