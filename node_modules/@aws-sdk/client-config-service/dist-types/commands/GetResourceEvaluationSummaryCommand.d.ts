 ...
 *
 */
export declare class GetResourceEvaluationSummaryCommand extends $Command<GetResourceEvaluationSummaryCommandInput, GetResourceEvaluationSummaryCommandOutput, ConfigServiceClientResolvedConfig> {
    readonly input: GetResourceEvaluationSummaryCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: GetResourceEvaluationSummaryCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: ConfigServiceClientResolvedConfig, options?: __HttpHandlerOptions): Handler<GetResourceEvaluationSummaryCommandInput, GetResourceEvaluationSummaryCommandOutput>;
    /**
     * @internal
     */
    private serialize;
