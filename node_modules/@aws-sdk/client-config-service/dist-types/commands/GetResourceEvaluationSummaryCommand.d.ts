...
declare const GetResourceEvaluationSummaryCommand_base: {
    new (input: GetResourceEvaluationSummaryCommandInput): import("@smithy/smithy-client").CommandImpl<GetResourceEvaluationSummaryCommandInput, GetResourceEvaluationSummaryCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetResourceEvaluationSummaryCommandInput): import("@smithy/smithy-client").CommandImpl<GetResourceEvaluationSummaryCommandInput, GetResourceEvaluationSummaryCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
