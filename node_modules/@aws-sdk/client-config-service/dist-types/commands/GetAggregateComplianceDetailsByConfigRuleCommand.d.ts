...
declare const GetAggregateComplianceDetailsByConfigRuleCommand_base: {
    ...
    new (__0_0: GetAggregateComplianceDetailsByConfigRuleCommandInput): import("@smithy/smithy-client").CommandImpl<GetAggregateComplianceDetailsByConfigRuleCommandInput, GetAggregateComplianceDetailsByConfigRuleCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
