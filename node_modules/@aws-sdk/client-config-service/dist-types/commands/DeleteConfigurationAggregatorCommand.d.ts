...
declare const DeleteConfigurationAggregatorCommand_base: {
    new (input: DeleteConfigurationAggregatorCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteConfigurationAggregatorCommandInput, DeleteConfigurationAggregatorCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteConfigurationAggregatorCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteConfigurationAggregatorCommandInput, DeleteConfigurationAggregatorCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
