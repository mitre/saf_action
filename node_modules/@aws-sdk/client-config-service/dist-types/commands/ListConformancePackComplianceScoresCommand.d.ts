...
import type { ListConformancePackComplianceScoresRequest, ListConformancePackComplianceScoresResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListConformancePackComplianceScoresCommand_base: {
    new (input: ListConformancePackComplianceScoresCommandInput): import("@smithy/core/client").CommandImpl<ListConformancePackComplianceScoresCommandInput, ListConformancePackComplianceScoresCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListConformancePackComplianceScoresCommandInput]): import("@smithy/core/client").CommandImpl<ListConformancePackComplianceScoresCommandInput, ListConformancePackComplianceScoresCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
