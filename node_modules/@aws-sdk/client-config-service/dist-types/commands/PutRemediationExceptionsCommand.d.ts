...
declare const PutRemediationExceptionsCommand_base: {
    new (input: PutRemediationExceptionsCommandInput): import("@smithy/smithy-client").CommandImpl<PutRemediationExceptionsCommandInput, PutRemediationExceptionsCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutRemediationExceptionsCommandInput): import("@smithy/smithy-client").CommandImpl<PutRemediationExceptionsCommandInput, PutRemediationExceptionsCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
