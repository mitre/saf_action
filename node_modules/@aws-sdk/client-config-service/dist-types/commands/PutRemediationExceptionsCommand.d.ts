...
declare const PutRemediationExceptionsCommand_base: {
    new (input: PutRemediationExceptionsCommandInput): import("@smithy/core/client").CommandImpl<PutRemediationExceptionsCommandInput, PutRemediationExceptionsCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutRemediationExceptionsCommandInput): import("@smithy/core/client").CommandImpl<PutRemediationExceptionsCommandInput, PutRemediationExceptionsCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
