...
declare const ListStoredQueriesCommand_base: {
    new (input: ListStoredQueriesCommandInput): import("@smithy/core/client").CommandImpl<ListStoredQueriesCommandInput, ListStoredQueriesCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListStoredQueriesCommandInput]): import("@smithy/core/client").CommandImpl<ListStoredQueriesCommandInput, ListStoredQueriesCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
