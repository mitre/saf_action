...
declare const ListConfigurationRecordersCommand_base: {
    new (input: ListConfigurationRecordersCommandInput): import("@smithy/core/client").CommandImpl<ListConfigurationRecordersCommandInput, ListConfigurationRecordersCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListConfigurationRecordersCommandInput]): import("@smithy/core/client").CommandImpl<ListConfigurationRecordersCommandInput, ListConfigurationRecordersCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
