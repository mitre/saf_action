...
declare const StartResourceEvaluationCommand_base: {
    new (input: StartResourceEvaluationCommandInput): import("@smithy/smithy-client").CommandImpl<StartResourceEvaluationCommandInput, StartResourceEvaluationCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartResourceEvaluationCommandInput): import("@smithy/smithy-client").CommandImpl<StartResourceEvaluationCommandInput, StartResourceEvaluationCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
