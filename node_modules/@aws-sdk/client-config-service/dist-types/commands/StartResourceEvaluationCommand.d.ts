...
declare const StartResourceEvaluationCommand_base: {
    new (input: StartResourceEvaluationCommandInput): import("@smithy/core/client").CommandImpl<StartResourceEvaluationCommandInput, StartResourceEvaluationCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartResourceEvaluationCommandInput): import("@smithy/core/client").CommandImpl<StartResourceEvaluationCommandInput, StartResourceEvaluationCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
