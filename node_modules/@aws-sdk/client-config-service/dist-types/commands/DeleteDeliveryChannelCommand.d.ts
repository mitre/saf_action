...
declare const DeleteDeliveryChannelCommand_base: {
    new (input: DeleteDeliveryChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDeliveryChannelCommandInput, DeleteDeliveryChannelCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteDeliveryChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDeliveryChannelCommandInput, DeleteDeliveryChannelCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
