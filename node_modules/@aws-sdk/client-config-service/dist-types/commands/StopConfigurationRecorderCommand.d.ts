...
declare const StopConfigurationRecorderCommand_base: {
    new (input: StopConfigurationRecorderCommandInput): import("@smithy/core/client").CommandImpl<StopConfigurationRecorderCommandInput, StopConfigurationRecorderCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopConfigurationRecorderCommandInput): import("@smithy/core/client").CommandImpl<StopConfigurationRecorderCommandInput, StopConfigurationRecorderCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
