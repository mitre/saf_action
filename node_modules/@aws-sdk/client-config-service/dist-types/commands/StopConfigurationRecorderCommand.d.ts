...
declare const StopConfigurationRecorderCommand_base: {
    new (input: StopConfigurationRecorderCommandInput): import("@smithy/smithy-client").CommandImpl<StopConfigurationRecorderCommandInput, StopConfigurationRecorderCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StopConfigurationRecorderCommandInput): import("@smithy/smithy-client").CommandImpl<StopConfigurationRecorderCommandInput, StopConfigurationRecorderCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
