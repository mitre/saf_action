...
declare const GetOrganizationCustomRulePolicyCommand_base: {
    new (input: GetOrganizationCustomRulePolicyCommandInput): import("@smithy/smithy-client").CommandImpl<GetOrganizationCustomRulePolicyCommandInput, GetOrganizationCustomRulePolicyCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetOrganizationCustomRulePolicyCommandInput): import("@smithy/smithy-client").CommandImpl<GetOrganizationCustomRulePolicyCommandInput, GetOrganizationCustomRulePolicyCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
