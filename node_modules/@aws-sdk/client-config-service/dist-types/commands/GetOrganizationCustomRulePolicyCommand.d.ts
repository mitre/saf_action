...
import type { GetOrganizationCustomRulePolicyRequest, GetOrganizationCustomRulePolicyResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetOrganizationCustomRulePolicyCommand_base: {
    new (input: GetOrganizationCustomRulePolicyCommandInput): import("@smithy/core/client").CommandImpl<GetOrganizationCustomRulePolicyCommandInput, GetOrganizationCustomRulePolicyCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetOrganizationCustomRulePolicyCommandInput): import("@smithy/core/client").CommandImpl<GetOrganizationCustomRulePolicyCommandInput, GetOrganizationCustomRulePolicyCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
