...
declare const GetAggregateDiscoveredResourceCountsCommand_base: {
    new (input: GetAggregateDiscoveredResourceCountsCommandInput): import("@smithy/smithy-client").CommandImpl<GetAggregateDiscoveredResourceCountsCommandInput, GetAggregateDiscoveredResourceCountsCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetAggregateDiscoveredResourceCountsCommandInput): import("@smithy/smithy-client").CommandImpl<GetAggregateDiscoveredResourceCountsCommandInput, GetAggregateDiscoveredResourceCountsCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
