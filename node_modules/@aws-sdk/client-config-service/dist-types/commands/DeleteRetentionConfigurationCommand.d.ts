...
declare const DeleteRetentionConfigurationCommand_base: {
    new (input: DeleteRetentionConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRetentionConfigurationCommandInput, DeleteRetentionConfigurationCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteRetentionConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRetentionConfigurationCommandInput, DeleteRetentionConfigurationCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
