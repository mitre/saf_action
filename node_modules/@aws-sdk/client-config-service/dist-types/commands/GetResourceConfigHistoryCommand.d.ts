...
declare const GetResourceConfigHistoryCommand_base: {
    new (input: GetResourceConfigHistoryCommandInput): import("@smithy/core/client").CommandImpl<GetResourceConfigHistoryCommandInput, GetResourceConfigHistoryCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetResourceConfigHistoryCommandInput): import("@smithy/core/client").CommandImpl<GetResourceConfigHistoryCommandInput, GetResourceConfigHistoryCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
