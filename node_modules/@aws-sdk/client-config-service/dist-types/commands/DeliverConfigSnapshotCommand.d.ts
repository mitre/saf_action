...
declare const DeliverConfigSnapshotCommand_base: {
    new (input: DeliverConfigSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<DeliverConfigSnapshotCommandInput, DeliverConfigSnapshotCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeliverConfigSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<DeliverConfigSnapshotCommandInput, DeliverConfigSnapshotCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
