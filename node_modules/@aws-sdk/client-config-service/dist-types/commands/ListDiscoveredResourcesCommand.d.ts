...
declare const ListDiscoveredResourcesCommand_base: {
    new (input: ListDiscoveredResourcesCommandInput): import("@smithy/core/client").CommandImpl<ListDiscoveredResourcesCommandInput, ListDiscoveredResourcesCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDiscoveredResourcesCommandInput): import("@smithy/core/client").CommandImpl<ListDiscoveredResourcesCommandInput, ListDiscoveredResourcesCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
