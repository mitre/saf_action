...
declare const StartConfigurationRecorderCommand_base: {
    new (input: StartConfigurationRecorderCommandInput): import("@smithy/smithy-client").CommandImpl<StartConfigurationRecorderCommandInput, StartConfigurationRecorderCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartConfigurationRecorderCommandInput): import("@smithy/smithy-client").CommandImpl<StartConfigurationRecorderCommandInput, StartConfigurationRecorderCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
