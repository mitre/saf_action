...
declare const GetConformancePackComplianceDetailsCommand_base: {
    new (input: GetConformancePackComplianceDetailsCommandInput): import("@smithy/smithy-client").CommandImpl<GetConformancePackComplianceDetailsCommandInput, GetConformancePackComplianceDetailsCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetConformancePackComplianceDetailsCommandInput): import("@smithy/smithy-client").CommandImpl<GetConformancePackComplianceDetailsCommandInput, GetConformancePackComplianceDetailsCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
