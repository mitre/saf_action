...
declare const DeleteConfigurationRecorderCommand_base: {
    new (input: DeleteConfigurationRecorderCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteConfigurationRecorderCommandInput, DeleteConfigurationRecorderCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteConfigurationRecorderCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteConfigurationRecorderCommandInput, DeleteConfigurationRecorderCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
