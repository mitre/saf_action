...
declare const DescribeAggregateComplianceByConfigRulesCommand_base: {
    new (input: DescribeAggregateComplianceByConfigRulesCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAggregateComplianceByConfigRulesCommandInput, DescribeAggregateComplianceByConfigRulesCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeAggregateComplianceByConfigRulesCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAggregateComplianceByConfigRulesCommandInput, DescribeAggregateComplianceByConfigRulesCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
