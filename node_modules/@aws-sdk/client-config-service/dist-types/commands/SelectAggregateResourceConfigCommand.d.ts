...
declare const SelectAggregateResourceConfigCommand_base: {
    new (input: SelectAggregateResourceConfigCommandInput): import("@smithy/smithy-client").CommandImpl<SelectAggregateResourceConfigCommandInput, SelectAggregateResourceConfigCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SelectAggregateResourceConfigCommandInput): import("@smithy/smithy-client").CommandImpl<SelectAggregateResourceConfigCommandInput, SelectAggregateResourceConfigCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
