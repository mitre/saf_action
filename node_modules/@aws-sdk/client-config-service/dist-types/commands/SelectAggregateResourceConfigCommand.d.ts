...
declare const SelectAggregateResourceConfigCommand_base: {
    new (input: SelectAggregateResourceConfigCommandInput): import("@smithy/core/client").CommandImpl<SelectAggregateResourceConfigCommandInput, SelectAggregateResourceConfigCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SelectAggregateResourceConfigCommandInput): import("@smithy/core/client").CommandImpl<SelectAggregateResourceConfigCommandInput, SelectAggregateResourceConfigCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
