...
import type { ListResourceEvaluationsRequest, ListResourceEvaluationsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListResourceEvaluationsCommand_base: {
    new (input: ListResourceEvaluationsCommandInput): import("@smithy/core/client").CommandImpl<ListResourceEvaluationsCommandInput, ListResourceEvaluationsCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListResourceEvaluationsCommandInput]): import("@smithy/core/client").CommandImpl<ListResourceEvaluationsCommandInput, ListResourceEvaluationsCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
