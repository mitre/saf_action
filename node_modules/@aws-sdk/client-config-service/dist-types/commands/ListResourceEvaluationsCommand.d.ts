 ...
 *
 */
export declare class ListResourceEvaluationsCommand extends $Command<ListResourceEvaluationsCommandInput, ListResourceEvaluationsCommandOutput, ConfigServiceClientResolvedConfig> {
    readonly input: ListResourceEvaluationsCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: ListResourceEvaluationsCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: ConfigServiceClientResolvedConfig, options?: __HttpHandlerOptions): Handler<ListResourceEvaluationsCommandInput, ListResourceEvaluationsCommandOutput>;
    /**
     * @internal
     */
    private serialize;
