...
import type { PutRetentionConfigurationRequest, PutRetentionConfigurationResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const PutRetentionConfigurationCommand_base: {
    new (input: PutRetentionConfigurationCommandInput): import("@smithy/core/client").CommandImpl<PutRetentionConfigurationCommandInput, PutRetentionConfigurationCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutRetentionConfigurationCommandInput): import("@smithy/core/client").CommandImpl<PutRetentionConfigurationCommandInput, PutRetentionConfigurationCommandOutput, import("..").ConfigServiceClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
