...
declare const PutRetentionConfigurationCommand_base: {
    new (input: PutRetentionConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutRetentionConfigurationCommandInput, PutRetentionConfigurationCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutRetentionConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutRetentionConfigurationCommandInput, PutRetentionConfigurationCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
