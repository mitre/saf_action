...
declare const DeleteResourceConfigCommand_base: {
    new (input: DeleteResourceConfigCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteResourceConfigCommandInput, DeleteResourceConfigCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteResourceConfigCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteResourceConfigCommandInput, DeleteResourceConfigCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
