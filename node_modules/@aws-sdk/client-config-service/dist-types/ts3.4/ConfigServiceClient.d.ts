...
export type ConfigServiceClientConfigType = Partial<
...
> &
  ...
  HttpAuthSchemeInputConfig &
  ClientInputEndpointParameters;
export interface ConfigServiceClientConfig
  extends ConfigServiceClientConfigType {}
export type ConfigServiceClientResolvedConfigType =
  __SmithyResolvedConfiguration<__HttpHandlerOptions> &
    ...
    HttpAuthSchemeResolvedConfig &
    ClientResolvedEndpointParameters;
export interface ConfigServiceClientResolvedConfig
  extends ConfigServiceClientResolvedConfigType {}
export declare class ConfigServiceClient extends __Client<
...
> {
  ...
  constructor(
    ...[configuration]: __CheckOptionalClientConfig<ConfigServiceClientConfig>
  );
  destroy(): void;
