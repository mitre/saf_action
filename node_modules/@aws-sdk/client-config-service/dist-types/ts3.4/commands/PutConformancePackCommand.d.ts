...
export interface PutConformancePackCommandInput
  extends PutConformancePackRequest {}
export interface PutConformancePackCommandOutput
  extends PutConformancePackResponse,
    __MetadataBearer {}
declare const PutConformancePackCommand_base: {
  ...
  >;
  new (
    __0_0: PutConformancePackCommandInput
  ): import("@smithy/smithy-client").CommandImpl<
    PutConformancePackCommandInput,
    PutConformancePackCommandOutput,
    ConfigServiceClientResolvedConfig,
