...
export declare const ResourceType: {
    ...
    readonly ApiGatewayUsagePlan: "AWS::ApiGateway::UsagePlan";
    readonly ApiGatewayV2Integration: "AWS::ApiGatewayV2::Integration";
    ...
    readonly AppConfigExtension: "AWS::AppConfig::Extension";
    ...
    readonly AppStreamAppBlockBuilder: "AWS::AppStream::AppBlockBuilder";
    ...
    readonly B2BICapability: "AWS::B2BI::Capability";
    ...
    readonly CloudFormationStackSet: "AWS::CloudFormation::StackSet";
    readonly CloudFrontKeyValueStore: "AWS::CloudFront::KeyValueStore";
    readonly CloudFrontPublicKey: "AWS::CloudFront::PublicKey";
    ...
    readonly CodeArtifactDomain: "AWS::CodeArtifact::Domain";
    ...
    readonly ConfigConformancePack: "AWS::Config::ConformancePack";
    readonly ConfigStoredQuery: "AWS::Config::StoredQuery";
    ...
    readonly DeadlineFleet: "AWS::Deadline::Fleet";
    readonly DeadlineMonitor: "AWS::Deadline::Monitor";
    readonly DeadlineQueueFleetAssociation: "AWS::Deadline::QueueFleetAssociation";
    ...
    readonly EC2IPAMPoolCidr: "AWS::EC2::IPAMPoolCidr";
    ...
    readonly EC2SecurityGroupVpcAssociation: "AWS::EC2::SecurityGroupVpcAssociation";
    readonly EC2SnapshotBlockPublicAccess: "AWS::EC2::SnapshotBlockPublicAccess";
    readonly EC2SpotFleet: "AWS::EC2::SpotFleet";
    readonly EC2SubnetCidrBlock: "AWS::EC2::SubnetCidrBlock";
    readonly EC2SubnetNetworkAclAssociation: "AWS::EC2::SubnetNetworkAclAssociation";
    ...
    readonly EC2VerifiedAccessInstance: "AWS::EC2::VerifiedAccessInstance";
    ...
    readonly GlueDatabase: "AWS::Glue::Database";
    ...
    readonly GuardDutyMalwareProtectionPlan: "AWS::GuardDuty::MalwareProtectionPlan";
    ...
    readonly ImageBuilderLifecyclePolicy: "AWS::ImageBuilder::LifecyclePolicy";
    ...
    readonly IoTCoreDeviceAdvisorSuiteDefinition: "AWS::IoTCoreDeviceAdvisor::SuiteDefinition";
    ...
    readonly IoTThingGroup: "AWS::IoT::ThingGroup";
    ...
    readonly KafkaConnectCustomPlugin: "AWS::KafkaConnect::CustomPlugin";
    ...
    readonly LocationAPIKey: "AWS::Location::APIKey";
    ...
    readonly MSKServerlessCluster: "AWS::MSK::ServerlessCluster";
    ...
    readonly NetworkManagerTransitGatewayPeering: "AWS::NetworkManager::TransitGatewayPeering";
    ...
    readonly OpenSearchServerlessSecurityConfig: "AWS::OpenSearchServerless::SecurityConfig";
    ...
    readonly RDSIntegration: "AWS::RDS::Integration";
    ...
    readonly RedshiftIntegration: "AWS::Redshift::Integration";
    ...
    readonly Route53DNSSEC: "AWS::Route53::DNSSEC";
    readonly Route53HostedZone: "AWS::Route53::HostedZone";
    readonly Route53ProfilesProfile: "AWS::Route53Profiles::Profile";
    readonly Route53ProfilesProfileAssociation: "AWS::Route53Profiles::ProfileAssociation";
    ...
    readonly S3AccessGrant: "AWS::S3::AccessGrant";
    readonly S3AccessGrantsInstance: "AWS::S3::AccessGrantsInstance";
    readonly S3AccessGrantsLocation: "AWS::S3::AccessGrantsLocation";
    ...
    readonly SESDedicatedIpPool: "AWS::SES::DedicatedIpPool";
    ...
    readonly SSMContactsContact: "AWS::SSMContacts::Contact";
    readonly SSMDocument: "AWS::SSM::Document";
    readonly SSMIncidentsResponsePlan: "AWS::SSMIncidents::ResponsePlan";
    readonly SSMResourceDataSync: "AWS::SSM::ResourceDataSync";
    ...
    readonly SageMakerDataQualityJobDefinition: "AWS::SageMaker::DataQualityJobDefinition";
    ...
    readonly SageMakerMlflowTrackingServer: "AWS::SageMaker::MlflowTrackingServer";
    readonly SageMakerModel: "AWS::SageMaker::Model";
    readonly SageMakerModelBiasJobDefinition: "AWS::SageMaker::ModelBiasJobDefinition";
    readonly SageMakerModelExplainabilityJobDefinition: "AWS::SageMaker::ModelExplainabilityJobDefinition";
    readonly SageMakerModelQualityJobDefinition: "AWS::SageMaker::ModelQualityJobDefinition";
    ...
    readonly SageMakerUserProfile: "AWS::SageMaker::UserProfile";
    ...
    readonly SecretsManagerResourcePolicy: "AWS::SecretsManager::ResourcePolicy";
    ...
    readonly TransferServer: "AWS::Transfer::Server";
