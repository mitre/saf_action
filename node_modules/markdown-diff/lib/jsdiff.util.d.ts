...
export declare class JsDiffUtil {
    ...
    static doubleStringArrayDiff(newArray: string[][] | undefined, oldArray: string[][] | undefined): string[][];
    private static getChangeVal;
    private static getChangeWithPrefix;
}
