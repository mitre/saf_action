...
function Ft(e, t, n, r) {
	for (let a of r.keys(n)) {
		var i;
		if (e.maxTotalMergeKeys !== -1 && ++e.totalMergeKeys > e.maxTotalMergeKeys && A(e, `merge keys exceeded maxTotalMergeKeys (${e.maxTotalMergeKeys})`), t.tag.has(t.value, a)) continue;
		let o = t.tag.addPair(t.value, a, r.get(n, a));
		o && A(e, o), ((i = t.overridable) == null ? t.overridable = /* @__PURE__ */ new Set() : i).add(a);
	}
}
function It(e, t, n, r) {
	if (e.position = t.keyPosition, Pt(r)) Ft(e, t, n, r);
	else if (r.nodeKind === "sequence" && Array.isArray(n)) for (let r of n) {
		let n = e.nodeTags.get(r);
		n || A(e, "cannot merge mappings; the provided source object is unacceptable"), Ft(e, t, r, n);
	}
...
function Rt(e, t, n) {
	...
	if (r.kind === "document") r.value = t, r.hasValue = !0;
		...
		let i = r.key;
		r.key = void 0, r.hasKey = !1, Lt(e, r, i, t, n);
	...
	for (; n.eventIndex < n.events.length;) {
		...
		switch (n.position = At(e), e.type) {
			...
			case T.ALIAS: {
				...
				r || A(n, `unidentified alias "${t}"`), r.isValueFinal || A(n, `recursive alias "${t}" is not supported for tag ${r.tag.tagName} because it uses finalize()`), Rt(n, r.value, r.tag);
				break;
			}
			case T.POP: {
				let e = n.frames.pop();
				if (e.kind === "mapping" && e.hasKey && (n.position = e.keyPosition, A(n, "incomplete mapping pair in event stream")), e.kind === "document") n.documents.push(e.value);
					...
					e.anchor && (e.anchor.value = t, e.anchor.isValueFinal = !0), Rt(n, t, e.tag);
				}
				break;
			}
		}
...
var j = -1, Vt = Object.prototype.hasOwnProperty, M = 1, Ht = 2, Ut = 3, Wt = 4, Gt = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Kt = /[,\[\]{}]/, qt = /^(?:!|!!|![0-9A-Za-z-]+!)$/, Jt = String.raw`(?:%[0-9A-Fa-f]{2}|[0-9A-Za-z\-#;/?:@&=+$,_.!~*'()\[\]])`, Yt = String.raw`(?:%[0-9A-Fa-f]{2}|[0-9A-Za-z\-#;/?:@&=+$.~*'()_])`, Xt = RegExp(`^(?:${Jt})*$`), Zt = RegExp(`^(?:${Yt})+$`), Qt = RegExp(`^(?:!(?:${Jt})*|${Yt}(?:${Jt})*)$`), $t = {
	filename: "",
	maxDepth: 100
};
function en(e, t, n) {
...
function W(e, t) {
	...
	for (; r !== 0;) {
		...
		while (!z(r) && r !== 0);
		if (!z(r)) break;
		for (dn(e), n++, i = !0, r = e.input.charCodeAt(e.position); r === 32;) e.lineIndent++, r = e.input.charCodeAt(++e.position);
	}
	return n;
}
...
function hn(e, t, n) {
	Gt.test(e.input.slice(t, n)) && R(e, "the stream contains non-printable characters");
}
function gn(e, t, n) {
	...
	if (i) {
		...
		for (; s !== 0 && !V(s) && !(n && U(s));) s === 33 && (a ? R(e, "tag suffix cannot contain exclamation marks") : (o = e.input.slice(c - 1, e.position + 1), qt.test(o) || R(e, "named tag handle cannot contain such characters"), a = !0, c = e.position + 1)), s = e.input.charCodeAt(++e.position);
		l = e.input.slice(c, e.position), Kt.test(l) && R(e, "tag suffix cannot contain flow indicator characters");
	}
	return l && !(i ? Xt.test(l) : Zt.test(l)) && R(e, `tag name cannot contain such characters: ${l}`), !i && o !== "!" && o !== "!!" && !Vt.call(e.tagHandlers, o) && R(e, `undeclared tag handle "${o}"`), t.tagStart = r, t.tagEnd = e.position, !0;
}
function _n(e, t) {
...
function vn(e, t) {
	...
	let n = e.position;
	for (; e.input.charCodeAt(e.position) !== 0 && !V(e.input.charCodeAt(e.position)) && !U(e.input.charCodeAt(e.position));) e.position++;
	return e.position === n && R(e, "name of an alias node must contain at least one character"), an(e, n, e.position), !0;
}
function yn(e, t) {
...
function bn(e, t, n) {
	...
	for (; e.input.charCodeAt(e.position) !== 0;) {
		...
		z(a) ? (i = !1, yn(e, t)) : e.position === e.lineStart && G(e) ? R(e, "unexpected end of the document within a single quoted scalar") : a !== 9 && a < 32 ? R(e, "expected valid JSON character") : e.position++;
	}
...
function xn(e, t, n) {
	...
	for (; e.input.charCodeAt(e.position) !== 0;) {
		...
		if (a === 92) {
			...
			if (z(n)) yn(e, t);
			else if (un(n)) e.position++;
			else {
				let t = ln(n);
				for (t === 0 && R(e, "unknown escape sequence"); t-- > 0;) e.position++, cn(e.input.charCodeAt(e.position)) < 0 && R(e, "expected hexadecimal character");
				e.position++;
			}
		} else z(a) ? (i = !1, yn(e, t)) : e.position === e.lineStart && G(e) ? R(e, "unexpected end of the document within a double quoted scalar") : a !== 9 && a < 32 ? R(e, "expected valid JSON character") : e.position++;
	}
...
function Sn(e, t, n) {
	...
	for (e.position++; e.input.charCodeAt(e.position) !== 0;) {
		let n = e.input.charCodeAt(e.position), r = sn(n);
	...
	c && e.input.charCodeAt(e.position) === 35 && mn(e), z(e.input.charCodeAt(e.position)) ? dn(e) : e.input.charCodeAt(e.position) !== 0 && R(e, "a line break is expected");
	...
	for (; e.input.charCodeAt(e.position) !== 0;) {
		...
		mn(e), f = e.position, z(e.input.charCodeAt(e.position)) && (dn(e), f = e.position);
	}
	return hn(e, d, f), N(e, d, f, n.anchorStart, n.anchorEnd, n.tagStart, n.tagEnd, s, i, l), !0;
}
function Cn(e, t) {
...
function wn(e, t, n, r) {
	...
	return a === i ? !1 : (hn(e, i, a), N(e, i, a, r.anchorStart, r.anchorEnd, r.tagStart, r.tagEnd, E.PLAIN, O.CLIP, -1, !c), !0);
}
function K(e, t) {
	let n = e.line;
...
function Tn(e, t, n) {
	...
	let s = i ? 125 : 93;
	for (i ? nn(e, a, n.anchorStart, n.anchorEnd, n.tagStart, n.tagEnd, D.FLOW) : tn(e, a, n.anchorStart, n.anchorEnd, n.tagStart, n.tagEnd, D.FLOW), e.position++; e.input.charCodeAt(e.position) !== 0;) {
		K(e, t);
		let n = e.input.charCodeAt(e.position);
		...
		K(e, t), n = e.input.charCodeAt(e.position), (i || a || e.line === c) && n === 58 ? (r = !0, e.position++, K(e, t), i || rn(e, l), u || F(e), q(e, t, M, !1, !0) || F(e), K(e, t), i || P(e)) : i && r ? (u || F(e), F(e)) : i ? F(e) : r && (rn(e, l), u || F(e), F(e), P(e)), n = e.input.charCodeAt(e.position), n === 44 ? (o = !0, e.position++) : o = !1;
	}
...
function En(e, t, n) {
	...
	for (tn(e, e.position, n.anchorStart, n.anchorEnd, n.tagStart, n.tagEnd, D.BLOCK); e.input.charCodeAt(e.position) === 45 && H(e.input.charCodeAt(e.position + 1));) {
		e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, R(e, "tab characters must not be used in indentation"));
		let n = e.line;
		e.position++;
		let r = W(e, !0) > 0;
		if (e.firstTabInLine !== -1 && e.input.charCodeAt(e.position) === 45 && H(e.input.charCodeAt(e.position + 1)) && R(e, "bad indentation of a sequence entry"), r && e.lineIndent <= t ? F(e) : q(e, t, Ut, !1, !0), W(e, !0), e.lineIndent < t || e.position >= e.length) break;
...
function Dn(e, t, n, r) {
	...
	for (; c !== 0;) {
		...
		if ((c === 63 || c === 58) && H(l)) o || (nn(e, e.position, r.anchorStart, r.anchorEnd, r.tagStart, r.tagEnd, D.BLOCK), o = !0), c === 63 ? (i && F(e), a = !0, i = !0) : i ? i = !1 : (F(e), a = !0, i = !1), e.position += 1, s = !0;
		else {
			i && (F(e), i = !1);
			let t = I(e);
			if (!q(e, n, Ht, !1, !0)) break;
			if (e.line === u) {
				...
				if (c === 58) {
					if (c = e.input.charCodeAt(++e.position), H(c) || R(e, "a whitespace character is expected after the key-value separator within a block mapping"), !o) {
						for (L(e, t), nn(e, t.position, r.anchorStart, r.anchorEnd, r.tagStart, r.tagEnd, D.BLOCK), o = !0, q(e, n, Ht, !1, !0), c = e.input.charCodeAt(e.position); B(c);) c = e.input.charCodeAt(++e.position);
						e.position++;
					}
					a = !0, i = !1, s = !1;
		...
		if (q(e, t, Wt, !0, s) && (s = !1), i || s && (F(e), s = !1), W(e, !0), c = e.input.charCodeAt(e.position), (e.line === u || e.lineIndent > t) && c !== 0) R(e, "bad indentation of a mapping entry");
...
function q(e, t, n, r, i, a = !0) {
	...
	let o = 1, s = !1, c = !1, l = null, u = on(), d = n === Wt || n === Ut, f = d, p = d;
	if (r && W(e, !0) && (s = !0, o = e.lineIndent > t ? 1 : e.lineIndent === t ? 0 : -1), o === 1) for (;;) {
		...
		if (s && p && (u.tagStart !== j || u.anchorStart !== j) && (r === 33 || r === 38)) {
			var m;
			let n = I(e), r = t + 1;
			if (Dn(e, e.position - e.lineStart, r, u) && ((m = e.events[n.eventsLength]) == null ? void 0 : m.type) === T.MAPPING) return e.depth--, !0;
			L(e, n);
		}
		if (s && (r === 33 && u.tagStart !== j || r === 38 && u.anchorStart !== j) || !gn(e, u, n === M) && !_n(e, u)) break;
		l === null && (l = i), W(e, !0) ? (s = !0, f = p, o = e.lineIndent > t ? 1 : e.lineIndent === t ? 0 : -1) : f = !1;
	}
	if (f && (f = s || i), o === 1 || n === Wt) {
		let r = n === M || n === Ht ? t : t + 1, i = e.position - e.lineStart;
		if (o === 1) if (f && (En(e, i, u) || Dn(e, i, r, u)) || Tn(e, r, u)) c = !0;
			...
			if (l !== null && a && p && !f && t !== 124 && t !== 62) {
				...
				L(e, l), Dn(e, n, r, on()) && ((h = e.events[t.eventsLength]) == null ? void 0 : h.type) === T.MAPPING ? c = !0 : L(e, t);
			}
...
function On(e) {
	...
	if (z(e.input.charCodeAt(e.position)) && dn(e), n === "YAML") {
		...
		let [t, n] = r;
		qt.test(t) || R(e, "ill-formed tag handle (first argument) of the TAG directive"), Vt.call(e.tagHandlers, t) && R(e, `there is a previously declared suffix for "${t}" tag handle`), Qt.test(n) || R(e, "ill-formed tag prefix (second argument) of the TAG directive"), e.tagHandlers[t] = n, e.directives.push({
			kind: "tag",
			handle: t,
			prefix: n
		});
...
function kn(e) {
	...
	if (en(e, n, !1), q(e, e.lineIndent - 1, Wt, !1, i, i) || F(e), W(e, !0), e.position === e.lineStart && G(e) && (r = e.input.charCodeAt(e.position) === 46, r)) {
		let t = e.line;
		e.position += 3, W(e, !0), e.line === t && e.position < e.length && R(e, "end of the stream or a document separator is expected");
	}
	let o = e.events[a];
	(o == null ? void 0 : o.type) === T.DOCUMENT && (o.explicitEnd = r), P(e), !r && e.position < e.length && !pn(e) && R(e, "end of the stream or a document separator is expected");
}
function An(e, t) {
	let n = e.length, r = x(x(x({}, $t), t), {}, {
		input: `${e}\0`,
		length: n,
		position: 0,
		line: 0,
	...
	for (i !== -1 && w.throwAt(e, i, "null byte is not allowed in input", r.filename); r.position < r.length && (fn(r), W(r, !0), !(r.position >= r.length));) {
		let e = r.position;
		kn(r), r.position === e && R(r, "can not read a document");
	}
	return r.events;
}
//#endregion
...
var jn = x(x({}, $t), kt);
function Mn(e, t = {}) {
	let n = x(x({}, jn), t), r = String(e), i = Object.keys($t), a = Object.keys(kt);
	return Bt(An(r, Ve(n, i)), x(x({}, Ve(n, a)), {}, { source: r }));
}
function Nn(e, t, n) {
	let r = null;
...
var Rn = Symbol("visit:break"), zn = Symbol("visit:skip");
function Bn(e, t, n) {
	let r = t(e, n);
	if (r === Rn) return !0;
	if (r === zn) return !1;
	...
	switch (e.kind) {
		case "sequence":
			for (let n of e.items) if (Bn(n, t, {
				depth: i,
				parent: e,
				isKey: !1
			})) return !0;
			break;
		case "mapping":
			for (let { key: n, value: r } of e.items) if (Bn(n, t, {
				depth: i,
				parent: e,
				isKey: !0
			}) || Bn(r, t, {
...
function Vn(e, t) {
	for (let n of e) if (n.contents && Bn(n.contents, t, {
		depth: 0,
		parent: null,
		isKey: !1
	})) return;
...
var Un = {
	applyQuoteFlowKeysOption: Gn,
	doubleQuoteForInvisibles: Kn,
	doubleQuoteWhitespaceOnly: qn,
	applyForceQuotesOption: Jn,
	tryLongOrMultilineAsBlock: Yn,
	quoteInvalidPlain: Xn,
	fallbackToDoubleQuoted: Zn
};
function Wn(e) {
	return e.presenterOptions.quoteStyle === "single" && Hn(e.allowedStylesMask, E.SINGLE_QUOTED) ? E.SINGLE_QUOTED : E.DOUBLE_QUOTED;
}
function Gn(e) {
...
function Xn(e) {
	e.style === E.PLAIN && !Hn(e.allowedStylesMask, E.PLAIN) && (e.style = Wn(e));
}
function Zn(e) {
	Hn(e.allowedStylesMask, e.style) || (e.style = E.DOUBLE_QUOTED);
}
//#endregion
...
var Qn = "[\\x09\\x0A\\x0D\\x20-\\x7E\\x85\\xA0-\\uD7FF\\uE000-\\uFFFD\\u{10000}-\\u{10FFFF}]", $n = "[\\n\\r]", er = "\\uFEFF", tr = "[ \\t]", nr = `(?:(?!(?:${$n}|${er}))${Qn})`, rr = `(?:(?!${tr})${nr})`, ir = "[\\x09\\x20-\\uD7FF\\uE000-\\uFFFF\\u{10000}-\\u{10FFFF}]", ar = "[-?:,\\[\\]{}#&*!|>'\"%@`]", or = "[,\\[\\]{}]", sr = rr, cr = `(?:(?!${or})${rr})`, lr = `(?:(?:(?!${ar})${rr})|[?:-](?=${sr}))`, ur = `(?:(?:(?!${ar})${rr})|[?:-](?=${cr}))`, dr = `(?:(?:(?![:#])${sr})|:(?=${sr}))#*`, fr = `(?:(?:(?![:#])${cr})|:(?=${cr}))#*`, pr = `(?:${tr}*${dr})*`, mr = `(?:${tr}*${fr})*`, hr = `${lr}#*${pr}`, gr = `${ur}#*${mr}`, _r = hr, vr = gr, yr = `\\n+${dr}${pr}`, br = `\\n+${fr}${mr}`, xr = `${hr}(?:${yr})*`, Sr = `${gr}(?:${br})*`, Cr = RegExp(`^(?:${xr})$`, "u"), wr = RegExp(`^(?:${Sr})$`, "u"), Tr = RegExp(`^(?:${_r})$`, "u"), Er = RegExp(`^(?:${vr})$`, "u"), Dr = RegExp(`^(?:${ir})*$`, "u"), Or = RegExp(`^(?:${ir}|\\n)*$`, "u"), kr = RegExp(`^(?:${nr}|\\n)*$`, "u"), Ar = /^(?:---|\.\.\.)(?=$|[ \t\n\r])/, jr = /^(?:---|\.\.\.)(?=$|[ \t\n\r])/m;
function Mr(e) {
	let t = e.node.value;
	if (t !== "") {
		if (!(e.isKey ? e.flowOnly ? Er : Tr : e.flowOnly ? wr : Cr).test(t) || e.shiftOfFirstLine === 0 && Ar.test(t)) return !1;
		if (e.shiftOfContent === 0) {
			let e = t.indexOf("\n");
			if (e !== -1) {
				let n = t.slice(e + 1);
				if (jr.test(n)) return !1;
			}
		}
	}
...
function Nr(e) {
	let t = e.node.value;
	if (!(e.isKey ? Dr : Or).test(t) || /[ \t]\n|\n[ \t]/.test(t)) return !1;
	if (!e.isKey && e.shiftOfContent === 0) {
		let e = t.indexOf("\n");
		if (e !== -1 && jr.test(t.slice(e + 1))) return !1;
	}
	return !0;
}
function Pr(e) {
	if (e.flowOnly || !kr.test(e.node.value)) return !1;
	let t = e.shiftOfContent - e.shiftOfParent;
	return !(t < 1 || t > 9 && /^\n* /.test(e.node.value) || e.shiftOfContent === 0 && jr.test(e.node.value));
}
function Fr(e) {
	let t = X(0, E.DOUBLE_QUOTED);
	Mr(e) && (t = X(t, E.PLAIN)), Nr(e) && (t = X(t, E.SINGLE_QUOTED)), Pr(e) && (t = X(X(t, E.LITERAL_BLOCK), E.FOLDED_BLOCK)), e.allowedStylesMask = t;
}
function Ir(e) {
	switch (e.style) {
		case E.PLAIN: return Lr(e);
		case E.SINGLE_QUOTED: return Rr(e);
		case E.LITERAL_BLOCK: return zr(e);
		case E.FOLDED_BLOCK: return Br(e);
		case E.DOUBLE_QUOTED: return Vr(e);
	}
}
function Lr(e) {
	return Hr(e.node.value, e.shiftOfContent);
}
function Rr(e) {
	return `'${Hr(e.node.value, e.shiftOfContent).replace(/'/g, "''")}'`;
}
function zr(e) {
	let t = e.node.value;
	return "|" + Gr(t, e.shiftOfParent, e.shiftOfContent) + Kr(Ur(t, e.shiftOfContent));
}
function Br(e) {
	let t = e.node.value, n = e.presenterOptions.lineWidth, r = Infinity;
	return n !== -1 && (r = Math.max(Math.min(n, 40), n - e.shiftOfContent)), ">" + Gr(t, e.shiftOfParent, e.shiftOfContent) + Kr(Ur(Yr(t, r), e.shiftOfContent));
}
function Vr(e) {
	return `"${Qr(e.node.value)}"`;
}
function Hr(e, t) {
	let n = e.indexOf("\n");
	if (n === -1) return e;
...
function Gr(e, t, n) {
	let r = Wr(e) ? String(n - t) : "", i = e[e.length - 1] === "\n";
...
function Yr(e, t) {
	...
	let i = Jr(e.slice(0, r), t), a = e[0] === "\n" || qr(e[0]), o, s;
	for (; s = n.exec(e);) {
		let e = s[1], n = s[2];
		o = n !== "" && qr(n[0]), i += e + (!a && !o && n !== "" ? "\n" : "") + Jr(n, t), a = o;
	}
	return i;
}
var Xr = /["\\\x00-\x1F\x7F-\xA0\u2028\u2029\uD800-\uDFFF\uFEFF\uFFFE\uFFFF]/gu;
function Zr(e) {
	switch (e) {
		case "\0": return "\\0";
		case "\x07": return "\\a";
...
var Z = 10, $r = {
	...
	quoteStyle: "single",
	forceQuotes: !1,
	scalarStyleRules: Object.keys(Un).map((e) => Reflect.get(Un, e)),
	tagBeforeAnchor: !1
};
function ei(e) {
...
function ai(e, t, n, r) {
	...
	for (let a = 0, o = n.items.length; a < o; a += 1) {
		...
		(!r || i !== "") && (i += ni(e, t)), o === "" || Z === o.charCodeAt(0) ? i += "-" : i += "- ", i += o;
	}
	return i;
}
function oi(e, t, n) {
...
function si(e, t, n, r) {
	...
	for (let a = 0, o = n.items.length; a < o; a += 1) {
		...
		m && (d && Z === d.charCodeAt(0) ? o += "?" : o += "? "), o += d, m && (o += ni(e, t));
		let h = Q(e, t + 1, c, n, {
			block: !0,
			compact: m,
			isblockseq: m && !ci(e, c, t + 1)
...
function Q(e, t, n, r, i) {
	...
	if (n.kind === "mapping") d = p ? si(e, t, n, l) : oi(e, t, n);
	else if (n.kind === "sequence") d = p ? e.seqNoIndent && !c && t > 0 ? ai(e, t - 1, n, l) : ai(e, t, n, l) : ii(e, t, n);
	else {
		let i = ri(e, n, r, t, s, !o);
		Fr(i);
		for (let t of e.scalarStyleRules) t(i);
		d = Ir(i), e.openEnded = (i.style === E.LITERAL_BLOCK || i.style === E.FOLDED_BLOCK) && (n.value === "\n" || n.value.endsWith("\n\n")), f = n.tagged || d === "" && i.flowOnly && (r == null ? void 0 : r.kind) === "sequence" && !u || i.style !== E.PLAIN && n.tag !== e.defaultScalarTagName;
	}
	(n.kind === "mapping" || n.kind === "sequence") && !p && (e.openEnded = !1), p && l && t > 0 && e.indent > 2 && (d = `${" ".repeat(e.indent - 2)}${d}`);
	let m = d === "", h = d;
	if (f || u) {
		let t = [], r = f ? ei(n) : null, i = u ? `&${n.anchor}` : null;
...
function di(e, t) {
	...
	for (let t = 0; t < e.length; t += 1) {
		let a = e[t];
		n.openEnded = !1;
		let o = ui(a), s = o !== "", c = a.explicitStart || s || t > 0 && !i;
		if (r += o, a.contents === null) c && (r += "---\n");
		else if (c) {
			let e = Q(n, 0, a.contents, null, {
				block: !0,
				compact: !0
			}).text, t = e === "" ? "" : s || li(a.contents) ? "\n" : " ";
			r += `---${t}${e}\n`;
...
function mi(e, t = {}) {
	let n = x(x({}, fi), t), r = Ln(e, n.schema, {
		noRefs: n.noRefs,
		skipInvalid: n.skipInvalid
	});
	if (n.flowLevel >= 0 && Vn(r, (e, t) => {
		if (!(t.depth < n.flowLevel)) return (e.kind === "sequence" || e.kind === "mapping") && (e.style = D.FLOW), zn;
	}), n.sortKeys) {
		let e = n.sortKeys === !0 ? pi : n.sortKeys;
		Vn(r, (t) => {
			t.kind === "mapping" && t.items.sort((t, n) => e(t.key.kind === "scalar" ? t.key.value : "", n.key.kind === "scalar" ? n.key.value : ""));
		});
	}
	return n.transform(r), di(r, x(x({}, Ve(n, Object.keys($r))), {}, { schema: n.schema }));
}
//#endregion
...
function vi(e, t) {
	let n = Ct(e.source, t), r = gi(e, t), i, a = !1;
	...
	for (; n.eventIndex < e.length;) {
		...
		switch (n.position = hi(t), t.type) {
			...
			case T.SCALAR:
				...
				break;
			case T.SEQUENCE: {
				let { tag: e, tagged: r, style: i, anchor: a } = yi(n, t, "tag:yaml.org,2002:seq"), o = {
					kind: "sequence",
					tag: e,
					tagged: r,
					style: i,
			...
			case T.MAPPING: {
				let { tag: e, tagged: r, style: i, anchor: a } = yi(n, t, "tag:yaml.org,2002:map"), o = {
					kind: "mapping",
					tag: e,
					tagged: r,
					style: i,
			...
			case T.POP: {
				...
				e.kind === "document" ? n.documents.push(e.doc) : bi(n, e.node);
				break;
			}
		}
	}
...
//#endregion
//#region src/index.ts
var Si = T.DOCUMENT, Ci = T.SEQUENCE, wi = T.MAPPING, Ti = T.SCALAR, Ei = T.ALIAS, Di = T.POP, Oi = E.PLAIN, ki = E.SINGLE_QUOTED, Ai = E.DOUBLE_QUOTED, ji = E.LITERAL_BLOCK, Mi = E.FOLDED_BLOCK, Ni = D.BLOCK, Pi = D.FLOW, Fi = O.CLIP, Ii = O.STRIP, Li = O.KEEP;
//#endregion
export { Fi as CHOMPING_CLIP, Li as CHOMPING_KEEP, O as CHOMPING_MODE, Ii as CHOMPING_STRIP, D as COLLECTION_STYLE, Ni as COLLECTION_STYLE_BLOCK, Pi as COLLECTION_STYLE_FLOW, $e as CORE_SCHEMA, Un as DEFAULT_SCALAR_STYLE_RULES, tt as DUMP_SCHEMA, Ei as EVENT_ALIAS, Si as EVENT_DOCUMENT, T as EVENT_ID, wi as EVENT_MAPPING, Di as EVENT_POP, Ti as EVENT_SCALAR, Ci as EVENT_SEQUENCE, C as FAILSAFE_SCHEMA, Qe as JSON_SCHEMA, e as NOT_RESOLVED, E as SCALAR_STYLE, Ai as SCALAR_STYLE_DOUBLE_QUOTED, Mi as SCALAR_STYLE_FOLDED_BLOCK, ji as SCALAR_STYLE_LITERAL_BLOCK, Oi as SCALAR_STYLE_PLAIN, ki as SCALAR_STYLE_SINGLE_QUOTED, S as Schema, Rn as VISIT_BREAK, zn as VISIT_SKIP, et as YAML11_SCHEMA, w as YAMLException, Pe as binaryTag, f as boolCoreTag, h as boolJsonTag, ne as boolYaml11Tag, Bt as constructFromEvents, r as defineMappingTag, t as defineScalarTag, n as defineSequenceTag, mi as dump, xi as eventsToAst, be as floatCoreTag, Te as floatJsonTag, _ as floatYaml11Tag, Ct as getScalarValue, se as intCoreTag, fe as intJsonTag, g as intYaml11Tag, Ln as jsToAst, it as legacyMapTag, Pn as load, Nn as loadAll, We as mapTag, Ae as mergeTag, o as nullCoreTag, s as nullJsonTag, l as nullYaml11Tag, He as omapTag, Ue as pairsTag, An as parseEvents, di as present, nt as realMapTag, Be as seqTag, Ge as setTag, i as strTag, ze as timestampTag, Vn as visit };
