...
declare const ListStoredQueriesCommand_base: {
    new (input: ListStoredQueriesCommandInput): import("@smithy/smithy-client").CommandImpl<ListStoredQueriesCommandInput, ListStoredQueriesCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListStoredQueriesCommandInput]): import("@smithy/smithy-client").CommandImpl<ListStoredQueriesCommandInput, ListStoredQueriesCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
