...
declare const GetComplianceDetailsByResourceCommand_base: {
    new (input: GetComplianceDetailsByResourceCommandInput): import("@smithy/smithy-client").CommandImpl<GetComplianceDetailsByResourceCommandInput, GetComplianceDetailsByResourceCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetComplianceDetailsByResourceCommandInput]): import("@smithy/smithy-client").CommandImpl<GetComplianceDetailsByResourceCommandInput, GetComplianceDetailsByResourceCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
