...
import { AttestationData, ControlAttestationStatus } from 'inspecjs/src/generated_parsers/v_1_0/exec-json';
import moment from 'moment';
export type Attestation = Omit<AttestationData, 'status'> & {
    status: `${ControlAttestationStatus}`;
};
export declare function advanceDate(date: moment.Moment, frequency: string): moment.Moment;
export declare function createAttestationMessage(attestation: Attestation, expired: boolean): string;
