...
exports.FromHDFToSplunkMapper = exports.FromHDFControlToSplunkControlMapper = exports.FromHDFProfileToSplunkProfileMapper = exports.FromHDFExecutionToSplunkExecutionMapper = exports.createControlMapping = exports.createProfileMapping = exports.getProfileRunLevel = exports.getDependencies = exports.createReportMapping = exports.createGUID = void 0;
...
class FromHDFToSplunkMapper extends reverse_any_base_converter_1.FromAnyBaseConverter {
    constructor(data, logService, loggingLevel) {
        ...
        super((0, global_1.ensureContextualizedEvaluation)(data));
    ...
    async uploadSplunkData(config, targetIndex, splunkData) {
        ...
        try {
            ...
            const controlEvents = _.chunk(splunkData.controls, UPLOAD_CHUNK_SIZE).map((chunk) => {
                return this.axiosInstance
