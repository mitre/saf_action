...
exports.BaseConverter = exports.DEFAULT_XML_PROCESS_ENTITIES_OPTIONS = void 0;
...
exports.DEFAULT_XML_PROCESS_ENTITIES_OPTIONS = {
    enabled: true,
    maxEntityCount: 100,
...
function parseXml(xml, additionalOptions) {
    const options = {
        ...
        parseTagValue: false,
        processEntities: exports.DEFAULT_XML_PROCESS_ENTITIES_OPTIONS,
        removeNSPrefix: true,
        ...additionalOptions,
    };
    ...
    evaluate(file, v) {
        ...
        if (_.keys(v).length > 0 && hasTransformer) {
            return {
                ...
                ...this.convertInternal(hasPath ? pathV : file, transformer(hasPath ? pathV : file))
            };
        }
        if (hasTransformer) {
    ...
    handleArray(file, v) {
        ...
        for (const lookupPath of v) {
            if (lookupPath.path === undefined) {
                ...
                let output = [];
                output.push(this.evaluate(file, lookupPath));
