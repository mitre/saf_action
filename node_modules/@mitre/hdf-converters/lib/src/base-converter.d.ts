...
export type ObjectEntryValue<T> = {
...
export declare const DEFAULT_XML_PROCESS_ENTITIES_OPTIONS: {
    enabled: true;
...
export declare function parseXml(xml: string, additionalOptions?: X2jOptions): Record<string, unknown>;
