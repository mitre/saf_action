...
exports.InvalidChecklistMetadataException = void 0;
    ...
    properties: {
        ...
        hostip: {
            ...
            conform: (ip) => {
                ...
                return ipAddresses.every((address) => (0, validator_1.isIP)(address));
            },
        ...
        hostmac: {
            ...
            conform: (mac) => {
                ...
                return macAddresses.every((address) => (0, validator_1.isMACAddress)(address));
            },
