...
class XCCDFResultsMapper extends base_converter_1.BaseConverter {
    constructor(scapXml, withRaw = false) {
        ...
        this.mappings = {
            ...
            passthrough: {
                transformer: (data) => {
                    let auxData = lodash_1.default.has(data, 'Benchmark')
                        ? lodash_1.default.get(data, 'Benchmark')
                        : lodash_1.default.get(data, 'cdf:Benchmark');
                    ...
                    auxData = lodash_1.default.has(data, 'Benchmark')
                        ? { Benchmark: auxData }
