                    ...
                    controls: [
                        {
                            ...
                            tags: {
                                ...
                                description: {
                                    ...
                                    transformer: (description) => _.get((0, base_converter_1.parseXml)(description), 'VulnDiscussion', description)
                                },
                                group_id: { path: 'group.id' },
                                group_title: { path: ['group.title.text', 'group.title'] },
                                group_description: {
                                    path: ['group.description.text', 'group.description'],
                                    transformer: (description) => _.get((0, base_converter_1.parseXml)(description), 'GroupDescription', description)
                                },
                                rule_id: { path: 'id' },
                                check: {
                                    path: 'check',
                                ...
                                profiles: [
                                    {
                                        ...
                                        description: {
                                            path: ['description.text', 'description'],
                                            transformer: (description) => _.get((0, base_converter_1.parseXml)(description), 'ProfileDescription', description)
                                        },
                                ...
                                value: {
                                    ...
                                    transformer: (values) => asArray(values).map((value) => ({
                                        ...
                                        description: _.get(value, 'description.text') ||
                                            _.get(value, 'description'),
                                        warning: _.get(value, 'warning.text') || _.get(value, 'warning'),
