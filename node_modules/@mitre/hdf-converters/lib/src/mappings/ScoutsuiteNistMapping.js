...
class ScoutsuiteNistMapping {
    ...
    constructor() {
        this.data = [];
        if (Array.isArray(ScoutsuiteNistMappingData_1.data)) {
            this.data = ScoutsuiteNistMappingData_1.data.map((line) => new ScoutsuiteNistMappingItem_1.ScoutsuiteNistMappingItem(line));
        }
    }
    nistTag(rule) {
