...
export declare class SonarqubeResults {
    ...
    readonly excludeIssueStatuses?: string | undefined;
    authMethod?: AuthenticationMethod;
    axiosClient: AxiosInstance;
    constructor(sonarqubeHost: string, projectKey: string, userToken: string, branchName?: string | undefined, // if branch/pr are not specified, then sonarqube uses the default branch
    pullRequestID?: string | undefined, organization?: string | undefined, // sometimes the organization parameter is required for the api/rules/show endpoint - we try to grab it from the issue, but this is here to ensure a fallback if necessary
    withRaw?: boolean, excludeIssueStatuses?: string | undefined);
    logAxiosError(e: AxiosError): void;
    static readonly DEFAULT_DENY_LIST_LEGACY: string[];
    static readonly DEFAULT_DENY_LIST_MODERN: string[];
    discoverIssueStatuses(sonarqubeVersion: string): Promise<string>;
    getSearchResults<T extends SonarqubeVersion>(sonarqubeVersion: string): Promise<Search<T>>;
...
export {};
//# sourceMappingURL=sonarqube-mapper.d.ts.map