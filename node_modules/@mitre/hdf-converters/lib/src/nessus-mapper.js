...
class NessusResults {
    ...
    customMapping;
    withRaw;
    constructor(nessusXml, withRaw = false, options = {}) {
        ...
        const { maxTotalExpansions = DEFAULT_NESSUS_MAX_TOTAL_EXPANSIONS } = _.isPlainObject(options.processEntities)
            ? options.processEntities
            : {};
        this.data = (0, base_converter_1.parseXml)(nessusXml, {
            processEntities: {
                ...base_converter_1.DEFAULT_XML_PROCESS_ENTITIES_OPTIONS,
                maxTotalExpansions,
            },
        });
