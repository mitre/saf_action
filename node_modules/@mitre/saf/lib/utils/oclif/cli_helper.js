...
exports.printBoldRedGreen = printBoldRedGreen;
...
function printBoldRedGreen(title, info) {
    console.log(colors_1.default.bold.red(title), colors_1.default.green(info));
    processLogData.push(`${title} ${info}`);
}
...
//# sourceMappingURL=cli_helper.js.map