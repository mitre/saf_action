...
exports.checkInput = exports.getDescription = exports.getProfileInfo = exports.extractValueViaPathOrNumber = exports.arrayNeededPaths = exports.arrayedPaths = exports.getInstalledPath = exports.dataURLtoU8Array = exports.convertFullPathToFilename = exports.sliceIntoChunks = exports.checkSuffix = exports.knownInspecMetadataKeys = void 0;
...
function getInstalledPath() {
    ...
    try {
        ...
        installedPath = path_1.default.join(((_a = require.main) === null || _a === void 0 ? void 0 : _a.path.replace('/bin', '').replace('\\bin', '')) || '.');
    }
...
function getDescription(descriptions, key) {
    var _a;
    return Array.isArray(descriptions) ? (_a = descriptions.find((description) => description.label.toLowerCase() === key)) === null || _a === void 0 ? void 0 : _a.data : lodash_1.default.get(descriptions, key);
}
