...
function getJsonMetaDataExamples(endpoint) {
    ...
    const assets = '"marking": "[Unclass, CUI, etc]",'
        ...
        + `"role": "The computing role, one of: [${Object.values(hdf_converters_1.Role)}]",`
        + `"assettype": "The asset type, one of: [${Object.values(hdf_converters_1.Assettype)}]",`
        + `"techarea": "The tech area, one of: [${Object.values(hdf_converters_1.Techarea).filter(item => item !== '')}]",`
