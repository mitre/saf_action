...
exports.COLUMN_EMOJI = exports.COLUMN_ORDER = exports.ROW_ORDER = void 0;
...
*/
const logger = (0, logging_1.createWinstonLogger)({ module: 'View Summary:' });
...
function extractResultSets(execJSONs, profileName) {
    ...
    return Object.entries(execJSONs).filter(([, execJSON]) => {
        ...
        return (0, global_1.basename)(filePath);
    });
}
/**
...
//# sourceMappingURL=output_generator.js.map