import type { ContextualizedProfile, ExecJSON } from 'inspecjs';
...
export declare function getDescriptionContentsOrUndefined(label: string, descriptions?: ExecJSON.ControlDescription[] | Record<string, unknown> | null): unknown;
