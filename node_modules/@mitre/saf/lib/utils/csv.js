...
function convertRow(filename, control, fieldsToAdd) {
    ...
    if (control.data.tags.check) {
        ...
        const found = (_a = control.data.descriptions) === null || _a === void 0 ? void 0 : _a.find((description) => description.label.toLowerCase() === 'check');
        if (found) {
            check = found.data;
        }
    }
    if (control.data.tags.fix) {
        ...
        const found = (_b = control.data.descriptions) === null || _b === void 0 ? void 0 : _b.find((description) => description.label.toLowerCase() === 'fix');
        if (found) {
            fix = found.data;
        }
    }
