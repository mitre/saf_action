...
exports.inspecControlToRubyCode = exports.impactNumberToSeverityString = exports.severityStringToImpact = exports.convertEncodedHTMLIntoJson = exports.convertEncodedXmlIntoJson = void 0;
...
const wrapAndEscapeQuotes = (s) => escapeDoubleQuotes(wrap(s)); // Escape backslashes and quotes, and wrap long lines
...
function inspecControlToRubyCode(control) {
