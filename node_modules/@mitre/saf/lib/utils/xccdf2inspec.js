...
exports.inspecControlToRubyCode = exports.impactNumberToSeverityString = exports.severityStringToImpact = exports.convertEncodedXmlIntoJson = exports.wrapAndEscapeQuotes = exports.escapeDoubleQuotes = exports.escapeQuotes = exports.wrap = void 0;
...
exports.wrap = wrap;
const escapeQuotes = (s) => s.replaceAll('\\', '\\\\').replaceAll("'", "\\'"); // Escape backslashes and quotes
exports.escapeQuotes = escapeQuotes;
const escapeDoubleQuotes = (s) => s.replaceAll('\\', '\\\\').replaceAll('"', '\\"'); // Escape backslashes and double quotes
...
//# sourceMappingURL=xccdf2inspec.js.map