...
exports.wrapAndEscapeQuotes = exports.escapeDoubleQuotes = exports.escapeQuotes = void 0;
exports.wrap = wrap;
...
const escapeQuotes = (s) => s.replaceAll('\\', '\\\\').replaceAll("'", String.raw `\'`); // Escape backslashes and quotes
exports.escapeQuotes = escapeQuotes;
const escapeDoubleQuotes = (s) => s.replaceAll('\\', '\\\\').replaceAll('"', String.raw `\"`); // Escape backslashes and double quotes
...
function inspecControlToRubyCode(control, lineLength, showUtfEncoding) {
    ...
    if (control.descs) {
        for (const [key, desc] of Object.entries(control.descs)) {
            if (desc) {
