...
function severityStringToImpact(string) {
    ...
    if ((_c = string.match(/med(ium)?|cat(egory)?\s*(ii|2)/i)) === null || _c === void 0 ? void 0 : _c.length) {
        return 0.5;
    }
    if ((_d = string.match(/high|cat(egory)?\s*(i|1)/i)) === null || _d === void 0 ? void 0 : _d.length) {
        return 0.7;
    }
    if ((_e = string.match(/crit(ical)?|severe/i)) === null || _e === void 0 ? void 0 : _e.length) {
        return 1.0;
    }
