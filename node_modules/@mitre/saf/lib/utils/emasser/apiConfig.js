...
function printHelpMessage() {
    ...
    (0, utilities_1.printHelpMsg)('If a configuration file exists, it is placed in the directory where the emasser command is executed.');
}
    ...
    constructor() {
        try {
            ...
            if (error.code === 'ENOENT') {
                ...
                (0, utilities_1.printRedMsg)('An eMASS variables configuration file (.env) was not found.');
                printHelpMessage();
                process.exit(0);
            }
            else {
