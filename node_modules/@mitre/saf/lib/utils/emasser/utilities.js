...
const outputError_1 = require("./outputError");
/**
...
function saveFile(dir, filename, data) {
    ...
    fs_1.default.writeFile(outDir, data, (err) => {
        if (err) {
...
function displayError(error, endpoint) {
    if (error instanceof Error) {
        console.error((0, json_colorizer_1.colorize)((0, outputError_1.outputError)(error)));
    }
    else {
