            ...
            switch (args.endpoint) { // skipcq: JS-0047
                ...
                case 'workflow_instances': {
                    if (args.argument === 'all') {
                        flagObj = {
                            includeComments: core_1.Flags.boolean({ char: 'i', description: 'Boolean - Include transition comments', allowNo: true, required: false }),
                            pageIndex: core_1.Flags.integer({ char: 'p', description: 'The page number to query', required: false }),
                            sinceDate: core_1.Flags.string({ char: 'd', description: 'The Workflow Instance date. Unix date format', required: false }),
                            status: core_1.Flags.string({ char: 's', description: 'The Workflow status - must be a valid status', options: ['active', 'inactive', 'all'], required: false }),
                        };
                    }
