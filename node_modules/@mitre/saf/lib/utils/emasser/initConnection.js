...
const axios_1 = tslib_1.__importDefault(require("@mitre/emass_client/node_modules/axios"));
    ...
    constructor(conf) {
        ...
        this.axiosRequestConfig = {
            httpsAgent: new https_1.default.Agent({
                ...
                key: fs_1.default.readFileSync(conf.keyCert),
                cert: fs_1.default.readFileSync(conf.clientCert),
