...
function outputFormat(data, doConversion = true) {
    ...
    try {
        ...
        if (doConversion) {
            const paginationObj = { pagination: lodash_1.default.get(formatDataObj, 'pagination') };
            if (hideNulls) {
                const newData = {};
                Object.keys(formatDataObj).forEach((key1) => {
                    switch (key1) {
                        ...
                        case 'meta': {
                            const jsonData = { [key1]: formatDataObj[key1] };
                        ...
                        case 'pagination': {
                            lodash_1.default.merge(newData, paginationObj);
                            break;
                        }
