...
import { INPUT_TYPES } from '@mitre/hdf-converters';
import type { AnyProfile, ContextualizedEvaluation, ExecJSON } from 'inspecjs';
export type SpreadsheetTypes = 'cis' | 'disa' | 'general';
export declare const knownInspecMetadataKeys: string[];
export declare function checkSuffix(input: string, suffix?: string): string;
/**
 ...
 */
export declare function resolveSafeChild(baseDir: string, ...parts: string[]): string;
/**
 ...
 */
export declare function basename(inputPath: string): string;
/**
 ...
 */
export declare function safeFilename(inputPath: string): string;
/**
 ...
 */
export declare function safeExecFileSync(command: string, args: string[], options: ExecFileSyncOptionsWithStringEncoding): string;
/**
 ...
 */
export declare function dataURLtoU8Array(dataURL: string): Uint8Array;
/**
 ...
 */
export declare function getInstalledPath(moduleName: string): string;
export declare const arrayedPaths: string[];
/**
 ...
 */
export declare function arrayNeededPaths(typeOfPath: string, values: string | string[]): string | string[];
/**
 ...
 */
export declare function extractValueViaPathOrNumber(typeOfPathOrNumber: string, pathOrNumber: string | string[] | number, data: Record<string, any>): any;
 ...
 */
export declare function getProfileInfo(evaluation: ExtendedContextualizedEvaluation, fileName: string): string;
/**
 ...
 */
export declare function getDescription(descriptions: Record<string, string> | ExecJSON.ControlDescription[], key: string): string | undefined;
/**
 ...
 */
export declare function checkInput(guessOptions: {
    data: string;
    filename: string;
}, desiredType: INPUT_TYPES, desiredFormat: string): void;
/**
 ...
 */
export declare function downloadFile(url: string | undefined, outputPath: string): Promise<void>;
/**
 ...
 */
export declare function extractFileFromZip(zipPath: string, fileName: string): [Buffer | null, string];
/**
 ...
 */
export declare function getJsonMetaDataExamples(endpoint?: string): string[];
export {};
