...
ApplyAttestation.usage = 'attest apply -i <input-hdf-json>... <attestation>... -o <output-hdf-path>';
ApplyAttestation.description = 'Apply one or more attestation files to one or more HDF results sets';
ApplyAttestation.examples = [
