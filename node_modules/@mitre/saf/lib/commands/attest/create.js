...
const accurate_search_1 = __importDefault(require("accurate-search"));
...
class CreateAttestations extends base_command_1.BaseCommand {
    ...
    async run() {
        ...
        switch (flags.format) {
            ...
            case 'xlsx': {
                const workBook = await xlsx_populate_1.default.fromDataAsync((0, global_1.dataURLtoU8Array)(files_json_1.default.AttestationTemplate.data));
