...
class Fortify2HDF extends baseCommand_1.BaseCommand {
    static usage = '<%= command.id %> -i <fortify-fvdl> -o <hdf-scan-results-json> [-h] [-w]';
    ...
    async run() {
        ...
        (0, global_1.checkInput)({ data, filename: flags.input }, 'fortify', 'Fortify results FVDL file');
        const converter = new hdf_converters_1.FortifyMapper(data, flags.includeRaw);
...
//# sourceMappingURL=fortify2hdf.js.map