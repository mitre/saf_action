...
class HDF2ASFF extends command_1.Command {
    async run() {
        ...
        const converted = new hdf_converters_1.FromHdfToAsffMapper(JSON.parse(fs.readFileSync(flags.input, 'utf-8')), {
...
HDF2ASFF.flags = {
    ...
    upload: command_1.flags.boolean({ char: 'u', required: false, description: 'Upload findings to AWS Security Hub' }),
    output: command_1.flags.string({ char: 'o', required: false, description: 'Output ASFF JSON Folder' }),
    ...
    certificate: command_1.flags.string({ char: 'C', required: false, description: 'Trusted signing certificate file' }),
};
