...
class HDF2ASFF extends core_1.Command {
    async run() {
        ...
        const converted = new hdf_converters_1.FromHdfToAsffMapper(JSON.parse(fs_1.default.readFileSync(flags.input, 'utf-8')), {
            ...
            aws_sdk_1.default.config.update({
                httpOptions: {
                    agent: new https_1.default.Agent({
                        ...
                        ca: flags.certificate ? fs_1.default.readFileSync(flags.certificate, 'utf-8') : undefined,
                    }),
                },
            });
