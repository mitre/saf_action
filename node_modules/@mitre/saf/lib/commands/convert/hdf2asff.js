        ...
        if (flags.upload) {
            ...
            try {
                if (profileInfoFinding) {
                    ...
                    if ((_b = result.FailedFindings) === null || _b === void 0 ? void 0 : _b.length) {
...
HDF2ASFF.usage = 'convert hdf2asff -a <account-id> -r <region> -i <hdf-scan-results-json> -t <target> [-h] [-R] (-u [-I -C <certificate>] | [-o <asff-output-folder>])';
