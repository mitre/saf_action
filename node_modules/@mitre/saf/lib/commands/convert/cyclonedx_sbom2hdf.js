...
class CycloneDXSBOM2HDF extends core_1.Command {
    ...
    static flags = {
        ...
        input: core_1.Flags.string({ char: 'i', required: true, description: 'Input CycloneDX SBOM file' }),
    ...
    async run() {
        ...
        const converter = new hdf_converters_1.CycloneDXSBOMResults(data, flags['with-raw']);
