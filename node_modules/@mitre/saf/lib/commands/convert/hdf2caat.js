...
class HDF2CAAT extends base_command_1.BaseCommand {
    ...
    static examples = ['<%= config.bin %> <%= command.id %> -i hdf_input.json -o caat-results.xlsx'];
    static flags = {
    ...
    async run() {
        ...
        const inputData = flags.input.map(filename => ({
            ...
            filename: (0, global_1.basename)(filename),
        }));
