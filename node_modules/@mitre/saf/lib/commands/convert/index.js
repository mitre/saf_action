...
class Convert extends core_1.Command {
    static getFlagsForInputFile(path) {
        if (path) {
            Convert.detectedType = (0, hdf_converters_1.fingerprint)({ data: fs_1.default.readFileSync(path, 'utf8'), filename: (0, global_1.convertFullPathToFilename)(path) });
    ...
    async run() {
        ...
        switch (Convert.detectedType) {
            ...
            case 'twistlock': {
                converter = new hdf_converters_1.TwistlockMapper(fs_1.default.readFileSync(flags.input, 'utf8'));
                fs_1.default.writeFileSync((0, global_1.checkSuffix)(flags.output), JSON.stringify(converter.toHdf()));
                break;
            }
            case 'xccdf': {
...
Convert.description = 'The generic convert command translates any supported file-based security results set into the Heimdall Data Format';
Convert.examples = ['saf convert -i input -o output'];
Convert.flags = {
