...
const asff2hdf_1 = __importDefault(require("./asff2hdf"));
const zap2hdf_1 = __importDefault(require("./zap2hdf"));
...
class Convert extends base_command_1.BaseCommand {
        ...
        switch (Convert.detectedType) {
            ...
            case 'asff': {
                ...
                lodash_1.default.forOwn(results, (result, filename) => {
                    fs_1.default.writeFileSync((0, global_1.resolveSafeChild)(flags.output, (0, global_1.safeFilename)((0, global_1.checkSuffix)(filename))), JSON.stringify(result, null, 2));
                });
                break;
            }
            case 'burp': {
            ...
            case 'checkov': {
                converter = new hdf_converters_1.CheckovMapper(fs_1.default.readFileSync(flags.input, 'utf8'));
                fs_1.default.writeFileSync((0, global_1.checkSuffix)(flags.output), JSON.stringify(converter.toHdf(), null, 2));
                break;
            }
            case 'conveyor': {
            ...
            case 'nessus': {
                ...
                const outputBase = path_1.default.dirname(flags.output);
                const outputPrefix = (0, global_1.safeFilename)(flags.output.replaceAll(/\.json/gi, ''));
                for (const element of pluralResults) {
                    fs_1.default.writeFileSync((0, global_1.resolveSafeChild)(outputBase, (0, global_1.safeFilename)(`${outputPrefix}-${(0, global_1.basename)(lodash_1.default.get(element, 'platform.target_id') || '')}.json`)), JSON.stringify(element, null, 2));
                }
                if (singularResult) {
            ...
            case 'prisma': {
                ...
                lodash_1.default.forOwn(results, (result) => {
                    fs_1.default.writeFileSync((0, global_1.resolveSafeChild)(flags.output, (0, global_1.safeFilename)(`${lodash_1.default.get(result, 'platform.target_id')}.json`)), JSON.stringify(result, null, 2));
                });
                break;
            }
            case 'sarif': {
