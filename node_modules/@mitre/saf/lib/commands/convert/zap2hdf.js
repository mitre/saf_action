...
class Zap2HDF extends command_1.Command {
    async run() {
        const { flags } = this.parse(Zap2HDF);
        const converter = new hdf_converters_1.ZapMapper(fs_1.default.readFileSync(flags.input, 'utf-8'), flags.name);
...
Zap2HDF.flags = {
    ...
    name: command_1.flags.string({ char: 'n', required: true }),
