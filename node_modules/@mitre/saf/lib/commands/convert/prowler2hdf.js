...
Prowler2HDF.usage = 'convert prowler2hdf -i <prowler-finding-json> -o <hdf-output-folder> [-h]';
Prowler2HDF.description = 'Translate a Prowler-derived AWS Security Finding Format results from JSONL into a Heimdall Data Format JSON file';
