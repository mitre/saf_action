...
class DBProtect2HDF extends base_command_1.BaseCommand {
    ...
    static examples = ['<%= config.bin %> <%= command.id %> -i check_results_details_report.xml -o output-hdf-name.json'];
    static flags = {
    ...
    async run() {
        ...
        (0, global_1.checkInput)({ data, filename: flags.input }, hdf_converters_1.INPUT_TYPES.DB_PROTECT, 'DBProtect report in "Check Results Details" XML format');
