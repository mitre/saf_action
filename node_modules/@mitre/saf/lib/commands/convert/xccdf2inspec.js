    ...
    async run() {
        ...
        if (!flags.singleFile) {
            inspecControls.forEach(control => {
                fs_1.default.writeFileSync(path_1.default.join(flags.output, 'controls', control.id + '.rb'), (0, xccdf2inspec_1.inspecControlToRubyCode)(control));
            });
        }
        else {
            const controlOutfile = fs_1.default.createWriteStream(path_1.default.join(flags.output, 'controls', 'controls.rb'), { flags: 'w' });
            inspecControls.forEach(control => {
                controlOutfile.write((0, xccdf2inspec_1.inspecControlToRubyCode)(control) + '\n\n');
            });
...
XCCDF2InSpec.usage = 'convert:xccdf2inspec -i, --input=XML -o, --output=FOLDER';
