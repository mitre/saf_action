    ...
    async run() {
        ...
        if (flags.apiKey && flags.teamName && flags.allProjects) {
            ...
            for (const filename of flags.input) {
                ...
                fs_1.default.writeFileSync(path_1.default.join(flags.output, (0, global_1.checkSuffix)((0, global_1.convertFullPathToFilename)(filename))), JSON.stringify((new hdf_converters_1.IonChannelMapper(fs_1.default.readFileSync(filename, 'utf-8'))).toHdf()));
            }
        }
        else {
