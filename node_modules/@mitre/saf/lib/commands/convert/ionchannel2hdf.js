    ...
    async run() {
        ...
        if (flags.apiKey && flags.teamName && flags.allProjects) {
            ...
            for (const project of availableProjects) {
                ...
                fs_1.default.writeFileSync(path_1.default.join(flags.output, (0, global_1.basename)(filename)), JSON.stringify(json, null, 2));
            }
        }
            ...
            for (const filename of flags.input) {
                ...
                fs_1.default.writeFileSync(path_1.default.join(flags.output, (0, global_1.checkSuffix)((0, global_1.basename)(filename))), JSON.stringify(new hdf_converters_1.IonChannelMapper(data).toHdf()));
            }
        }
        else {
