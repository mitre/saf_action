...
class IonChannel2HDF extends base_command_1.BaseCommand {
    ...
    async run() {
        ...
        const logger = (0, logging_1.createWinstonLogger)({ module: 'IonChannel2HDF', level: flags.logLevel });
        ...
        if (flags.apiKey && flags.teamName && flags.allProjects) {
            ...
            for (const project of availableProjects) {
                ...
                fs_1.default.writeFileSync((0, global_1.resolveSafeChild)(flags.output, (0, global_1.safeFilename)(filename)), JSON.stringify(json, null, 2));
            }
        }
            ...
            for (const filename of flags.input) {
                ...
                (0, global_1.checkInput)({ data: data, filename: filename }, // skipcq: JS-0240
                hdf_converters_1.INPUT_TYPES.IONCHANNEL, 'IonChannel JSON');
                logger.debug(`Processing...${filename}`);
                fs_1.default.writeFileSync((0, global_1.resolveSafeChild)(flags.output, (0, global_1.safeFilename)((0, global_1.checkSuffix)(filename))), JSON.stringify(new hdf_converters_1.IonChannelMapper(data).toHdf()));
            }
        }
        else {
