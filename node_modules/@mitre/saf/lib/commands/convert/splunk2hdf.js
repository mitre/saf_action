...
class Splunk2HDF extends base_command_1.BaseCommand {
    ...
    async run() {
        ...
        const logger = (0, logging_1.createWinstonLogger)({ module: 'splunk2hdf', level: flags.logLevel });
        ...
        const mapper = new hdf_converters_1.SplunkMapper({
            host: flags.host,
            port: flags.port,
        ...
        if (flags.input && flags.output) {
            ...
            for (const input of flags.input) {
                ...
                if (/^(\w){30}$/.test(input)) {
                    ...
                    fs_1.default.writeFileSync((0, global_1.resolveSafeChild)(outputFolder, (0, global_1.safeFilename)(lodash_1.default.get(hdf, 'meta.filename', '').replace(/\.json$/, '')
