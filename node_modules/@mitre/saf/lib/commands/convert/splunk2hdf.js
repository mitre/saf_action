    ...
    async run() {
        ...
        if (flags.input && flags.output) {
            ...
            executionsAvailable.forEach(execution => {
                availableExecutionsTable.push([lodash_1.default.get(execution, 'meta.filename') || '', lodash_1.default.get(execution, 'meta.guid') || '', lodash_1.default.get(execution, 'meta.parse_time') || '']);
            });
