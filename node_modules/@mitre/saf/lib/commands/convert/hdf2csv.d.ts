...
export default class HDF2CSV extends Command {
    ...
    static flags: {
        ...
        fields: import("@oclif/core/lib/interfaces").OptionFlag<string, import("@oclif/core/lib/interfaces/parser").CustomOptions>;
        noTruncate: import("@oclif/core/lib/interfaces").BooleanFlag<boolean>;
    };
