...
class Prisma2HDF extends baseCommand_1.BaseCommand {
    static usage = '<%= command.id %> -i <prisma-cloud-csv> -o <hdf-output-folder> [-h]';
    ...
    async run() {
        ...
        lodash_1.default.forOwn(results, result => {
            fs_1.default.writeFileSync(path_1.default.join(flags.output, `${lodash_1.default.get(result, 'platform.target_id')}.json`), JSON.stringify(result, null, 2));
        });
    }
}
exports.default = Prisma2HDF;
//# sourceMappingURL=prisma2hdf.js.map