...
Prisma2HDF.usage = 'convert prisma2hdf -i <prisma-cloud-csv> -o <hdf-output-folder> [-h]';
Prisma2HDF.description = 'Translate a Prisma Cloud Scan Report CSV file into Heimdall Data Format JSON files';
Prisma2HDF.examples = ['saf convert prisma2hdf -i prismacloud-report.csv -o output-hdf-name.json'];
Prisma2HDF.flags = {
