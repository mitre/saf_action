...
Sonarqube2HDF.usage = 'convert sonarqube2hdf -n <sonar-project-key> -u <http://your.sonar.instance:9000> -a <your-sonar-api-key> [ -b <target-branch> | -p <pull-request-id> ] -o <hdf-scan-results-json>';
...
Sonarqube2HDF.examples = ['saf convert sonarqube2hdf -n sonar_project_key -u http://sonar:9000 --auth abcdefg -p 123 -o scan_results.json'];
Sonarqube2HDF.flags = {
    help: core_1.Flags.help({ char: 'h' }),
    auth: core_1.Flags.string({ char: 'a', required: true, description: 'SonarQube API Key' }),
    projectKey: core_1.Flags.string({ char: 'n', required: true, description: 'SonarQube Project Key' }),
    url: core_1.Flags.string({ char: 'u', required: true, description: 'SonarQube Base URL (excluding \'/api\')' }),
