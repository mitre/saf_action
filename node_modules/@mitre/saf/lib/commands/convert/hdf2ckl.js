...
class HDF2CKL extends core_1.Command {
    ...
    async run() {
        ...
        const rootControls = lodash_1.default.uniqBy(controls, control => lodash_1.default.get(control, 'root.hdf.wraps.id')).map(({ root }) => root);
        let cklData = {};
        const cklMetadata = {
        ...
        cklData = {
            ...
            uuid: (0, uuid_1.v4)(),
            controls: rootControls.map(control => (0, checklist_1.getDetails)(control, profileName)),
        };
        fs_1.default.writeFileSync(flags.output, mustache_1.default.render(files_json_1.default['cklExport.ckl'].data, cklData).replaceAll(/[^\x00-\x7F]/g, ''));
    }
}
