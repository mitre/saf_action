...
class HDF2CKL extends core_1.Command {
    static usage = '<%= command.id %> -i <hdf-scan-results-json> -o <output-ckl> [-h] [-m <metadata>] '
    ...
    static examples = [
        ...
        'The metadata file can be generated by invoking the \u001B[38;5;2m"saf generate ckl_metadata"\u001B[34m command.',
    ];
    static flags = {
        ...
        metadata: core_1.Flags.string({
            char: 'm',
            required: false,
            description: 'Metadata JSON file, generate one with "saf generate ckl_metadata"',
        ...
        profiletitle: core_1.Flags.string({
            required: false,
        ...
        releasenumber: core_1.Flags.integer({
            required: false,
            description: 'Profile release number',
            min: 0,
            helpGroup: 'Checklist Metadata',
        }),
        releasedate: core_1.Flags.string({
            required: false,
            description: 'Profile release date',
            helpGroup: 'Checklist Metadata',
        }),
        marking: core_1.Flags.string({
            required: false,
            description: 'A security classification or designation of the asset, indicating its sensitivity level',
            helpGroup: 'Checklist Metadata',
        }),
        ...
        mac: core_1.Flags.string({
            char: 'M',
            required: false,
            description: 'MAC address',
            helpGroup: 'Checklist Metadata',
        }),
        fqdn: core_1.Flags.string({
            char: 'F',
            required: false,
            description: 'Fully Qualified Domain Name',
            helpGroup: 'Checklist Metadata',
        }),
        targetcomment: core_1.Flags.string({
            required: false,
        ...
        role: core_1.Flags.string({
            required: false,
            description: 'The primary function or role of the asset within the network or organization',
            options: Object.values(hdf_converters_1.Role),
            helpGroup: 'Checklist Metadata',
        }),
        assettype: core_1.Flags.string({
            required: false,
            description: 'The category or classification of the asset',
            options: Object.values(hdf_converters_1.Assettype),
            helpGroup: 'Checklist Metadata',
        }),
        techarea: core_1.Flags.string({
            required: false,
            description: 'The technical area or domain to which the asset belongs',
            options: Object.values(hdf_converters_1.Techarea),
            helpGroup: 'Checklist Metadata',
        }),
        stigguid: core_1.Flags.string({
            required: false,
            description: 'A unique identifier associated with the STIG for the asset',
            helpGroup: 'Checklist Metadata',
        }),
        targetkey: core_1.Flags.string({
            required: false,
            description: 'A unique key or identifier for the asset within the checklist or inventory system',
            helpGroup: 'Checklist Metadata',
        }),
        webordatabase: core_1.Flags.boolean({
            required: false,
            description: 'Indicates whether the STIG is primarily for either a web or database server',
            helpGroup: 'Checklist Metadata',
        }),
        webdbsite: core_1.Flags.string({
            required: false,
            description: 'The specific site or application hosted on the web or database server',
            dependsOn: ['webordatabase'],
            helpGroup: 'Checklist Metadata',
        }),
        webdbinstance: core_1.Flags.string({
            required: false,
            description: 'The specific instance of the web application or database running on the server',
            dependsOn: ['webordatabase'],
            helpGroup: 'Checklist Metadata',
        }),
        vulidmapping: core_1.Flags.string({
            required: false,
            description: 'Which type of control identifier to map to the checklist ID',
            options: ['gid', 'id'],
            helpGroup: 'Checklist Metadata',
        }),
    };
    ...
    async run() {
        ...
        const defaultMetadata = {
            role: hdf_converters_1.Role.None,
            assettype: hdf_converters_1.Assettype.Computing,
            webordatabase: 'false',
            profiles: [],
            hostfqdn: '',
            hostip: '',
            hostmac: '',
            marking: '',
            techarea: hdf_converters_1.Techarea.Empty,
            vulidmapping: 'id',
            hostname: '',
            targetcomment: '',
            webdbinstance: '',
        ...
        if (validationResults.ok) {
            fs_1.default.writeFileSync((0, global_1.checkSuffix)(flags.output, '.ckl'), new hdf_converters_1.ChecklistResults(inputHDF).toCkl());
        }
        else {
