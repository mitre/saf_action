...
class ASFF2HDF extends base_command_1.BaseCommand {
    ...
    async run() {
        ...
        const logger = (0, logging_1.createWinstonLogger)({ module: 'asff2hdf', level: flags.logLevel });
        let securityHub;
        ...
        if (flags.input) {
            ...
            try {
                ...
                if (Array.isArray(convertedJson)) {
                    ...
                    hdf_converters_1.INPUT_TYPES.ASFF, 'AWS Security Finding Format JSON');
                }
            }
            catch (error) {
