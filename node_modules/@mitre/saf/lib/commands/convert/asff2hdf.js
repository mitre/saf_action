    ...
    async run() {
        ...
        if (flags.input) {
            ...
            while (nextToken !== undefined) {
                ...
                logger.debug(`Received: ${(_a = getEnabledStandardsResult.StandardsSubscriptions) === null || _a === void 0 ? void 0 : _a.length} standards`);
            ...
            for (const standard of enabledStandards) {
                ...
                while (nextToken !== undefined) {
                    ...
                    logger.info(`Received: ${(_b = getEnabledStandardsResult.Controls) === null || _b === void 0 ? void 0 : _b.length} Controls`);
...
ASFF2HDF.usage = 'convert asff2hdf -o <hdf-output-folder> [-h] (-i <asff-json> [--securityhub <standard-json>]... | -a -r <region> [-I | -C <certificate>] [-t <target>]) [-L info|warn|debug|verbose]';
