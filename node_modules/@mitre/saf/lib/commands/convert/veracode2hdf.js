...
class Veracode2HDF extends baseCommand_1.BaseCommand {
    static usage = '<%= command.id %> -i <veracode-xml> -o <hdf-scan-results-json> [-h]';
    static description = 'Translate a Veracode XML file into a Heimdall Data Format JSON file';
    static examples = ['<%= config.bin %> <%= command.id %> -i veracode_results.xml -o output-hdf-name.json'];
    static flags = {
...
//# sourceMappingURL=veracode2hdf.js.map