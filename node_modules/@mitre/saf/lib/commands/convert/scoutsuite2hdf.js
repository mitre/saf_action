...
class Scoutsuite2HDF extends baseCommand_1.BaseCommand {
    static usage = '<%= command.id %> -i <scoutsuite-results-js> -o <hdf-scan-results-json> [-h] [-w]';
    static description = 'Translate a ScoutSuite results from a Javascript object into a Heimdall Data Format JSON file\n'
        + 'Note: Currently this mapper only supports AWS.';
    static examples = ['<%= config.bin %> <%= command.id %> -i scoutsuite-results.js -o output-hdf-name.json'];
    static flags = {
    ...
    async run() {
        ...
        (0, global_1.checkInput)({ data, filename: flags.input }, 'scoutsuite', 'ScoutSuite results from a Javascript object');
        const converter = new hdf_converters_1.ScoutsuiteMapper(data, flags.includeRaw);
...
//# sourceMappingURL=scoutsuite2hdf.js.map