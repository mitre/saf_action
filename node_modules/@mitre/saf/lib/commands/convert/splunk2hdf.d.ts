...
export default class Splunk2HDF extends Command {
    ...
    static flags: {
        ...
        host: import("@oclif/core/lib/interfaces").OptionFlag<string, import("@oclif/core/lib/interfaces/parser").CustomOptions>;
        port: import("@oclif/core/lib/interfaces").OptionFlag<number, import("@oclif/core/lib/interfaces/parser").CustomOptions>;
        scheme: import("@oclif/core/lib/interfaces").OptionFlag<string, import("@oclif/core/lib/interfaces/parser").CustomOptions>;
    ...
    searchExecutions(mapper: SplunkMapper, filename: string, index?: string): Promise<any[]>;
    run(): Promise<void>;
}
