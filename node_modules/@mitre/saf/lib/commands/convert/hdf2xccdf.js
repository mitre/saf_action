...
class HDF2XCCDF extends core_1.Command {
    async run() {
        ...
        const converter = new hdf_converters_1.FromHDFToXCCDFMapper(fs_1.default.readFileSync(flags.input, 'utf-8'), files_json_1.default['xccdfTemplate.xml'].data);
        fs_1.default.writeFileSync(flags.output, converter.toXCCDF());
    }
}
exports.default = HDF2XCCDF;
HDF2XCCDF.usage = 'convet hdf2xccdf -i, --input=JSON -o, --output=OUTPUT';
HDF2XCCDF.description = 'Translate an HDF file into an XCCDF XML';
HDF2XCCDF.examples = ['saf convert hdf2xccdf -i hdf_input.json -o xccdf-results.xml'];
HDF2XCCDF.flags = {
