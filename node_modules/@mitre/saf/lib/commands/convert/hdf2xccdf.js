...
class HDF2XCCDF extends base_command_1.BaseCommand {
    ...
    static examples = ['<%= config.bin %> <%= command.id %> -i hdf_input.json -o xccdf-results.xml'];
    static flags = {
    ...
    async run() {
        ...
        fs_1.default.writeFileSync((0, global_1.checkSuffix)(flags.output, '.xml'), converter.toXCCDF());
    }
}
