...
class HDF2Condensed extends base_command_1.BaseCommand {
    static usage = '<%= command.id %> -i <hdf-scan-results-json> -o <condensed-json> [-h]';
    ...
    static examples = ['<%= config.bin %> <%= command.id %> -i rhel7-results.json -o rhel7-condensed.json'];
    static flags = {
...
//# sourceMappingURL=hdf2condensed.js.map