...
CKL2POAM.usage = 'convert ckl2POAM -i <disa-checklist> -o <poam-output-folder> [-h] [-O <office/org>] [-d <device-name>] [-s <num-rows>]';
CKL2POAM.description = 'Translate DISA Checklist CKL file(s) to POA&M files';
CKL2POAM.aliases = ['convert:ckl2poam'];
CKL2POAM.examples = ['saf convert ckl2POAM -i checklist_file.ckl -o output-folder -d abcdefg -s 2'];
CKL2POAM.flags = {
