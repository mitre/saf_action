...
class CKL2POAM extends baseCommand_1.BaseCommand {
    ...
    async run() {
        ...
        flags.input.forEach((fileName) => {
            ...
            fs_1.default.readFile(fileName, (readFileError, data) => {
                if (readFileError) {
                    logger.log({
                        level: 'error',
                        file: fileName,
                ...
                parser.parseString(data, (parseFileError, result) => {
                    if (parseFileError) {
                        logger.log({
                            level: 'error',
                            file: fileName,
                        ...
                        const officeOrg = flags.officeOrg
                                ...
                                if (vulnerability.STATUS !== 'NotAFinding'
                                    ...
                                    if (vulnerability.STATUS === 'Open'
                                        ...
                                        if (host.startsWith('Nessus')) {
                                            ...
                                            sheet
                                                .cell(`M${currentRow}`)
                                                .value((0, ckl2poam_1.combineComments)(vulnerability, host));
                                        }
                                    }
                                    // Raw Severity
                                    sheet
                                    ...
                                    sheet
                                        .cell(`Q${currentRow}`)
                                        .value((0, ckl2poam_1.cklSeverityToRelevanceOfThreat)(vulnerability.Severity || ''));
                                    // Likelihood
                                    sheet
                                        .cell(`R${currentRow}`)
