...
class Nikto2HDF extends base_command_1.BaseCommand {
    ...
    async run() {
        ...
        (0, global_1.checkInput)({ data, filename: flags.input }, hdf_converters_1.INPUT_TYPES.NIKTO, 'Nikto results JSON');
