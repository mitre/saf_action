...
class CKL2HDF extends core_1.Command {
    ...
    static flags = {
        ...
        input: core_1.Flags.string({ char: 'i', required: true, description: 'Input Checklist XML File' }),
    ...
    async run() {
        ...
        const converter = new hdf_converters_1.ChecklistResults(data, flags['with-raw']);
