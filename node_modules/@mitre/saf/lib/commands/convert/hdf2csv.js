...
class HDF2CSV extends core_1.Command {
...
HDF2CSV.usage = 'convert hdf2csv -i <hdf-scan-results-json> -o <output-csv> [-h] [-f <csv-fields>] [-t]';
...
HDF2CSV.flags = {
    ...
    output: core_1.Flags.string({ char: 'o', required: true, description: 'Output CSV file' }),
    fields: core_1.Flags.string({ char: 'f', required: false, default: csv_1.csvExportFields.join(','), description: 'Fields to include in output CSV, separated by commas' }),
    noTruncate: core_1.Flags.boolean({ char: 't', required: false, default: false, description: "Don't truncate fields longer than 32,767 characters (the cell limit in Excel)" }),
};
