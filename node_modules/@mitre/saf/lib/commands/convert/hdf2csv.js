...
class HDF2CSV extends core_1.Command {
    ...
    static flags = {
        ...
        noTruncate: core_1.Flags.boolean({ char: 't', required: false, default: false, description: 'Do not truncate fields longer than 32,767 characters (the cell limit in Excel)' }),
    };
