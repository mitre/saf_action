...
Trivy2HDF.usage = 'convert trivy2hdf -i <trivy-finding-json> -o <hdf-output-folder>';
Trivy2HDF.description = 'Translate a Trivy-derived AWS Security Finding Format results from JSONL into a Heimdall Data Format JSON file';
Trivy2HDF.examples = ['saf convert trivy2hdf -i trivy-asff.json -o output-folder'];
Trivy2HDF.flags = {
