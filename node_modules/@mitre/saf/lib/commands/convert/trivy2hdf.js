...
class Trivy2HDF extends base_command_1.BaseCommand {
    static usage = '<%= command.id %> -i <trivy-finding-json> -o <hdf-output-folder>';
    ...
    static examples = ['<%= config.bin %> <%= command.id %> -i trivy-asff.json -o output-folder'];
    static flags = {
    ...
    async run() {
        ...
        // }
        (0, global_1.checkInput)({ data: input, filename: flags.input }, hdf_converters_1.INPUT_TYPES.ASFF, 'Trivy-derived AWS Security Finding Format results');
...
//# sourceMappingURL=trivy2hdf.js.map