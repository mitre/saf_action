...
const sync_1 = (0, tslib_1.__importDefault)(require("csv-parse/lib/sync"));
const yaml_1 = (0, tslib_1.__importDefault)(require("yaml"));
const xlsx_populate_1 = (0, tslib_1.__importDefault)(require("xlsx-populate"));
const xccdf2inspec_1 = require("../../utils/xccdf2inspec");
const lodash_1 = (0, tslib_1.__importDefault)(require("lodash"));
const global_1 = require("../../utils/global");
const cci_nist_mapping_json_1 = (0, tslib_1.__importDefault)(require("@mitre/hdf-converters/lib/data/cci-nist-mapping.json"));
const cis2nist_json_1 = (0, tslib_1.__importDefault)(require("../../resources/cis2nist.json"));
const files_json_1 = (0, tslib_1.__importDefault)(require("../../resources/files.json"));
class Spreadsheet2HDF extends command_1.Command {
    ...
    async run() {
        ...
        if (flags.metadata) {
            if (fs_1.default.existsSync(flags.metadata)) {
                metadata = JSON.parse(fs_1.default.readFileSync(flags.metadata, 'utf-8'));
            }
            else {
        ...
        if (flags.mapping) {
            if (fs_1.default.existsSync(flags.mapping)) {
                mappings = yaml_1.default.parse(fs_1.default.readFileSync(flags.mapping, 'utf-8'));
            }
            else {
                throw new Error('Passed metadata file does not exist');
            }
        ...
        await xlsx_populate_1.default.fromFileAsync(flags.input).then((workBook) => {
            ...
            const inputDataLines = fs_1.default.readFileSync(flags.input, 'utf-8').split('\n');
            ...
            records.forEach((record, index) => {
                ...
                if (newControl.tags && ((_a = newControl.tags) === null || _a === void 0 ? void 0 : _a.cci)) {
                    ...
                    newControl.tags.cci.forEach(cci => {
                        var _a, _b;
                        if (cci in cci_nist_mapping_json_1.default) {
                            (_b = (_a = newControl.tags) === null || _a === void 0 ? void 0 : _a.nist) === null || _b === void 0 ? void 0 : _b.push(lodash_1.default.get(cci_nist_mapping_json_1.default, cci));
                        }
                    });
                }
                newControl = this.matchReferences(newControl);
        ...
        inspecControls.forEach(control => {
            fs_1.default.writeFileSync(path_1.default.join(flags.output, 'controls', control.id + '.rb'), (0, xccdf2inspec_1.inspecControlToRubyCode)(control, flags.lineLength));
        });
    }
}
...
Spreadsheet2HDF.flags = {
    ...
    controlNamePrefix: command_1.flags.string({ char: 'c', required: false, default: '', description: 'Prefix for all control IDs' }),
    format: command_1.flags.string({ char: 'f', required: false, default: 'general', options: ['cis', 'disa', 'general'] }),
    metadata: command_1.flags.string({ char: 'm', required: false, description: 'Path to a JSON file with additional metadata for the inspec.yml file' }),
    mapping: command_1.flags.string({ char: 'M', required: false, description: 'Path to a YAML file with mappings for each field, by default, CIS Benchmark fields are used for XLSX, STIG Viewer CSV export is used by CSV' }),
    lineLength: command_1.flags.integer({ char: 'l', required: false, default: 80, description: 'Characters between lines within InSpec controls' }),
    output: command_1.flags.string({ char: 'o', required: true, description: 'Output InSpec profile folder' }),
};
