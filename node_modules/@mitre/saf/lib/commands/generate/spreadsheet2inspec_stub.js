...
class Spreadsheet2HDF extends baseCommand_1.BaseCommand {
    ...
    async run() {
        ...
        inspecControls.forEach((control) => {
            fs_1.default.writeFileSync(path_1.default.join(flags.output, 'controls', (0, global_1.basename)(control.id) + '.rb'), (0, xccdf2inspec_1.inspecControlToRubyCode)(control, flags.lineLength, flags.encodingHeader));
        });
    }
}
