            ...
            records.forEach((record, index) => {
                ...
                if (newControl.tags && ((_a = newControl.tags) === null || _a === void 0 ? void 0 : _a.cci)) {
                    ...
                    newControl.tags.cci.forEach(cci => {
                        var _a, _b;
                        if (cci in hdf_converters_1.CciNistMappingData) {
                            (_b = (_a = newControl.tags) === null || _a === void 0 ? void 0 : _a.nist) === null || _b === void 0 ? void 0 : _b.push(lodash_1.default.get(hdf_converters_1.CciNistMappingData, cci));
                        }
                    });
                }
                newControl = this.matchReferences(newControl);
