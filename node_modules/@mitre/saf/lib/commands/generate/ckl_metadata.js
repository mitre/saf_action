...
async function getFlags() {
    ...
    (0, cli_helper_1.printGreen)('  Required flag - The metadata json file to be generated (full path to include file name)');
    const answers = {
...
async function getCklMetaData() {
    // Variable used to store the prompts (question and answers)
    const interactiveValues = {};
    (0, cli_helper_1.printYellow)('This process collects information necessary to generate a checklist metadata used by the "saf convert hdf2ckl" command.');
    (0, cli_helper_1.printYellow)('Not all fields are visible in the STIG Viewer, some are used for references and may not generate a ckl exactly as the STIG Viewer.\n');
    (0, cli_helper_1.printGreen)('Please fill in the following fields to the best of your ability, if you do not have a value, please leave the field empty.');
