...
class GenerateThreshold extends core_1.Command {
    async run() {
        ...
        lodash_1.default.set(thresholds, 'passed.total', severityStatusCounts.Passed);
        lodash_1.default.set(thresholds, 'failed.total', severityStatusCounts.Failed);
        lodash_1.default.set(thresholds, 'skipped.total', severityStatusCounts['Not Reviewed']);
        lodash_1.default.set(thresholds, 'error.total', severityStatusCounts['Profile Error']);
        lodash_1.default.set(thresholds, 'no_impact.total', severityStatusCounts['Not Applicable']);
