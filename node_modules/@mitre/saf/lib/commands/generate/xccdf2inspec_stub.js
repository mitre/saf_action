...
class XCCDF2InSpec extends command_1.Command {
    async run() {
        var _a;
        ...
        // Read XCCDF file
        const parsedXML = (0, xccdf2inspec_1.convertEncodedXmlIntoJson)(fs_1.default.readFileSync(flags.input, 'utf-8'));
            ...
            if ('ident' in group.Rule) {
                ...
                identifiers.forEach(identifier => {
                    ...
                    if (identifier['@_system'].toLowerCase().endsWith('cci')) {
                        ...
                        if (identifier['#text'] in cci_nist_mapping_json_1.default) {
                            lodash_1.default.set(inspecControl, 'tags.nist', lodash_1.default.get(inspecControl, 'tags.nist') || []);
                            const nistMapping = lodash_1.default.get(cci_nist_mapping_json_1.default, identifier['#text']);
        ...
        if (!flags.singleFile) {
            ...
            inspecControls.forEach(control => {
                controlOutfile.write((0, xccdf2inspec_1.inspecControlToRubyCode)(control, flags.lineLength) + '\n\n');
            });
...
XCCDF2InSpec.flags = {
    ...
    input: command_1.flags.string({ char: 'i', required: true, description: 'Path to the DISA STIG XCCDF file' }),
    ...
    singleFile: command_1.flags.boolean({ char: 's', required: false, default: false, description: 'Output the resulting controls as a single file' }),
    useVulnerabilityId: command_1.flags.boolean({ char: 'r', required: false, default: false, description: "Use Vulnerability IDs (ex. 'SV-XXXXX') instead of Group IDs (ex. 'V-XXXXX')" }),
    ...
    output: command_1.flags.string({ char: 'o', required: true, default: 'profile' }),
};
