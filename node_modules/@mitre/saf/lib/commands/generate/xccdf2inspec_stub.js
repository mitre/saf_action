...
XCCDF2InSpec.usage = 'generate xccdf2inspec_stub -i <stig-xccdf-xml> -o <output-folder> [-h] [-m <metadata-json>] [-s] [-r | -S] [-l <line-length>] [-e]';
XCCDF2InSpec.description = 'Translate a DISA STIG XCCDF XML file into a skeleton for an InSpec profile';
XCCDF2InSpec.flags = {
