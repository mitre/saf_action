...
XCCDFBenchmark2InSpec.usage = 'generate xccdf_benchmark2inspec_stub -i <stig-xccdf-xml> -o <output-folder> [-h] [-m <metadata-json>] [-s] [-r | -S] [-l <line-length>] [-e]';
XCCDFBenchmark2InSpec.description = 'Translate a DISA STIG XCCDF-Benchmark XML file into a skeleton for an InSpec profile';
XCCDFBenchmark2InSpec.flags = {
    help: core_1.Flags.help({ char: 'h' }),
    input: core_1.Flags.string({ char: 'i', required: true, description: 'Path to the DISA STIG XCCDF Benchmark file' }),
