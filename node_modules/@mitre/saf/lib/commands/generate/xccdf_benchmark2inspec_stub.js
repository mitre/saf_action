...
XCCDFBenchmark2InSpec.usage = 'saf generate xccdf_benchmark2inspec_stub -i <stig-xccdf-xml> [-o <output-folder>] [-h] [-m <metadata-json>] [-T (rule|group|cis|version)] [-s] [-L (info|warn|debug|verbose)]';
XCCDFBenchmark2InSpec.description = 'Translate an XCCDF benchmark file to a skeleton for an InSpec profile';
XCCDFBenchmark2InSpec.flags = {
    ...
    ovalDefinitions: core_1.Flags.string({ char: 'O', required: false, description: 'Path to an OVAL definitions file to populate profile elements that reference OVAL defintions' }),
...
XCCDFBenchmark2InSpec.examples = [
