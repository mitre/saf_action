...
class GenerateUpdateControls extends baseCommand_1.BaseCommand {
    ...
    async run() {
        ...
        logger.warn(colors_1.default.yellow('╚═══════════════════════════════════════════════╝'));
        let inspecProfile = new inspec_objects_1.Profile();
        ...
        if (flags.inspecJsonFile) {
            logger.info(`  Using execution/profile summary file: ${(0, global_1.basename)(flags.inspecJsonFile)}`); // skipcq: JS-0339
            try {
