...
class GenerateUpdateControls extends baseCommand_1.BaseCommand {
    ...
    static description = 'Update the control names and/or format for an existing InSpec\n' +
    ...
    static flags = {
        ...
        useXccdfGroupId: core_1.Flags.boolean({ char: 'g', required: false, default: false, allowNo: true, description: 'Use the XCCDF `Group Id` to rename the controls. Uses prefix V or SV based on controlPrefix option\n[default: false]' }),
