...
class GenerateUpdateControls extends base_command_1.BaseCommand {
    ...
    async run() {
        ...
        const logger = (0, logging_1.createWinstonLogger)({ module: 'generate:update_controls', level: flags.logLevel });
        logger.warn('╔═══════════════════════════════════════════════╗');
        ...
        const log = (0, logging_1.createWinstonLogger)({ logFile: 'CliProcessOutput.log', plainText: true, alwaysPrintToConsole: true });
        ...
        if (flags.inspecJsonFile) {
            ...
            try {
                ...
                const inspecJsonFile = (0, global_1.safeExecFileSync)(inspecPath, ['json', profileDir], { encoding: 'utf8', maxBuffer: 50 * 1024 * 1024 });
        ...
        for (const file of files) {
            ...
            if (fileExt === ext) {
                ...
                const currentFileFullPath = (0, global_1.resolveSafeChild)(controlsDir, (0, global_1.safeFilename)(file));
...
function saveControl(filePath, newXCCDFControlNumber, currentControlNumber, updatedControl, backupControls, renamedControl) {
    const newFileName = (0, global_1.resolveSafeChild)(path_1.default.dirname(filePath), (0, global_1.safeFilename)(`${(0, global_1.basename)(newXCCDFControlNumber)}.rb`));
    // Move processed (old) control to oldControls folder
    if (backupControls) {
        const destFilePath = (0, global_1.resolveSafeChild)(GenerateUpdateControls.backupDir, (0, global_1.safeFilename)(`${(0, global_1.basename)(currentControlNumber)}.rb`));
        if (renamedControl) {
