...
class GenerateInSpecMetadata extends command_1.Command {
    async run() {
...
GenerateInSpecMetadata.description = 'Generate an InSpec metadata template for "saf convert:*2inspec"';
GenerateInSpecMetadata.flags = {
    help: command_1.flags.help({ char: 'h' }),
    output: command_1.flags.string({ char: 'o', required: true, description: 'Output JSON File' }),
};
