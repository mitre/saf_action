...
GenerateInSpecMetadata.usage = 'generate inspec_metadata -o <json-file>';
GenerateInSpecMetadata.description = 'Generate an InSpec metadata template for "saf convert *2inspec_stub"';
GenerateInSpecMetadata.examples = ['saf generate inspec_metadata -o ms_sql_baseline_metadata.json'];
