...
class GenerateInSpecMetadata extends baseCommand_1.BaseCommand {
    static usage = '<%= command.id %> -o <json-file>';
    static description = 'Generate an InSpec metadata template for "saf convert *2inspec_stub"';
    static examples = ['<%= config.bin %> <%= command.id %> -o ms_sql_baseline_metadata.json'];
    static flags = {
