...
class Threshold extends baseCommand_1.BaseCommand {
    static usage = '<%= command.id %> -i <hdf-json> [-h] [-T <flattened-threshold-json> | -F <template-file>]';
    static description = 'Validate the compliance and status counts of an HDF file';
    static examples = ['<%= config.bin %> <%= command.id %> -i rhel7-results.json -F output.yaml'];
    static flags = {
