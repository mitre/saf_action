...
Threshold.usage = 'validate threshold -i <hdf-json> [-h] [-T <flattened-threshold-json> | -F <template-file>]';
Threshold.description = 'Validate the compliance and status counts of an HDF file';
Threshold.examples = ['saf validate threshold -i rhel7-results.json -F output.yaml'];
Threshold.flags = {
    help: core_1.Flags.help({ char: 'h' }),
    input: core_1.Flags.string({ char: 'i', required: true, description: 'Input HDF JSON File' }),
    templateInline: core_1.Flags.string({ char: 'T', required: false, exclusive: ['templateFile'], description: 'Flattened JSON containing your validation thresholds (Intended for backwards compatibility with InSpec Tools)' }),
