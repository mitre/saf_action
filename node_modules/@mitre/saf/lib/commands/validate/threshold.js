...
class Threshold extends command_1.Command {
    async run() {
        ...
        for (const statusThreshold of targets) {
            ...
            if (thresholdType === 'min' && lodash_1.default.get(thresholds, statusThreshold) !== undefined) {
            ...
            else if (thresholdType === 'max' && lodash_1.default.get(thresholds, statusThreshold) !== undefined) {
                (0, threshold_1.exitNonZeroIfTrue)(Boolean(lodash_1.default.get(overallStatusCounts, (0, threshold_1.renameStatusName)(statusName)) >
                    lodash_1.default.get(thresholds, statusThreshold)), `${statusThreshold}: ${lodash_1.default.get(overallStatusCounts, (0, threshold_1.renameStatusName)(statusName))} > ${lodash_1.default.get(thresholds, statusThreshold)}`);
            }
        }
...
Threshold.flags = {
    ...
    templateInline: command_1.flags.string({ char: 'T', required: false }),
    templateFile: command_1.flags.string({ char: 'F', required: false, description: 'Expected data template, generate one with "saf generate:threshold"' }),
};
