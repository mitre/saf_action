...
class Heimdall extends core_1.Command {
    async run() {
        ...
        if (!flags.noOpenBrowser) {
            if (flags.port) {
                flags.files ? (0, open_1.default)(`http://localhost:${flags.port}/?predefinedLoad=true`) : (0, open_1.default)(`http://localhost:${flags.port}/`);
            }
            else {
...
Heimdall.usage = 'view heimdall [-h] [-p <port>] [-f <file>] [-n]';
Heimdall.description = 'Run an instance of Heimdall Lite to visualize your data';
Heimdall.examples = ['saf view heimdall -p 8080'];
Heimdall.flags = {
