...
const data_loader_1 = require("../../utils/ohdf/data_loader");
const output_generator_1 = require("../../utils/ohdf/output_generator");
...
class Summary extends core_1.Command {
     ...
     */
    logger = (0, logging_1.createWinstonLogger)({ module: 'View Summary' });
    /**
    ...
    async run() {
        try {
            ...
            this.logger = (0, logging_1.createWinstonLogger)({ module: VIEW_SUMMARY, level: (logLevel ?? process.env.LOG_LEVEL ?? 'info') });
            this.logger.verbose('Parsed command line flags');
            const executionData = (0, data_loader_1.loadExecJSONs)(this.parsedFlags.input);
            ...
            const printableSummaries = Object.entries(totals).map(([profileName, profileMetrics]) => {
                ...
                return (0, output_generator_1.createPrintableSummary)(profileName, profileMetrics, executionData, complianceScores);
            });
            this.logger.verbose(`Generated ${printableSummaries.length} printable summaries`);
            (0, output_generator_1.printAndWriteOutput)({ printableSummaries, titleTable, format, printPretty, stdout, output });
