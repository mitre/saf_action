...
class Summary extends command_1.Command {
    async run() {
...
Summary.flags = {
    ...
    input: command_1.flags.string({ char: 'i', required: true, multiple: true, description: 'Input HDF files' }),
    json: command_1.flags.boolean({ char: 'j', required: false, description: 'Output results as JSON' }),
    output: command_1.flags.string({ char: 'o', required: false }),
};
