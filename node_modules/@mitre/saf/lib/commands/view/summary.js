...
Summary.usage = 'view summary -i <hdf-file> [-h] [-j] [-o <output>]';
...
Summary.examples = ['saf view summary -i rhel7-results.json', 'saf view summary -i rhel7-host1-results.json nginx-host1-results.json mysql-host1-results.json'];
