...
export default class Summary extends Command {
    ...
    static flags: {
        ...
        stdout: import("@oclif/core/lib/interfaces").BooleanFlag<boolean>;
        'print-pretty': import("@oclif/core/lib/interfaces").BooleanFlag<boolean>;
        'title-table': import("@oclif/core/lib/interfaces").BooleanFlag<boolean>;
