...
EmasserBuildConfig.summary = 'Generate a configuration file (.env) for accessing an eMASS instances.';
EmasserBuildConfig.description = `
  ...
  `;
EmasserBuildConfig.examples = ['<%= config.bin %> <%= command.id %>'];
