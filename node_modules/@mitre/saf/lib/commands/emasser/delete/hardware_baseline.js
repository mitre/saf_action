...
class EmasserDeleteHardwareBaseline extends core_1.Command {
    ...
    async run() {
        ...
        flags.assetsHardwareId.forEach((hardwareId) => {
            requestBodyArray.push({ hardwareId: hardwareId }); // skipcq: JS-0240
        });
        // Call the endpoint
        delHwBaseline.deleteHwBaselineAssets(flags.systemId, requestBodyArray).then((response) => {
