...
EmasserGetSystem.usage = '<%= command.id %> [ARGUMENTS]';
EmasserGetSystem.description = 'Get system information for a specific system defined by ID (systemId)';
EmasserGetSystem.examples = ['<%= config.bin %> <%= command.id %> [-s, --systemId] <value> [options]'];
EmasserGetSystem.flags = {
    help: core_1.Flags.help({ char: 'h', description: 'Show emasser CLI help for the GET System endpoint' }),
