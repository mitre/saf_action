...
EmasserGetMilestones.usage = '<%= command.id %> [ARGUMENTS]';
EmasserGetMilestones.description = (0, utilities_1.getDescriptionForEndpoint)(process.argv, endpoint);
EmasserGetMilestones.examples = (0, utilities_1.getExamplesForEndpoint)(process.argv, endpoint);
EmasserGetMilestones.flags = {
