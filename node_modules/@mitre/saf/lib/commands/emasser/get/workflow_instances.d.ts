...
export default class EmasserGetWorkflowInstances extends Command {
    ...
    static args: {
        ...
        all: import("@oclif/core/interfaces").Arg<string | undefined, Record<string, unknown>>;
        byInstanceId: import("@oclif/core/interfaces").Arg<string | undefined, Record<string, unknown>>;
    };
    run(): Promise<void>;
