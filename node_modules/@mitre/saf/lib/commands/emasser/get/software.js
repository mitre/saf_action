...
class EmasserGetSoftwareBaseline extends core_1.Command {
    ...
    async run() {
        ...
        if (args.name === 'baseline') {
            ...
            }).catch((error) => (0, utilities_1.displayError)(error, 'Software'));
        }
        else {
            throw this.error;
        }
