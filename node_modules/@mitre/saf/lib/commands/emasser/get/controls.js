...
class EmasserGetControls extends core_1.Command {
    ...
    static examples = ['<%= config.bin %> <%= command.id %> [-s, --systemId] <value> [option]'];
    static flags = {
        help: core_1.Flags.help({ char: 'h', description: 'Show eMASSer CLI help for the GET Controls command' }),
