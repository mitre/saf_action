...
EmasserGetControls.usage = '<%= command.id %> [options]';
EmasserGetControls.description = 'Get system Security Control information for both the Implementation Plan and Risk Assessment';
EmasserGetControls.examples = ['<%= config.bin %> <%= command.id %> --systemId <value> [option]'];
EmasserGetControls.flags = {
