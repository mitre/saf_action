...
class EmasserGetWorkflowInstances extends core_1.Command {
    ...
    static flags = {
        help: core_1.Flags.help({ char: 'h', description: 'Show eMASSer CLI help for the GET Workflow Instances command' }),
    ...
    async run() {
        ...
        if (args.name === 'all') {
            ...
            getWorkflowInstances.getSystemWorkflowInstances(flags.includeComments, flags.includeDecommissionSystems, flags.pageIndex, flags.sinceDate, flags.status).then((response) => {
                console.log((0, json_colorizer_1.colorize)((0, outputFormatter_1.outputFormat)(response)));
            }).catch((error) => (0, utilities_1.displayError)(error, 'Workflow Instances'));
        }
...
//# sourceMappingURL=workflow_instances.js.map