...
EmasserGetArtifacts.usage = '<%= command.id %> [ARGUMENTS]';
EmasserGetArtifacts.description = (0, utilities_1.getDescriptionForEndpoint)(process.argv, endpoint);
EmasserGetArtifacts.examples = (0, utilities_1.getExamplesForEndpoint)(process.argv);
EmasserGetArtifacts.flags = {
    help: core_1.Flags.help({ char: 'h', description: 'Show emasser CLI help for the GET Artifacts endpoint' }),
