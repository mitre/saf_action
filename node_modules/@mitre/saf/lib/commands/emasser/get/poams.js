...
EmasserGetPoams.usage = '<%= command.id %> [ARGUMENTS]';
EmasserGetPoams.description = (0, utilities_1.getDescriptionForEndpoint)(process.argv, endpoint);
EmasserGetPoams.examples = (0, utilities_1.getExamplesForEndpoint)(process.argv, endpoint);
EmasserGetPoams.flags = {
