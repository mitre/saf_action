...
function addRequiredFieldsToRequestBody(dataObj) {
    ...
    try {
        ...
        console.log((0, json_colorizer_1.default)(JSON.stringify((0, utilities_1.getJsonExamples)('poams-post-required'), null, 2)));
        throw error;
    }
    // The required parameters/fields "poamId" and "displayPoamId" are generated by the POST call
...
function processBusinessLogic(bodyObject, dataObj) {
    ...
    switch (dataObj.status) {
        ...
        case 'Ongoing': {
            if (!(Object.prototype.hasOwnProperty.call(dataObj, 'scheduledCompletionDate') && Object.prototype.hasOwnProperty.call(dataObj, 'milestones'))) {
            ...
            else if ((typeof (lodash_1.default.find(dataObj.milestones, function (milestone) {
                return milestone.description;
            })) === 'undefined') ||
                (typeof (lodash_1.default.find(dataObj.milestones, function (milestone) {
                ...
                (_a = dataObj.milestones) === null || _a === void 0 ? void 0 : _a.forEach((milestone) => {
                    const milestoneObj = {};
        ...
        case 'Completed': {
            if (!(Object.prototype.hasOwnProperty.call(dataObj, 'scheduledCompletionDate')) || !(Object.prototype.hasOwnProperty.call(dataObj, 'comments')) ||
                ...
                // Add the milestone object
                const milestoneArray = [];
                (_b = dataObj.milestones) === null || _b === void 0 ? void 0 : _b.forEach((milestone) => {
                    const milestoneObj = {};
                    milestoneObj.description = milestone.description;
                    milestoneObj.scheduledCompletionDate = milestone.scheduledCompletionDate;
                    milestoneArray.push(milestoneObj);
...
EmasserPostPoams.usage = '<%= command.id %> [ARGUMENTS]';
EmasserPostPoams.description = 'Add a Plan of Action and Milestones (POA&M) into a systems.';
EmasserPostPoams.examples = ['<%= config.bin %> <%= command.id %> [-s,--systemId] [-f,--poamFile]',
    ...
    (0, json_colorizer_1.default)(JSON.stringify((0, utilities_1.getJsonExamples)('poams-post-required'), null, 2)),
    'Conditional JSON parameters/fields are: ',
    (0, json_colorizer_1.default)(JSON.stringify((0, utilities_1.getJsonExamples)('poams-post-conditional'), null, 2)),
...
EmasserPostPoams.flags = {
    help: core_1.Flags.help({ char: 'h', description: 'Post (add) a Plan of Action and Milestones (POA&M) item(s) in a system. See emasser Features (emasserFeatures.md) for additional information.' }),
