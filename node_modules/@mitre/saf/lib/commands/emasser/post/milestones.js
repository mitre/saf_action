...
EmasserPostMilestones.usage = '<%= command.id %> [ARGUMENTS]';
EmasserPostMilestones.description = 'Add milestones to one or many POA&M items in a system';
EmasserPostMilestones.examples = ['<%= config.bin %> <%= command.id %> [-s,--systemId] [-p,--poamId] [-d,--description] [-c,--scheduledCompletionDate]'];
EmasserPostMilestones.flags = {
    help: core_1.Flags.help({ char: 'h', description: 'Post (add) milestones to one or many POA&M items in a system' }),
