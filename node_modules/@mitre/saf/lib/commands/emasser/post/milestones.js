...
class EmasserPostMilestones extends core_1.Command {
    static usage = '<%= command.id %> -s <value> -p <value> -d <description> -c <completion-date>';
    ...
    static flags = {
        help: core_1.Flags.help({ char: 'h', description: 'Show eMASSer CLI help for the POST Milestones command' }),
