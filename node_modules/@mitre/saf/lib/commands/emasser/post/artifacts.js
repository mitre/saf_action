...
EmasserPostArtifacts.usage = '<%= command.id %> [ARGUMENTS]';
EmasserPostArtifacts.description = 'Uploads [FILES] to the given [SYSTEM_ID] as artifacts';
EmasserPostArtifacts.examples = ['<%= config.bin %> <%= command.id %> [-s,--systemId] [-i,--input] [options]'];
EmasserPostArtifacts.flags = {
