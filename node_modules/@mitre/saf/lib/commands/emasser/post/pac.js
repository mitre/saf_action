...
EmasserPostPac.usage = '<%= command.id %> [ARGUMENTS]';
EmasserPostPac.description = 'Add new Package Approval Chain (PAC) workflow(s) for a system';
EmasserPostPac.examples = ['<%= config.bin %> <%= command.id %> [-s,--systemId] [-w,--workflow] [-n,--name] [-c,--comments]'];
EmasserPostPac.flags = {
    help: core_1.Flags.help({ char: 'h', description: 'Post (add) a Package Approval Chain (PAC) item in a system' }),
