...
function addApplicationToRequestBody(dataObj) {
    ...
    const requestBody = {};
    try {
        assertParamExists('application.applicationName', (_a = dataObj.application) === null || _a === void 0 ? void 0 : _a.applicationName);
        assertParamExists('application.version', (_b = dataObj.application) === null || _b === void 0 ? void 0 : _b.version);
    }
    catch (error) {
    ...
    bodyObj.applicationName = (_c = dataObj.application) === null || _c === void 0 ? void 0 : _c.applicationName;
    bodyObj.version = (_d = dataObj.application) === null || _d === void 0 ? void 0 : _d.version;
...
function addApplicationFindingsFields(bodyObject, dataObj) {
    ...
    try {
        let findingsObj = {};
        let i = 0;
        (_a = dataObj.applicationFindings) === null || _a === void 0 ? void 0 : _a.forEach((appFindings) => {
...
EmasserPostStaticCodeScans.usage = '<%= command.id %> [ARGUMENTS]';
EmasserPostStaticCodeScans.description = "upload application scan findings into a system's assets module";
EmasserPostStaticCodeScans.examples = ['<%= config.bin %> <%= command.id %> [-s,--systemId] [-f,--cloudResourceFile]',
...
EmasserPostStaticCodeScans.flags = {
