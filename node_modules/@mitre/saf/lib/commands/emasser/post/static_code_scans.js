    ...
    async run() {
        ...
        if (fs_1.default.existsSync(flags.dataFile)) {
            ...
            if (!data || (typeof data !== 'object' && !Array.isArray(data))) {
                console.error('\x1B[91m» Invalid data format: Expected an object or array.\x1B[0m');
                process.exit(1);
            }
            ...
            if (Array.isArray(data)) {
                data.forEach((item) => {
                    if (typeof item !== 'object' || item === null) {
                        console.error('\x1B[91m» Invalid item in array: Expected an object.\x1B[0m');
                        process.exit(1);
                    }
                    let bodyObj = {};
                    try {
        ...
        }).catch((error) => (0, utilities_1.displayError)(error, 'Static Code Scans'));
    }
