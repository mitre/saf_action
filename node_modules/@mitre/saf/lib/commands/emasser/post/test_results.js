...
class EmasserPostTestResults extends core_1.Command {
    ...
    async run() {
        ...
        }).catch((error) => (0, utilities_1.displayError)(error, 'Test Results'));
    }
