...
EmasserContainerScans.usage = '<%= command.id %> [ARGUMENTS]';
EmasserContainerScans.description = 'Upload containers and their scan results in the assets module for a system';
EmasserContainerScans.examples = ['<%= config.bin %> <%= command.id %> [-s,--systemId] [-f,--containerCodeScanFile]',
