    ...
    async run() {
        ...
        if (fs_1.default.existsSync(flags.dataFile)) {
            ...
            try {
                ...
                console.error('\x1B[93m→ Error message was:', (0, global_1.getErrorMessage)(error), '\x1B[0m');
                process.exit(1);
            }
        ...
        // Call the endpoint
        swBaseline.addSwBaselineAssets(flags.systemId, requestBodyArray).then((response) => {
            console.log((0, json_colorizer_1.colorize)((0, outputFormatter_1.outputFormat)(response, false)));
        }).catch((error) => (0, utilities_1.displayError)(error, 'Software Baseline'));
    }
