...
class EmasserPostCac extends core_1.Command {
    ...
    static flags = {
        help: core_1.Flags.help({ char: 'h', description: 'Show eMASSer CLI help for the POST CAC command' }),
    ...
    async run() {
        ...
        const addCac = new emass_client_1.CACApi(apiCxn.configuration, apiCxn.basePath, apiCxn.axiosInstances);
        ...
        try {
            ...
            (0, utilities_1.displayError)(error, 'CAC');
        }
    }
    catch(err) {
...
exports.default = EmasserPostCac;
