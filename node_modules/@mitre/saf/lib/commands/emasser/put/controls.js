...
EmasserPutControls.usage = '<%= command.id %> [ARGUMENTS]';
EmasserPutControls.description = 'Update Security Control information of a system for both the Implementation Plan and Risk Assessment.';
EmasserPutControls.examples = ['<%= config.bin %> <%= command.id %> [-s,--systemId] [-f,--controlsFile]',
