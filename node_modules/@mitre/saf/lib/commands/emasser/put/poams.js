...
EmasserPutPoams.usage = '<%= command.id %> [ARGUMENTS]';
EmasserPutPoams.description = 'Update a Plan of Action and Milestones (POA&M) into a systems.';
EmasserPutPoams.examples = ['<%= config.bin %> <%= command.id %> [-s,--systemId] [-f,--poamFile]',
