...
function getAllJsonExamples() {
    let exampleBodyObj = {};
    exampleBodyObj = {
        ...(0, utilities_1.getJsonExamples)('hardware-put-required'),
...
function addRequiredFieldsToRequestBody(dataObj) {
    ...
    try {
        ...
        console.log((0, json_colorizer_1.colorize)(JSON.stringify((0, utilities_1.getJsonExamples)('hardware-put-required'), null, 2)));
        throw error;
    }
...
class EmasserHardwareBaseline extends core_1.Command {
    ...
    static description = 'Update one or many hardware assets to a system.\n' +
    ...
    static examples = [
        ...
        (0, json_colorizer_1.colorize)(JSON.stringify((0, utilities_1.getJsonExamples)('hardware-put-required'), null, 2)),
    ...
    static flags = {
        help: core_1.Flags.help({ char: 'h', description: 'Show eMASSer CLI help for the PUT Hardware Baseline command' }),
    ...
    async run() {
        ...
        // Call the endpoint
        hwBaseline.updateHwBaselineAssets(flags.systemId, requestBodyArray).then((response) => {
