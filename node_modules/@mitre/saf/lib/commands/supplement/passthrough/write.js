...
class WritePassthrough extends base_command_1.BaseCommand {
    ...
    async run() {
        ...
        if (flags.passthroughFile) {
            try {
                ...
                throw new Error(`Couldn't parse passthrough data: ${error instanceof Error ? error.message : JSON.stringify(error)}`, { cause: error });
            }
        }
