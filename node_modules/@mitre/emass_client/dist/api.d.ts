...
export declare const SystemsCloudTypeEnum: {
    readonly Hybrid: "Hybrid";
    readonly Private: "Private";
    readonly Public: "Public";
    readonly UnknownDefaultOpenApi: "11184809";
};
export declare type SystemsCloudTypeEnum = typeof SystemsCloudTypeEnum[keyof typeof SystemsCloudTypeEnum];
export declare const SystemsAtcStatusEnum: {
    readonly AuthorityToConnectAtc: "Authority to Connect (ATC)";
    readonly DenialOfAuthorityToConnectDatc: "Denial of Authority to Connect (DATC)";
    readonly NotYetConnected: "Not Yet Connected";
    readonly Decommissioned: "Decommissioned";
    readonly UnknownDefaultOpenApi: "11184809";
};
export declare type SystemsAtcStatusEnum = typeof SystemsAtcStatusEnum[keyof typeof SystemsAtcStatusEnum];
/**
 *
 * @export
...
export declare const ArtifactsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    addArtifactsBySystemId: (systemId: number, zipper: File, isBulk?: boolean, isTemplate?: boolean, type?: AddArtifactsBySystemIdTypeEnum, category?: AddArtifactsBySystemIdCategoryEnum, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const ArtifactsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    addArtifactsBySystemId(systemId: number, zipper: File, isBulk?: boolean, isTemplate?: boolean, type?: AddArtifactsBySystemIdTypeEnum, category?: AddArtifactsBySystemIdCategoryEnum, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ArtifactsResponsePutPost>>;
    /**
     * Remove the Artifact(s) matching `systemId` path parameter and request body artifact(s) file name<br><br> <b>Note:</b> Multiple files can be deleted by providing multiple file names at the CL (comma delimited)  Example: --files file1.txt, file2.txt
     * @summary Remove one or many artifacts in a system
     * @param {number} systemId **System Id**: The unique system record identifier.
...
export declare class ArtifactsApi extends BaseAPI {
     ...
     */
    addArtifactsBySystemId(systemId: number, zipper: File, isBulk?: boolean, isTemplate?: boolean, type?: AddArtifactsBySystemIdTypeEnum, category?: AddArtifactsBySystemIdCategoryEnum, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ArtifactsResponsePutPost>>;
    /**
     * Remove the Artifact(s) matching `systemId` path parameter and request body artifact(s) file name<br><br> <b>Note:</b> Multiple files can be deleted by providing multiple file names at the CL (comma delimited)  Example: --files file1.txt, file2.txt
     * @summary Remove one or many artifacts in a system
     * @param {number} systemId **System Id**: The unique system record identifier.
 ...
 * @export
 */
export declare const AddArtifactsBySystemIdTypeEnum: {
...
export declare type AddArtifactsBySystemIdTypeEnum = typeof AddArtifactsBySystemIdTypeEnum[keyof typeof AddArtifactsBySystemIdTypeEnum];
/**
 * @export
 */
export declare const AddArtifactsBySystemIdCategoryEnum: {
    readonly ImplementationGuidance: "Implementation Guidance";
    readonly Evidence: "Evidence";
    readonly UnknownDefaultOpenApi: "11184809";
};
export declare type AddArtifactsBySystemIdCategoryEnum = typeof AddArtifactsBySystemIdCategoryEnum[keyof typeof AddArtifactsBySystemIdCategoryEnum];
/**
 ...
 * @export
 */
export declare const CloudResourceResultsApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
 ...
 * @export
 */
export declare const CloudResourceResultsApiFp: (configuration?: Configuration) => {
    /**
     * Add cloud resources and their scan results in the assets module for a system `systemId`
     * @summary Add one or many cloud resources and their scan results
     * @param {number} systemId **System Id**: The unique system record identifier.
 ...
 * @export
 */
export declare const CloudResourceResultsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Add cloud resources and their scan results in the assets module for a system `systemId`
     * @summary Add one or many cloud resources and their scan results
     * @param {number} systemId **System Id**: The unique system record identifier.
 ...
 * @extends {BaseAPI}
 */
export declare class CloudResourceResultsApi extends BaseAPI {
    /**
     * Add cloud resources and their scan results in the assets module for a system `systemId`
     * @summary Add one or many cloud resources and their scan results
     * @param {number} systemId **System Id**: The unique system record identifier.
 ...
 * @export
 */
export declare const ContainerScanResultsApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
 ...
 * @export
 */
export declare const ContainerScanResultsApiFp: (configuration?: Configuration) => {
    /**
     * Add containers and their scan results in the assets module for a system `systemId`.
     * @summary Add one or many containers and their scan results
     * @param {number} systemId **System Id**: The unique system record identifier.
 ...
 * @export
 */
export declare const ContainerScanResultsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Add containers and their scan results in the assets module for a system `systemId`.
     * @summary Add one or many containers and their scan results
     * @param {number} systemId **System Id**: The unique system record identifier.
 ...
 * @extends {BaseAPI}
 */
export declare class ContainerScanResultsApi extends BaseAPI {
    /**
     * Add containers and their scan results in the assets module for a system `systemId`.
     * @summary Add one or many containers and their scan results
     * @param {number} systemId **System Id**: The unique system record identifier.
...
export declare const DashboardsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getSystemArtifactsDetails: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemArtifactsSummary: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemAssessmentProceduresDetails: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemAssociationsDetails: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemCommonIntegrationStatusSummary: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemControlComplianceSummary: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemHardwareDetails: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemHardwareSummary: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemPoamDetails: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemPoamSummary: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemPortsProtocolsDetails: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemPortsProtocolsSummary: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemPrivacySummary: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemSecurityControlDetails: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemSensorHardwareDetails: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemSensorHardwareSummary: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemSoftwareDetails: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemSoftwareSummary: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystemStatusDetails: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getUserSystemAssignmentsDetails: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getVaOmbFsmaSaopSummary: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getVaSystemA2Summary: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getVaSystemAaSummary: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getVaSystemFismaInvetoryCryptoSummary: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getVaSystemFismaInvetorySummary: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getVaSystemPl109ReportingSummary: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getVaSystemThreatArchitectureDetails: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getVaSystemThreatRiskSummary: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getVaSystemThreatSourceDetails: (orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const DashboardsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getSystemArtifactsDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get system Artifacts summary information.
     * @summary System Artifacts Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemArtifactsSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get systems assessement procdures details dashboard information.
     * @summary System Assessment Procedures Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemAssessmentProceduresDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get system associations details dashboard information.
     * @summary System Associations Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemAssociationsDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get system CONMON integration status dashboard information.
     * @summary System CONMON Integration Status
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemCommonIntegrationStatusSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get systems control compliance summary dashboard information.
     * @summary System Control Compliance Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemControlComplianceSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get system hardware details dashboard information.
     * @summary System Hardware Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemHardwareDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get system hardware summary dashboard information.
     * @summary System Hardware Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemHardwareSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get system POA&Ms details dashboard information.
     * @summary System POA&M Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemPoamDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get systems POA&Ms summary dashboard information.
     * @summary System POA&M Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemPoamSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get system ports and protocols details dashboard information.
     * @summary System Ports/Protocols Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemPortsProtocolsDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get system ports and protocols summary dashboard information.
     * @summary System Ports/Protocols Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemPortsProtocolsSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get user system privacy summary dashboard information.
     * @summary System Privacy Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemPrivacySummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get systems security control details dashboard information.
     * @summary System Control Compliance Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemSecurityControlDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get system sensor hardware details dashboard information.
     * @summary System Sensor Hardware Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemSensorHardwareDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get system sensor hardware summary dashboard information.
     * @summary System Sensor Hardware Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemSensorHardwareSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get system software details dashboard information.
     * @summary System Software Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemSoftwareDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get system software summary dashboard information.
     * @summary System Software Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemSoftwareSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get systems status detail dashboard information.
     * @summary System Status Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getSystemStatusDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get user system assignments details dashboard information.
     * @summary User System Assignments Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getUserSystemAssignmentsDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get VA OMB-FISMA SAOP summary dashboard information.
     * @summary VA OMB FISMA SAOP Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getVaOmbFsmaSaopSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get VA system A2.0 summary dashboard information.
     * @summary VA System A2.0 Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getVaSystemA2Summary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get VA system A&A summary dashboard information.
     * @summary VA System A&A Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getVaSystemAaSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get VA system FISMA inventory crypto summary dashboard information.
     * @summary VA System FISMA Inventory Crypto Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getVaSystemFismaInvetoryCryptoSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get VA system FISMA inventory summary dashboard information.
     * @summary VA System FISMA Inventory Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getVaSystemFismaInvetorySummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get VA system P.L. 109 reporting summary dashboard information.
     * @summary VA System P.L. 109 Reporting Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getVaSystemPl109ReportingSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get VA system threat architecture details dashboard information.
     * @summary VA System Threat Architecture Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getVaSystemThreatArchitectureDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get VA system threat risk summary dashboard information.
     * @summary VA System Threat Risks Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getVaSystemThreatRiskSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     * Get VA system threat source details dashboard information.
     * @summary VA System Threat Sources Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @throws {RequiredError}
     */
    getVaSystemThreatSourceDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
};
/**
...
export declare class DashboardsApi extends BaseAPI {
     ...
     */
    getSystemArtifactsDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get system Artifacts summary information.
     * @summary System Artifacts Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemArtifactsSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get systems assessement procdures details dashboard information.
     * @summary System Assessment Procedures Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemAssessmentProceduresDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get system associations details dashboard information.
     * @summary System Associations Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemAssociationsDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get system CONMON integration status dashboard information.
     * @summary System CONMON Integration Status
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemCommonIntegrationStatusSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get systems control compliance summary dashboard information.
     * @summary System Control Compliance Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemControlComplianceSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get system hardware details dashboard information.
     * @summary System Hardware Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemHardwareDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get system hardware summary dashboard information.
     * @summary System Hardware Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemHardwareSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get system POA&Ms details dashboard information.
     * @summary System POA&M Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemPoamDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get systems POA&Ms summary dashboard information.
     * @summary System POA&M Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemPoamSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get system ports and protocols details dashboard information.
     * @summary System Ports/Protocols Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemPortsProtocolsDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get system ports and protocols summary dashboard information.
     * @summary System Ports/Protocols Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemPortsProtocolsSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get user system privacy summary dashboard information.
     * @summary System Privacy Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemPrivacySummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get systems security control details dashboard information.
     * @summary System Control Compliance Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemSecurityControlDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get system sensor hardware details dashboard information.
     * @summary System Sensor Hardware Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemSensorHardwareDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get system sensor hardware summary dashboard information.
     * @summary System Sensor Hardware Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemSensorHardwareSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get system software details dashboard information.
     * @summary System Software Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemSoftwareDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get system software summary dashboard information.
     * @summary System Software Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemSoftwareSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get systems status detail dashboard information.
     * @summary System Status Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getSystemStatusDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get user system assignments details dashboard information.
     * @summary User System Assignments Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getUserSystemAssignmentsDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get VA OMB-FISMA SAOP summary dashboard information.
     * @summary VA OMB FISMA SAOP Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getVaOmbFsmaSaopSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get VA system A2.0 summary dashboard information.
     * @summary VA System A2.0 Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getVaSystemA2Summary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get VA system A&A summary dashboard information.
     * @summary VA System A&A Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getVaSystemAaSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get VA system FISMA inventory crypto summary dashboard information.
     * @summary VA System FISMA Inventory Crypto Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getVaSystemFismaInvetoryCryptoSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get VA system FISMA inventory summary dashboard information.
     * @summary VA System FISMA Inventory Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getVaSystemFismaInvetorySummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get VA system P.L. 109 reporting summary dashboard information.
     * @summary VA System P.L. 109 Reporting Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getVaSystemPl109ReportingSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get VA system threat architecture details dashboard information.
     * @summary VA System Threat Architecture Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getVaSystemThreatArchitectureDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get VA system threat risk summary dashboard information.
     * @summary VA System Threat Risks Summary
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getVaSystemThreatRiskSummary(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
    /**
     * Get VA system threat source details dashboard information.
     * @summary VA System Threat Sources Details
     * @param {number} orgId **Organization Id**: The unique organization identifier.
     ...
     * @memberof DashboardsApi
     */
    getVaSystemThreatSourceDetails(orgId: number, excludeinherited?: boolean, pageIndex?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<object>>;
}
/**
...
export declare const SystemRolesApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getSystemRolesByCategoryId: (roleCategory: GetSystemRolesByCategoryIdRoleCategoryEnum, role: GetSystemRolesByCategoryIdRoleEnum, policy?: GetSystemRolesByCategoryIdPolicyEnum, includeDecommissioned?: boolean, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare class SystemRolesApi extends BaseAPI {
     ...
     * @memberof SystemRolesApi
     */
    getSystemRolesByCategoryId(roleCategory: GetSystemRolesByCategoryIdRoleCategoryEnum, role: GetSystemRolesByCategoryIdRoleEnum, policy?: GetSystemRolesByCategoryIdPolicyEnum, includeDecommissioned?: boolean, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<SystemRolesCategoryResponse>>;
}
/**
 * @export
 */
export declare const GetSystemRolesByCategoryIdRoleCategoryEnum: {
    readonly Cac: "CAC";
    readonly Pac: "PAC";
    readonly Other: "Other";
    readonly UnknownDefaultOpenApi: "11184809";
};
export declare type GetSystemRolesByCategoryIdRoleCategoryEnum = typeof GetSystemRolesByCategoryIdRoleCategoryEnum[keyof typeof GetSystemRolesByCategoryIdRoleCategoryEnum];
/**
 * @export
 */
export declare const GetSystemRolesByCategoryIdRoleEnum: {
    readonly Ao: "AO";
    readonly Auditor: "Auditor";
    readonly ArtifactManager: "Artifact Manager";
    readonly CaTeam: "C&A Team";
    readonly Iao: "IAO";
    readonly Isso: "ISSO";
    readonly PmIam: "PM/IAM";
    readonly Sca: "SCA";
    readonly UserRep: "User Rep";
    readonly Validator: "Validator";
    readonly UnknownDefaultOpenApi: "11184809";
};
export declare type GetSystemRolesByCategoryIdRoleEnum = typeof GetSystemRolesByCategoryIdRoleEnum[keyof typeof GetSystemRolesByCategoryIdRoleEnum];
/**
 * @export
 */
export declare const GetSystemRolesByCategoryIdPolicyEnum: {
    readonly Diacap: "diacap";
    readonly Rmf: "rmf";
    readonly Reporting: "reporting";
    readonly UnknownDefaultOpenApi: "11184809";
};
export declare type GetSystemRolesByCategoryIdPolicyEnum = typeof GetSystemRolesByCategoryIdPolicyEnum[keyof typeof GetSystemRolesByCategoryIdPolicyEnum];
/**
...
export declare const SystemsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getSystem: (systemId: number, includePackage?: boolean, policy?: GetSystemPolicyEnum, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSystems: (includePackage?: boolean, registrationType?: string, ditprId?: string, coamsId?: string, policy?: GetSystemsPolicyEnum, includeDitprMetrics?: boolean, includeDecommissioned?: boolean, reportsForScorecard?: boolean, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const SystemsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getSystem(systemId: number, includePackage?: boolean, policy?: GetSystemPolicyEnum, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SystemResponse>>;
    /**
     * Returns all system(s) that match the query parameters
     * @summary Get system information
     * @param {boolean} [includePackage] **Include Package**:  Indicates if additional packages information is retrieved for queried system.
...
export declare class SystemsApi extends BaseAPI {
     ...
     * @memberof SystemsApi
     */
    getSystem(systemId: number, includePackage?: boolean, policy?: GetSystemPolicyEnum, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<SystemResponse>>;
    /**
     * Returns all system(s) that match the query parameters
     * @summary Get system information
     * @param {boolean} [includePackage] **Include Package**:  Indicates if additional packages information is retrieved for queried system.
     ...
     * @memberof SystemsApi
     */
    getSystems(includePackage?: boolean, registrationType?: string, ditprId?: string, coamsId?: string, policy?: GetSystemsPolicyEnum, includeDitprMetrics?: boolean, includeDecommissioned?: boolean, reportsForScorecard?: boolean, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<SystemsResponse>>;
}
/**
 * @export
 */
export declare const GetSystemPolicyEnum: {
    readonly Diacap: "diacap";
    readonly Rmf: "rmf";
    readonly Reporting: "reporting";
    readonly UnknownDefaultOpenApi: "11184809";
};
export declare type GetSystemPolicyEnum = typeof GetSystemPolicyEnum[keyof typeof GetSystemPolicyEnum];
/**
 * @export
 */
export declare const GetSystemsPolicyEnum: {
    readonly Diacap: "diacap";
    readonly Rmf: "rmf";
    readonly Reporting: "reporting";
    readonly UnknownDefaultOpenApi: "11184809";
};
export declare type GetSystemsPolicyEnum = typeof GetSystemsPolicyEnum[keyof typeof GetSystemsPolicyEnum];
/**
...
export declare const WorkflowInstancesApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getSystemWorkflowInstances: (includeComments?: boolean, pageIndex?: number, sinceDate?: string, status?: GetSystemWorkflowInstancesStatusEnum, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const WorkflowInstancesApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getSystemWorkflowInstances(includeComments?: boolean, pageIndex?: number, sinceDate?: string, status?: GetSystemWorkflowInstancesStatusEnum, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WorkflowInstancesResponseGet>>;
    /**
     * View detailed historical workflow information for `workflowInstanceId`.
     * @summary Get workflow instance by ID
     * @param {number} workflowInstanceId **Workflow Instance Id**: The unique workflow definition identifier.
...
export declare class WorkflowInstancesApi extends BaseAPI {
     ...
     */
    getSystemWorkflowInstances(includeComments?: boolean, pageIndex?: number, sinceDate?: string, status?: GetSystemWorkflowInstancesStatusEnum, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<WorkflowInstancesResponseGet>>;
    /**
     * View detailed historical workflow information for `workflowInstanceId`.
     * @summary Get workflow instance by ID
     * @param {number} workflowInstanceId **Workflow Instance Id**: The unique workflow definition identifier.
 ...
 * @export
 */
export declare const GetSystemWorkflowInstancesStatusEnum: {
    readonly Active: "active";
    readonly Inactive: "inactive";
    readonly All: "all";
    readonly UnknownDefaultOpenApi: "11184809";
};
export declare type GetSystemWorkflowInstancesStatusEnum = typeof GetSystemWorkflowInstancesStatusEnum[keyof typeof GetSystemWorkflowInstancesStatusEnum];
